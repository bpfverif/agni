...
define dso_local { i64, i64 } @tnum_const(i64 noundef %value) #0 align 16 {
entry:
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_range(i64 noundef %min, i64 noundef %max) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  ...
  %call = call i32 @fls64___(i64 noundef %2) #3
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define internal i32 @fls64___(i64 noundef %x) #0 align 16 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call = call i32 @generic___fls___(i64 noundef %1) #3
  %add = add i32 %call, 1
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_lshift(i64 %a.coerce0, i64 %a.coerce1, i8 noundef zeroext %shift) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_rshift(i64 %a.coerce0, i64 %a.coerce1, i8 noundef zeroext %shift) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %shift.addr = alloca i8, align 1
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_arshift(i64 %a.coerce0, i64 %a.coerce1, i8 noundef zeroext %min_shift, i8 noundef zeroext %insn_bitness) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_add(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_sub(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %b = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_and(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %b = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_or(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %b = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_xor(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %b = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_mul(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %b = alloca %struct.tnum, align 8
...
if.then:                                          ; preds = %while.body
  ...
  %call = call { i64, i64 } @tnum_add(i64 %16, i64 %18, i64 %21, i64 %23) #3
...
if.then12:                                        ; preds = %if.else
  ...
  %call19 = call { i64, i64 } @tnum_add(i64 %36, i64 %38, i64 %41, i64 %43) #3
...
if.end20:                                         ; preds = %if.end, %if.then
  ...
  %call22 = call { i64, i64 } @tnum_rshift(i64 %53, i64 %55, i8 noundef zeroext 1) #3
  ...
  %call24 = call { i64, i64 } @tnum_lshift(i64 %65, i64 %67, i8 noundef zeroext 1) #3
...
while.end:                                        ; preds = %lor.end
  ...
  %call28 = call { i64, i64 } @tnum_add(i64 %78, i64 %80, i64 %83, i64 %85) #3
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_intersect(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %b = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_cast(i64 %a.coerce0, i64 %a.coerce1, i8 noundef zeroext %size) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local zeroext i1 @tnum_is_aligned(i64 %a.coerce0, i64 %a.coerce1, i64 noundef %size) #0 align 16 {
entry:
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local zeroext i1 @tnum_in(i64 %a.coerce0, i64 %a.coerce1, i64 %b.coerce0, i64 %b.coerce1) #0 align 16 {
entry:
  %retval = alloca i1, align 1
  %a = alloca %struct.tnum, align 8
  %b = alloca %struct.tnum, align 8
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local i32 @tnum_sbin(i8* noundef %str, i64 noundef %size, i64 %a.coerce0, i64 %a.coerce1) #0 align 16 {
entry:
  %a = alloca %struct.tnum, align 8
  %str.addr = alloca i8*, align 8
  %size.addr = alloca i64, align 8
  %n = alloca i64, align 8
  %__UNIQUE_ID___x3 = alloca i64, align 8
  %__UNIQUE_ID___y4 = alloca i64, align 8
...
for.end:                                          ; preds = %for.cond
  ...
  %sub16 = sub i64 %18, 1
  store i64 %sub16, i64* %__UNIQUE_ID___x3, align 8
  store i64 64, i64* %__UNIQUE_ID___y4, align 8
  %19 = load i64, i64* %__UNIQUE_ID___x3, align 8
  %20 = load i64, i64* %__UNIQUE_ID___y4, align 8
  %cmp17 = icmp ult i64 %19, %20
  br i1 %cmp17, label %cond.true, label %cond.false

cond.true:                                        ; preds = %for.end
  %21 = load i64, i64* %__UNIQUE_ID___x3, align 8
  br label %cond.end

cond.false:                                       ; preds = %for.end
  %22 = load i64, i64* %__UNIQUE_ID___y4, align 8
  br label %cond.end
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_subreg(i64 %a.coerce0, i64 %a.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  %0 = bitcast %struct.tnum* %a to { i64, i64 }*
  ...
  %call = call { i64, i64 } @tnum_cast(i64 %5, i64 %7, i8 noundef zeroext 4) #3
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_clear_subreg(i64 %a.coerce0, i64 %a.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  ...
  %6 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %3, i32 0, i32 1
  %7 = load i64, i64* %6, align 8
  %call = call { i64, i64 } @tnum_rshift(i64 %5, i64 %7, i8 noundef zeroext 32) #3
  ...
  %call1 = call { i64, i64 } @tnum_lshift(i64 %15, i64 %17, i8 noundef zeroext 32) #3
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_with_subreg(i64 %reg.coerce0, i64 %reg.coerce1, i64 %subreg.coerce0, i64 %subreg.coerce1) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %reg = alloca %struct.tnum, align 8
  %subreg = alloca %struct.tnum, align 8
  %agg.tmp = alloca %struct.tnum, align 8
  %agg.tmp1 = alloca %struct.tnum, align 8
  %0 = bitcast %struct.tnum* %reg to { i64, i64 }*
  %1 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %0, i32 0, i32 0
  store i64 %reg.coerce0, i64* %1, align 8
  %2 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %0, i32 0, i32 1
  store i64 %reg.coerce1, i64* %2, align 8
  %3 = bitcast %struct.tnum* %subreg to { i64, i64 }*
  %4 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %3, i32 0, i32 0
  store i64 %subreg.coerce0, i64* %4, align 8
  %5 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %3, i32 0, i32 1
  store i64 %subreg.coerce1, i64* %5, align 8
  %6 = bitcast %struct.tnum* %reg to { i64, i64 }*
  %7 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %6, i32 0, i32 0
  %8 = load i64, i64* %7, align 8
  %9 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %6, i32 0, i32 1
  %10 = load i64, i64* %9, align 8
  %call = call { i64, i64 } @tnum_clear_subreg(i64 %8, i64 %10) #3
  ...
  %16 = bitcast %struct.tnum* %subreg to { i64, i64 }*
  %17 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %16, i32 0, i32 0
  %18 = load i64, i64* %17, align 8
  %19 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %16, i32 0, i32 1
  %20 = load i64, i64* %19, align 8
  %call2 = call { i64, i64 } @tnum_subreg(i64 %18, i64 %20) #3
  %21 = bitcast %struct.tnum* %agg.tmp1 to { i64, i64 }*
  ...
  %31 = bitcast %struct.tnum* %agg.tmp1 to { i64, i64 }*
  %32 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %31, i32 0, i32 0
  %33 = load i64, i64* %32, align 8
  %34 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %31, i32 0, i32 1
  %35 = load i64, i64* %34, align 8
  %call3 = call { i64, i64 } @tnum_or(i64 %28, i64 %30, i64 %33, i64 %35) #3
  %36 = bitcast %struct.tnum* %retval to { i64, i64 }*
  %37 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %36, i32 0, i32 0
  %38 = extractvalue { i64, i64 } %call3, 0
  store i64 %38, i64* %37, align 8
  %39 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %36, i32 0, i32 1
  %40 = extractvalue { i64, i64 } %call3, 1
  store i64 %40, i64* %39, align 8
  %41 = bitcast %struct.tnum* %retval to { i64, i64 }*
  %42 = load { i64, i64 }, { i64, i64 }* %41, align 8
  ret { i64, i64 } %42
}

; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local { i64, i64 } @tnum_const_subreg(i64 %a.coerce0, i64 %a.coerce1, i32 noundef %value) #0 align 16 {
entry:
  %retval = alloca %struct.tnum, align 8
  %a = alloca %struct.tnum, align 8
  ...
  %call = call { i64, i64 } @tnum_const(i64 noundef %conv) #3
  %4 = bitcast %struct.tnum* %agg.tmp to { i64, i64 }*
  ...
  %9 = bitcast %struct.tnum* %a to { i64, i64 }*
  %10 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %9, i32 0, i32 0
  %11 = load i64, i64* %10, align 8
  %12 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %9, i32 0, i32 1
  %13 = load i64, i64* %12, align 8
  %14 = bitcast %struct.tnum* %agg.tmp to { i64, i64 }*
  %15 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %14, i32 0, i32 0
  %16 = load i64, i64* %15, align 8
  %17 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %14, i32 0, i32 1
  %18 = load i64, i64* %17, align 8
  %call1 = call { i64, i64 } @tnum_with_subreg(i64 %11, i64 %13, i64 %16, i64 %18) #3
  %19 = bitcast %struct.tnum* %retval to { i64, i64 }*
  %20 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %19, i32 0, i32 0
  %21 = extractvalue { i64, i64 } %call1, 0
  store i64 %21, i64* %20, align 8
  %22 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %19, i32 0, i32 1
  %23 = extractvalue { i64, i64 } %call1, 1
  store i64 %23, i64* %22, align 8
  %24 = bitcast %struct.tnum* %retval to { i64, i64 }*
  %25 = load { i64, i64 }, { i64, i64 }* %24, align 8
  ret { i64, i64 } %25
}

; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define internal i32 @generic___fls___(i64 noundef %word) #0 align 16 {
entry:
...
attributes #0 = { noinline noredzone nounwind null_pointer_is_valid sspstrong "frame-pointer"="none" "min-legal-vector-width"="0" "no-jump-tables"="true" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+retpoline-external-thunk,+retpoline-indirect-branches,+retpoline-indirect-calls,-3dnow,-3dnowa,-aes,-avx,-avx2,-avx512bf16,-avx512bitalg,-avx512bw,-avx512cd,-avx512dq,-avx512er,-avx512f,-avx512fp16,-avx512ifma,-avx512pf,-avx512vbmi,-avx512vbmi2,-avx512vl,-avx512vnni,-avx512vp2intersect,-avx512vpopcntdq,-avxvnni,-f16c,-fma,-fma4,-gfni,-kl,-mmx,-pclmul,-sha,-sse,-sse2,-sse3,-sse4.1,-sse4.2,-sse4a,-ssse3,-vaes,-vpclmulqdq,-widekl,-x87,-xop" "tune-cpu"="generic" "warn-stack-size"="2048" }
