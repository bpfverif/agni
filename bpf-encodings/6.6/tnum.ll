...
module asm ".section \22.export_symbol\22,\22a\22 ; __export_symbol_tnum_strn: ; .asciz \22GPL\22 ; .asciz \22\22 ; .balign 8 ; .quad tnum_strn ; .previous"
...
if.end:                                           ; preds = %entry
  ...
  %call = call i64 @fls___(i64 noundef %1) #4
  %add = add i64 %call, 1
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define dso_local i32 @tnum_strn(i8* noundef %str, i64 noundef %size, i64 %a.coerce0, i64 %a.coerce1) #0 align 16 {
entry:
  %a = alloca %struct.tnum, align 8
