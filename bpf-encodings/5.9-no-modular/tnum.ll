...
@__addressable_tnum_strn262 = internal global i8* bitcast (i32 (i8*, i64, i64, i64)* @tnum_strn to i8*), section ".discard.addressable", align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__addressable_tnum_strn262 to i8*)], section "llvm.metadata"
