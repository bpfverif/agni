; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_SYNC/BPF_SYNC.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @reg_bounds_sync___(%struct.bpf_reg_state* nocapture noundef %dst_reg) local_unnamed_addr #0 {
entry:
...
__reg_deduce_bounds.exit:                         ; preds = %if.then32.i, %if.else.i, %if.then17.i, %if.then.i
