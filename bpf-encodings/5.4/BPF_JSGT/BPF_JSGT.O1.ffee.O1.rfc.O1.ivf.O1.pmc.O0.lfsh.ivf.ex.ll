; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JSGT/BPF_JSGT.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JSGT(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %i77.i = load i64, i64* %smin_value.i, align 8
  %cmp62.i = icmp sgt i64 %i77.i, %i58
  br i1 %cmp62.i, label %is_branch_taken.exit, label %if.else65.i

if.else65.i:                                      ; preds = %if.then25
  %i78.i = load i64, i64* %smax_value.i, align 8
  %cmp67.i = icmp sge i64 %i78.i, %i58
  %spec.select = sext i1 %cmp67.i to i32
  br label %is_branch_taken.exit

is_branch_taken.exit:                             ; preds = %if.else65.i, %if.then25
  %retval.0.i = phi i32 [ 1, %if.then25 ], [ %spec.select, %if.else65.i ]
...
cond.end:                                         ; preds = %if.then52
  ...
  %cond94.i = add i64 %i67, 1
  %i125.i = load i64, i64* %smax_value.i, align 8
  %cmp101.i = icmp slt i64 %i125.i, %i67
  %cond106.i = select i1 %cmp101.i, i64 %i125.i, i64 %i67
...
cond.end90:                                       ; preds = %if.else70
  ...
  %cond94.i60 = add i64 %i70, -1
  %i125.i62 = load i64, i64* %smin_value.i10, align 8
  %cmp101.i63 = icmp sgt i64 %i125.i62, %i70
  %cond106.i64 = select i1 %cmp101.i63, i64 %i125.i62, i64 %i70
  store i64 %cond106.i64, i64* %smin_value.i10, align 8
  %i126.i66 = load i64, i64* %smax_value8.i15, align 8
  %cmp109.i67 = icmp slt i64 %i126.i66, %cond94.i60
  %cond114.i68 = select i1 %cmp109.i67, i64 %i126.i66, i64 %cond94.i60
