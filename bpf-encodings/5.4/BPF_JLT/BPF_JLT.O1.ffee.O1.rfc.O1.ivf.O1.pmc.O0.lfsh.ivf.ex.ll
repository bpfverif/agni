; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JLT/BPF_JLT.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JLT(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %i79.i = load i64, i64* %umax_value.i, align 8
  %cmp74.i = icmp ult i64 %i79.i, %i58
  br i1 %cmp74.i, label %is_branch_taken.exit, label %if.else77.i

if.else77.i:                                      ; preds = %if.then25
  %i80.i = load i64, i64* %umin_value.i, align 8
  %cmp79.not.i = icmp ult i64 %i80.i, %i58
  %spec.select = sext i1 %cmp79.not.i to i32
  br label %is_branch_taken.exit

is_branch_taken.exit:                             ; preds = %if.else77.i, %if.then25
  %retval.0.i = phi i32 [ 1, %if.then25 ], [ %spec.select, %if.else77.i ]
...
cond.end:                                         ; preds = %if.then52
  ...
  %cond132.i = add i64 %i67, -1
  %i133.i = load i64, i64* %umin_value.i, align 8
  %cmp144.i = icmp ugt i64 %i133.i, %i67
  %cond149.i = select i1 %cmp144.i, i64 %i133.i, i64 %i67
  store i64 %cond149.i, i64* %umin_value.i, align 8
  %i134.i = load i64, i64* %umax_value10.i, align 8
  %cmp153.i = icmp ult i64 %i134.i, %cond132.i
  %cond158.i = select i1 %cmp153.i, i64 %i134.i, i64 %cond132.i
...
cond.end90:                                       ; preds = %if.else70
  ...
  %cond132.i58 = add i64 %i70, 1
  %cmp144.i60 = icmp ult i64 %lo_reg1.sroa.11.0.copyload, %i70
  %cond149.i61 = select i1 %cmp144.i60, i64 %lo_reg1.sroa.11.0.copyload, i64 %i70
  store i64 %cond149.i61, i64* %umax_value.i19, align 8
  %i134.i62 = load i64, i64* %umin_value9.i18, align 8
  %cmp153.i63 = icmp ugt i64 %i134.i62, %cond132.i58
  %cond158.i64 = select i1 %cmp153.i63, i64 %i134.i62, i64 %cond132.i58
