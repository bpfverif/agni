; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JEQ_32/BPF_JEQ_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JEQ_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %tobool.not.i.i = icmp eq i64 %and6.i.i.i, 0
  br i1 %tobool.not.i.i, label %if.end117, label %if.then44
...
cond.end:                                         ; preds = %if.then52
  %i101.i = load i64, i64* %value3.i, align 8
  %and.i64 = and i64 %i101.i, -4294967296
  %or.i = or i64 %and.i64, %and.i.i39
  store i64 %or.i, i64* %value3.i, align 8
  %i102.i = load i64, i64* %mask6.i, align 8
  %and22.i = and i64 %i102.i, -4294967296
  store i64 %and22.i, i64* %mask6.i, align 8
...
cond.end90:                                       ; preds = %if.else70
  %and.i82 = and i64 %i13.i5, -4294967296
  %or.i83 = or i64 %and.i.i, %and.i82
  store i64 %or.i83, i64* %value3.i6, align 8
  %and22.i86 = and i64 %i14.i8, -4294967296
  store i64 %and22.i86, i64* %mask6.i9, align 8
...
if.then.i.i105:                                   ; preds = %lor.lhs.false.i.i94, %cond.end90
  %i34.i.i96 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i97 = icmp ugt i64 %i.i42.i88, %i34.i.i96
  %cond.i.i98 = select i1 %cmp3.i.i97, i64 %i.i42.i88, i64 %i34.i.i96
  ...
  %i36.i.i102 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i103 = icmp ult i64 %i35.i.i100, %i36.i.i102
  %cond12.i.i104 = select i1 %cmp8.i48.i103, i64 %i35.i.i100, i64 %i36.i.i102
...
if.end.i.i111:                                    ; preds = %lor.lhs.false.i.i94
  %i37.i.i107 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i108 = icmp sgt i64 %i37.i.i107, -1
  %i38.i.i110 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i108, label %if.then17.i.i114, label %if.else.i.i116

if.then17.i.i114:                                 ; preds = %if.end.i.i111
  store i64 %i38.i.i110, i64* %smin_value.i10, align 8
  %cmp23.i.i112 = icmp ult i64 %i33.i.i92, %i37.i.i107
  %cond27.i.i113 = select i1 %cmp23.i.i112, i64 %i33.i.i92, i64 %i37.i.i107
  store i64 %cond27.i.i113, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i123.sink.split

if.else.i.i116:                                   ; preds = %if.end.i.i111
  %cmp31.i.i115 = icmp slt i64 %i38.i.i110, 0
  br i1 %cmp31.i.i115, label %if.then32.i.i119, label %__reg_deduce_bounds.exit.i123

if.then32.i.i119:                                 ; preds = %if.else.i.i116
  %cmp36.i.i117 = icmp ugt i64 %i.i42.i88, %i38.i.i110
  %cond40.i.i118 = select i1 %cmp36.i.i117, i64 %i.i42.i88, i64 %i38.i.i110
...
__reg_deduce_bounds.exit.i123.sink.split:         ; preds = %if.then32.i.i119, %if.then17.i.i114, %if.then.i.i105
  %i37.i.i107.sink = phi i64 [ %i37.i.i107, %if.then32.i.i119 ], [ %cond27.i.i113, %if.then17.i.i114 ], [ %cond12.i.i104, %if.then.i.i105 ]
  store i64 %i37.i.i107.sink, i64* %smax_value.i13, align 8
