; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JLT_32/BPF_JLT_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JLT_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %cmp74.i = icmp ult i64 %storemerge.i.i, %conv13.i
  %cmp79.not.i = icmp uge i64 %reg_lo.i.sroa.15.0, %conv13.i
  %narrow = select i1 %cmp74.i, i1 true, i1 %cmp79.not.i
...
cond.end:                                         ; preds = %if.then52
  %cond132.i = add nsw i64 %and.i.i39, -1
  %and.i16.i = and i64 %lo_reg0.sroa.1.0.copyload, -4294967296
  %add137.i = or i64 %and.i.i39, %and.i16.i
  ...
  %add140.i = add i64 %cond132.i, %and.i18.i
...
cond.end90:                                       ; preds = %if.else70
  ...
  %add137.i82 = or i64 %and.i17.i, %and.i.i
  %and.i18.i85 = and i64 %i13.i5, -4294967296
  %cond132.i77 = or i64 %and.i18.i85, 1
  %add140.i86 = add i64 %cond132.i77, %and.i.i
