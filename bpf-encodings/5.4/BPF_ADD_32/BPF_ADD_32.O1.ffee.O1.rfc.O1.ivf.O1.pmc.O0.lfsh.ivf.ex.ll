; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_ADD_32/BPF_ADD_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @adjust_scalar_min_max_vals_wrapper_BPF_ADD_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg) local_unnamed_addr #0 {
entry:
...
if.then72.i:                                      ; preds = %if.end27.i
  store i64 0, i64* %umin_value.i.i, align 8
  br label %if.end80.i

if.else75.i:                                      ; preds = %if.end27.i
...
if.then.i314.i:                                   ; preds = %if.end80.i
...
if.else.i315.i:                                   ; preds = %if.end80.i
  store i64 0, i64* %umin_value.i.i, align 8
  br label %coerce_reg_to_size.exit320.i
