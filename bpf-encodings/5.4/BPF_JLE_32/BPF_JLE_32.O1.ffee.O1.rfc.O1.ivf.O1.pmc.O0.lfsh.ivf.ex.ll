; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JLE_32/BPF_JLE_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JLE_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %reg_lo.i.sroa.15.0.copyload = load i64, i64* %umin_value.i, align 8
  %reg_lo.i.sroa.21.0.copyload = load i64, i64* %umax_value.i, align 8
  %i25.i.i = xor i64 %reg_lo.i.sroa.21.0.copyload, %reg_lo.i.sroa.15.0.copyload
  %cmp.i.i = icmp ult i64 %i25.i.i, 4294967296
  %and6.i.i = and i64 %reg_lo.i.sroa.15.0.copyload, 4294967295
  %and8.i.i = and i64 %reg_lo.i.sroa.21.0.copyload, 4294967295
  %reg_lo.i.sroa.15.0 = select i1 %cmp.i.i, i64 %and6.i.i, i64 0
  %storemerge.i.i = select i1 %cmp.i.i, i64 %and8.i.i, i64 4294967295
  %conv13.i = and i64 %i58, 4294967295
  %cmp122.not.i = icmp ule i64 %storemerge.i.i, %conv13.i
  %cmp127.i = icmp ugt i64 %reg_lo.i.sroa.15.0, %conv13.i
  %narrow = select i1 %cmp122.not.i, i1 true, i1 %cmp127.i
...
if.then44:                                        ; preds = %if.then25, %land.lhs.true, %entry
  ...
  %lo_reg1.sroa.13.0.copyload = load i64, i64* %umax_value.i19, align 8
  %and.i.i = and i64 %lo_reg0.sroa.1.0.copyload, 4294967295
  %and6.i.i30 = and i64 %lo_reg0.sroa.4.0.copyload, 4294967295
  %and.i.i39 = and i64 %lo_reg1.sroa.1.0.copyload, 4294967295
...
cond.end:                                         ; preds = %if.then52
  %and.i16.i = and i64 %lo_reg0.sroa.1.0.copyload, -4294967296
  %cond124.i = or i64 %and.i16.i, 1
  %add137.i = add i64 %cond124.i, %and.i.i39
  %i130.i = load i64, i64* %value3.i, align 8
  %i132.i = load i64, i64* %mask6.i, align 8
  %or.i17.i = or i64 %i132.i, %i130.i
  %and.i18.i = and i64 %or.i17.i, -4294967296
  %add140.i = or i64 %and.i18.i, %and.i.i39
  %i133.i = load i64, i64* %umin_value.i, align 8
  %cmp144.i = icmp ugt i64 %i133.i, %add137.i
  %cond149.i = select i1 %cmp144.i, i64 %i133.i, i64 %add137.i
  store i64 %cond149.i, i64* %umin_value.i, align 8
  %i134.i = load i64, i64* %umax_value10.i, align 8
  %cmp153.i = icmp ult i64 %i134.i, %add140.i
  %cond158.i = select i1 %cmp153.i, i64 %i134.i, i64 %add140.i
  store i64 %cond158.i, i64* %umax_value10.i, align 8
...
if.then.i.i64:                                    ; preds = %lor.lhs.false.i.i, %cond.end
...
if.end.i.i.i.i:                                   ; preds = %__reg_deduce_bounds.exit81.i
  ...
  %phi.bo35 = and i32 %add.i.i.i.i, 255
  br label %__reg_bound_offset.exit.i

__reg_bound_offset.exit.i:                        ; preds = %if.end.i.i.i.i, %__reg_deduce_bounds.exit81.i
  %retval.0.i.i.i.i = phi i32 [ %phi.bo35, %if.end.i.i.i.i ], [ 0, %__reg_deduce_bounds.exit81.i ]
...
if.end.i.i.i124.i:                                ; preds = %__reg_bound_offset.exit.i
  ...
  %phi.bo36 = and i32 %add.i.i.i123.i, 255
  br label %reg_set_min_max.exit

reg_set_min_max.exit:                             ; preds = %if.end.i.i.i124.i, %__reg_bound_offset.exit.i
  %retval.0.i.i.i125.i = phi i32 [ %phi.bo36, %if.end.i.i.i124.i ], [ 0, %__reg_bound_offset.exit.i ]
...
cond.end90:                                       ; preds = %if.else70
  %cond124.i77 = add nsw i64 %and.i.i, -1
  %or.i16.i = or i64 %lo_reg1.sroa.4.0.copyload, %lo_reg1.sroa.1.0.copyload
  %and.i17.i = and i64 %or.i16.i, -4294967296
  %add137.i82 = add i64 %cond124.i77, %and.i17.i
  %and.i18.i85 = and i64 %i13.i5, -4294967296
  %add140.i86 = or i64 %and.i.i, %and.i18.i85
  %cmp144.i88 = icmp ult i64 %lo_reg1.sroa.13.0.copyload, %add137.i82
  %cond149.i89 = select i1 %cmp144.i88, i64 %lo_reg1.sroa.13.0.copyload, i64 %add137.i82
  store i64 %cond149.i89, i64* %umax_value.i19, align 8
  %i134.i90 = load i64, i64* %umin_value9.i18, align 8
  %cmp153.i91 = icmp ugt i64 %i134.i90, %add140.i86
  %cond158.i92 = select i1 %cmp153.i91, i64 %i134.i90, i64 %add140.i86
  store i64 %cond158.i92, i64* %umin_value9.i18, align 8
  %i.i42.i94 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i95 = icmp sgt i64 %i.i42.i94, -1
  br i1 %cmp.i43.i95, label %if.then.i.i111, label %lor.lhs.false.i.i100

lor.lhs.false.i.i100:                             ; preds = %cond.end90
  %i33.i.i98 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i99 = icmp slt i64 %i33.i.i98, 0
  br i1 %cmp1.i45.i99, label %if.then.i.i111, label %if.end.i.i117

if.then.i.i111:                                   ; preds = %lor.lhs.false.i.i100, %cond.end90
  %i34.i.i102 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i103 = icmp ugt i64 %i.i42.i94, %i34.i.i102
  %cond.i.i104 = select i1 %cmp3.i.i103, i64 %i.i42.i94, i64 %i34.i.i102
  store i64 %cond.i.i104, i64* %umin_value.i16, align 8
  store i64 %cond.i.i104, i64* %smin_value.i10, align 8
  %i35.i.i106 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i108 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i109 = icmp ult i64 %i35.i.i106, %i36.i.i108
  %cond12.i.i110 = select i1 %cmp8.i48.i109, i64 %i35.i.i106, i64 %i36.i.i108
  store i64 %cond12.i.i110, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i129.sink.split

if.end.i.i117:                                    ; preds = %lor.lhs.false.i.i100
  %i37.i.i113 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i114 = icmp sgt i64 %i37.i.i113, -1
  %i38.i.i116 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i114, label %if.then17.i.i120, label %if.else.i.i122

if.then17.i.i120:                                 ; preds = %if.end.i.i117
  store i64 %i38.i.i116, i64* %smin_value.i10, align 8
  %cmp23.i.i118 = icmp ult i64 %i33.i.i98, %i37.i.i113
  %cond27.i.i119 = select i1 %cmp23.i.i118, i64 %i33.i.i98, i64 %i37.i.i113
  store i64 %cond27.i.i119, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i129.sink.split

if.else.i.i122:                                   ; preds = %if.end.i.i117
  %cmp31.i.i121 = icmp slt i64 %i38.i.i116, 0
  br i1 %cmp31.i.i121, label %if.then32.i.i125, label %__reg_deduce_bounds.exit.i129

if.then32.i.i125:                                 ; preds = %if.else.i.i122
  %cmp36.i.i123 = icmp ugt i64 %i.i42.i94, %i38.i.i116
  %cond40.i.i124 = select i1 %cmp36.i.i123, i64 %i.i42.i94, i64 %i38.i.i116
  store i64 %cond40.i.i124, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i124, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i129.sink.split

__reg_deduce_bounds.exit.i129.sink.split:         ; preds = %if.then32.i.i125, %if.then17.i.i120, %if.then.i.i111
  %i37.i.i113.sink = phi i64 [ %i37.i.i113, %if.then32.i.i125 ], [ %cond27.i.i119, %if.then17.i.i120 ], [ %cond12.i.i110, %if.then.i.i111 ]
  store i64 %i37.i.i113.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i129

__reg_deduce_bounds.exit.i129:                    ; preds = %__reg_deduce_bounds.exit.i129.sink.split, %if.else.i.i122
  %i.i50.i127 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i128 = icmp sgt i64 %i.i50.i127, -1
  br i1 %cmp.i51.i128, label %if.then.i66.i144, label %lor.lhs.false.i55.i133

lor.lhs.false.i55.i133:                           ; preds = %__reg_deduce_bounds.exit.i129
  %i33.i53.i131 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i132 = icmp slt i64 %i33.i53.i131, 0
  br i1 %cmp1.i54.i132, label %if.then.i66.i144, label %if.end.i72.i150

if.then.i66.i144:                                 ; preds = %lor.lhs.false.i55.i133, %__reg_deduce_bounds.exit.i129
  %i34.i57.i135 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i136 = icmp ugt i64 %i.i50.i127, %i34.i57.i135
  %cond.i59.i137 = select i1 %cmp3.i58.i136, i64 %i.i50.i127, i64 %i34.i57.i135
  store i64 %cond.i59.i137, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i137, i64* %smin_value7.i12, align 8
  %i35.i61.i139 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i141 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i142 = icmp ult i64 %i35.i61.i139, %i36.i63.i141
  %cond12.i65.i143 = select i1 %cmp8.i64.i142, i64 %i35.i61.i139, i64 %i36.i63.i141
  store i64 %cond12.i65.i143, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i165.sink.split

if.end.i72.i150:                                  ; preds = %lor.lhs.false.i55.i133
  %i37.i68.i146 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i147 = icmp sgt i64 %i37.i68.i146, -1
  %i38.i71.i149 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i147, label %if.then17.i75.i153, label %if.else.i77.i155

if.then17.i75.i153:                               ; preds = %if.end.i72.i150
  store i64 %i38.i71.i149, i64* %smin_value7.i12, align 8
  %cmp23.i73.i151 = icmp ult i64 %i33.i53.i131, %i37.i68.i146
  %cond27.i74.i152 = select i1 %cmp23.i73.i151, i64 %i33.i53.i131, i64 %i37.i68.i146
  store i64 %cond27.i74.i152, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i165.sink.split

if.else.i77.i155:                                 ; preds = %if.end.i72.i150
  %cmp31.i76.i154 = icmp slt i64 %i38.i71.i149, 0
  br i1 %cmp31.i76.i154, label %if.then32.i80.i158, label %__reg_deduce_bounds.exit81.i165

if.then32.i80.i158:                               ; preds = %if.else.i77.i155
  %cmp36.i78.i156 = icmp ugt i64 %i.i50.i127, %i38.i71.i149
  %cond40.i79.i157 = select i1 %cmp36.i78.i156, i64 %i.i50.i127, i64 %i38.i71.i149
  store i64 %cond40.i79.i157, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i157, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i165.sink.split

__reg_deduce_bounds.exit81.i165.sink.split:       ; preds = %if.then32.i80.i158, %if.then17.i75.i153, %if.then.i66.i144
  %i37.i68.i146.sink = phi i64 [ %i37.i68.i146, %if.then32.i80.i158 ], [ %cond27.i74.i152, %if.then17.i75.i153 ], [ %cond12.i65.i143, %if.then.i66.i144 ]
  store i64 %i37.i68.i146.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i165

__reg_deduce_bounds.exit81.i165:                  ; preds = %__reg_deduce_bounds.exit81.i165.sink.split, %if.else.i77.i155
  %i.i83.i160 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i162 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i163 = xor i64 %i5.i85.i162, %i.i83.i160
  %cmp.i.i.i.i164 = icmp eq i64 %xor.i.i.i163, 0
  br i1 %cmp.i.i.i.i164, label %__reg_bound_offset.exit.i223, label %if.end.i.i.i.i195

if.end.i.i.i.i195:                                ; preds = %__reg_deduce_bounds.exit81.i165
  %tobool.not.i.i.i.i.i166 = icmp ult i64 %xor.i.i.i163, 4294967296
  %shl.i.i.i.i.i167 = shl i64 %xor.i.i.i163, 32
  %spec.select.i.i.i.i.i168 = select i1 %tobool.not.i.i.i.i.i166, i64 %shl.i.i.i.i.i167, i64 %xor.i.i.i163
  %spec.select17.i.i.i.i.i169 = select i1 %tobool.not.i.i.i.i.i166, i32 31, i32 63
  %tobool2.not.i.i.i.i.i170 = icmp ult i64 %spec.select.i.i.i.i.i168, 281474976710656
  %sub4.i.i.i.i.i171 = add nsw i32 %spec.select17.i.i.i.i.i169, -16
  %shl5.i.i.i.i.i172 = shl i64 %spec.select.i.i.i.i.i168, 16
  %word.addr.1.i.i.i.i.i173 = select i1 %tobool2.not.i.i.i.i.i170, i64 %shl5.i.i.i.i.i172, i64 %spec.select.i.i.i.i.i168
  %num.1.i.i.i.i.i174 = select i1 %tobool2.not.i.i.i.i.i170, i32 %sub4.i.i.i.i.i171, i32 %spec.select17.i.i.i.i.i169
  %tobool8.not.i.i.i.i.i175 = icmp ult i64 %word.addr.1.i.i.i.i.i173, 72057594037927936
  %sub10.i.i.i.i.i176 = add nsw i32 %num.1.i.i.i.i.i174, -8
  %shl11.i.i.i.i.i177 = shl i64 %word.addr.1.i.i.i.i.i173, 8
  %word.addr.2.i.i.i.i.i178 = select i1 %tobool8.not.i.i.i.i.i175, i64 %shl11.i.i.i.i.i177, i64 %word.addr.1.i.i.i.i.i173
  %num.2.i.i.i.i.i179 = select i1 %tobool8.not.i.i.i.i.i175, i32 %sub10.i.i.i.i.i176, i32 %num.1.i.i.i.i.i174
  %tobool14.not.i.i.i.i.i180 = icmp ult i64 %word.addr.2.i.i.i.i.i178, 1152921504606846976
  %sub16.i.i.i.i.i181 = add nsw i32 %num.2.i.i.i.i.i179, -4
  %shl17.i.i.i.i.i182 = shl i64 %word.addr.2.i.i.i.i.i178, 4
  %word.addr.3.i.i.i.i.i183 = select i1 %tobool14.not.i.i.i.i.i180, i64 %shl17.i.i.i.i.i182, i64 %word.addr.2.i.i.i.i.i178
  %num.3.i.i.i.i.i184 = select i1 %tobool14.not.i.i.i.i.i180, i32 %sub16.i.i.i.i.i181, i32 %num.2.i.i.i.i.i179
  %tobool20.not.i.i.i.i.i185 = icmp ult i64 %word.addr.3.i.i.i.i.i183, 4611686018427387904
  %sub22.i.i.i.i.i186 = add i32 %num.3.i.i.i.i.i184, 254
  %shl23.i.i.i.i.i187 = shl i64 %word.addr.3.i.i.i.i.i183, 2
  %word.addr.4.i.i.i.i.i188 = select i1 %tobool20.not.i.i.i.i.i185, i64 %shl23.i.i.i.i.i187, i64 %word.addr.3.i.i.i.i.i183
  %num.4.i.i.i.i.i189 = select i1 %tobool20.not.i.i.i.i.i185, i32 %sub22.i.i.i.i.i186, i32 %num.3.i.i.i.i.i184
  %word.addr.4.lobit.i.i.i.i.i190.neg = lshr i64 %word.addr.4.i.i.i.i.i188, 63
  %i.i.i.i.i.i191.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i190.neg to i32
  %add.i.i.i.i194 = add i32 %num.4.i.i.i.i.i189, %i.i.i.i.i.i191.neg
  %phi.bo = and i32 %add.i.i.i.i194, 255
  br label %__reg_bound_offset.exit.i223

__reg_bound_offset.exit.i223:                     ; preds = %if.end.i.i.i.i195, %__reg_deduce_bounds.exit81.i165
  %retval.0.i.i.i.i196 = phi i32 [ %phi.bo, %if.end.i.i.i.i195 ], [ 0, %__reg_deduce_bounds.exit81.i165 ]
  %cmp.i.i.i198 = icmp ugt i32 %retval.0.i.i.i.i196, 63
  %sh_prom.i.i.i199 = zext i32 %retval.0.i.i.i.i196 to i64
  %notmask.i.i.i200 = shl nsw i64 -1, %sh_prom.i.i.i199
  %sub.i.i.i201 = xor i64 %notmask.i.i.i200, -1
  %and.i.i.i202 = and i64 %notmask.i.i.i200, %i.i83.i160
  %retval.sroa.0.0.i.i.i203 = select i1 %cmp.i.i.i198, i64 0, i64 %and.i.i.i202
  %retval.sroa.3.0.i.i.i204 = select i1 %cmp.i.i.i198, i64 -1, i64 %sub.i.i.i201
  %i9.i.i208 = load i64, i64* %value.i4, align 8
  %i11.i.i210 = load i64, i64* %mask.i7, align 8
  %or.i.i.i211 = or i64 %retval.sroa.0.0.i.i.i203, %i9.i.i208
  %and.i1.i.i212 = and i64 %retval.sroa.3.0.i.i.i204, %i11.i.i210
  %neg.i.i.i213 = xor i64 %and.i1.i.i212, -1
  %and4.i.i.i214 = and i64 %or.i.i.i211, %neg.i.i.i213
  store i64 %and4.i.i.i214, i64* %value.i4, align 8
  store i64 %and.i1.i.i212, i64* %mask.i7, align 8
  %i.i90.i218 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i220 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i221 = xor i64 %i5.i92.i220, %i.i90.i218
  %cmp.i.i.i94.i222 = icmp eq i64 %xor.i.i93.i221, 0
  br i1 %cmp.i.i.i94.i222, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i253

if.end.i.i.i124.i253:                             ; preds = %__reg_bound_offset.exit.i223
  %tobool.not.i.i.i.i95.i224 = icmp ult i64 %xor.i.i93.i221, 4294967296
  %shl.i.i.i.i96.i225 = shl i64 %xor.i.i93.i221, 32
  %spec.select.i.i.i.i97.i226 = select i1 %tobool.not.i.i.i.i95.i224, i64 %shl.i.i.i.i96.i225, i64 %xor.i.i93.i221
  %spec.select17.i.i.i.i98.i227 = select i1 %tobool.not.i.i.i.i95.i224, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i228 = icmp ult i64 %spec.select.i.i.i.i97.i226, 281474976710656
  %sub4.i.i.i.i100.i229 = add nsw i32 %spec.select17.i.i.i.i98.i227, -16
  %shl5.i.i.i.i101.i230 = shl i64 %spec.select.i.i.i.i97.i226, 16
  %word.addr.1.i.i.i.i102.i231 = select i1 %tobool2.not.i.i.i.i99.i228, i64 %shl5.i.i.i.i101.i230, i64 %spec.select.i.i.i.i97.i226
  %num.1.i.i.i.i103.i232 = select i1 %tobool2.not.i.i.i.i99.i228, i32 %sub4.i.i.i.i100.i229, i32 %spec.select17.i.i.i.i98.i227
  %tobool8.not.i.i.i.i104.i233 = icmp ult i64 %word.addr.1.i.i.i.i102.i231, 72057594037927936
  %sub10.i.i.i.i105.i234 = add nsw i32 %num.1.i.i.i.i103.i232, -8
  %shl11.i.i.i.i106.i235 = shl i64 %word.addr.1.i.i.i.i102.i231, 8
  %word.addr.2.i.i.i.i107.i236 = select i1 %tobool8.not.i.i.i.i104.i233, i64 %shl11.i.i.i.i106.i235, i64 %word.addr.1.i.i.i.i102.i231
  %num.2.i.i.i.i108.i237 = select i1 %tobool8.not.i.i.i.i104.i233, i32 %sub10.i.i.i.i105.i234, i32 %num.1.i.i.i.i103.i232
  %tobool14.not.i.i.i.i109.i238 = icmp ult i64 %word.addr.2.i.i.i.i107.i236, 1152921504606846976
  %sub16.i.i.i.i110.i239 = add nsw i32 %num.2.i.i.i.i108.i237, -4
  %shl17.i.i.i.i111.i240 = shl i64 %word.addr.2.i.i.i.i107.i236, 4
  %word.addr.3.i.i.i.i112.i241 = select i1 %tobool14.not.i.i.i.i109.i238, i64 %shl17.i.i.i.i111.i240, i64 %word.addr.2.i.i.i.i107.i236
  %num.3.i.i.i.i113.i242 = select i1 %tobool14.not.i.i.i.i109.i238, i32 %sub16.i.i.i.i110.i239, i32 %num.2.i.i.i.i108.i237
  %tobool20.not.i.i.i.i114.i243 = icmp ult i64 %word.addr.3.i.i.i.i112.i241, 4611686018427387904
  %sub22.i.i.i.i115.i244 = add i32 %num.3.i.i.i.i113.i242, 254
  %shl23.i.i.i.i116.i245 = shl i64 %word.addr.3.i.i.i.i112.i241, 2
  %word.addr.4.i.i.i.i117.i246 = select i1 %tobool20.not.i.i.i.i114.i243, i64 %shl23.i.i.i.i116.i245, i64 %word.addr.3.i.i.i.i112.i241
  %num.4.i.i.i.i118.i247 = select i1 %tobool20.not.i.i.i.i114.i243, i32 %sub22.i.i.i.i115.i244, i32 %num.3.i.i.i.i113.i242
  %word.addr.4.lobit.i.i.i.i119.i248.neg = lshr i64 %word.addr.4.i.i.i.i117.i246, 63
  %i.i.i.i.i120.i249.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i248.neg to i32
  %add.i.i.i123.i252 = add i32 %num.4.i.i.i.i118.i247, %i.i.i.i.i120.i249.neg
  %phi.bo34 = and i32 %add.i.i.i123.i252, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i253, %__reg_bound_offset.exit.i223
  %retval.0.i.i.i125.i254 = phi i32 [ %phi.bo34, %if.end.i.i.i124.i253 ], [ 0, %__reg_bound_offset.exit.i223 ]
  %cmp.i.i127.i256 = icmp ugt i32 %retval.0.i.i.i125.i254, 63
  %sh_prom.i.i128.i257 = zext i32 %retval.0.i.i.i125.i254 to i64
  %notmask.i.i129.i258 = shl nsw i64 -1, %sh_prom.i.i128.i257
  %sub.i.i130.i259 = xor i64 %notmask.i.i129.i258, -1
  %and.i.i131.i260 = and i64 %notmask.i.i129.i258, %i.i90.i218
  %retval.sroa.0.0.i.i132.i261 = select i1 %cmp.i.i127.i256, i64 0, i64 %and.i.i131.i260
  %retval.sroa.3.0.i.i133.i262 = select i1 %cmp.i.i127.i256, i64 -1, i64 %sub.i.i130.i259
  %i9.i137.i266 = load i64, i64* %value3.i6, align 8
  %i11.i139.i268 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i269 = or i64 %retval.sroa.0.0.i.i132.i261, %i9.i137.i266
  %and.i1.i141.i270 = and i64 %retval.sroa.3.0.i.i133.i262, %i11.i139.i268
  %neg.i.i142.i271 = xor i64 %and.i1.i141.i270, -1
  %and4.i.i143.i272 = and i64 %or.i.i140.i269, %neg.i.i142.i271
  store i64 %and4.i.i143.i272, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i270, i64* %mask6.i9, align 8
  %i.i148.i276 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i278 = load i64, i64* %value.i4, align 8
  %i24.i.i280 = load i64, i64* %mask.i7, align 8
  %and.i149.i281 = and i64 %i24.i.i280, -9223372036854775808
  %or.i150.i282 = or i64 %and.i149.i281, %i23.i.i278
  %cmp.i151.i283 = icmp sgt i64 %i.i148.i276, %or.i150.i282
  %cond.i152.i284 = select i1 %cmp.i151.i283, i64 %i.i148.i276, i64 %or.i150.i282
  store i64 %cond.i152.i284, i64* %smin_value.i10, align 8
  %i25.i.i286 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i287 = and i64 %i24.i.i280, 9223372036854775807
  %or8.i.i288 = or i64 %and7.i.i287, %i23.i.i278
  %cmp10.i.i289 = icmp slt i64 %i25.i.i286, %or8.i.i288
  %cond14.i.i290 = select i1 %cmp10.i.i289, i64 %i25.i.i286, i64 %or8.i.i288
  store i64 %cond14.i.i290, i64* %smax_value.i13, align 8
  %i26.i.i292 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i293 = icmp ugt i64 %i26.i.i292, %i23.i.i278
  %cond23.i.i294 = select i1 %cmp19.i.i293, i64 %i26.i.i292, i64 %i23.i.i278
  store i64 %cond23.i.i294, i64* %umin_value.i16, align 8
  %i27.i.i296 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i297 = or i64 %i24.i.i280, %i23.i.i278
  %cmp31.i156.i298 = icmp ult i64 %i27.i.i296, %or29.i.i297
  %cond35.i.i299 = select i1 %cmp31.i156.i298, i64 %i27.i.i296, i64 %or29.i.i297
  store i64 %cond35.i.i299, i64* %umax_value.i19, align 8
  %i.i158.i301 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i303 = load i64, i64* %value3.i6, align 8
  %i24.i162.i305 = load i64, i64* %mask6.i9, align 8
  %and.i163.i306 = and i64 %i24.i162.i305, -9223372036854775808
  %or.i164.i307 = or i64 %and.i163.i306, %i23.i160.i303
  %cmp.i165.i308 = icmp sgt i64 %i.i158.i301, %or.i164.i307
  %cond.i166.i309 = select i1 %cmp.i165.i308, i64 %i.i158.i301, i64 %or.i164.i307
  store i64 %cond.i166.i309, i64* %smin_value7.i12, align 8
  %i25.i168.i311 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i312 = and i64 %i24.i162.i305, 9223372036854775807
  %or8.i170.i313 = or i64 %and7.i169.i312, %i23.i160.i303
  %cmp10.i171.i314 = icmp slt i64 %i25.i168.i311, %or8.i170.i313
  %cond14.i172.i315 = select i1 %cmp10.i171.i314, i64 %i25.i168.i311, i64 %or8.i170.i313
  store i64 %cond14.i172.i315, i64* %smax_value8.i15, align 8
  %i26.i174.i317 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i318 = icmp ugt i64 %i26.i174.i317, %i23.i160.i303
  %cond23.i176.i319 = select i1 %cmp19.i175.i318, i64 %i26.i174.i317, i64 %i23.i160.i303
  store i64 %cond23.i176.i319, i64* %umin_value9.i18, align 8
  %i27.i178.i321 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i322 = or i64 %i24.i162.i305, %i23.i160.i303
  %cmp31.i180.i323 = icmp ult i64 %i27.i178.i321, %or29.i179.i322
  %cond35.i181.i324 = select i1 %cmp31.i180.i323, i64 %i27.i178.i321, i64 %or29.i179.i322
  store i64 %cond35.i181.i324, i64* %umax_value10.i21, align 8
  br label %if.end117
