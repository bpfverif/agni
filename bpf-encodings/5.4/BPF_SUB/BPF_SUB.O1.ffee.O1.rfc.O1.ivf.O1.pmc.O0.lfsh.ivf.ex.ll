; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_SUB/BPF_SUB.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @adjust_scalar_min_max_vals_wrapper_BPF_SUB(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg) local_unnamed_addr #0 {
entry:
...
lor.lhs.false94.i:                                ; preds = %if.end27.i
...
if.then98.i:                                      ; preds = %lor.lhs.false94.i, %if.end27.i
...
if.else112.i:                                     ; preds = %if.end105.i
...
lor.lhs.false.i.i:                                ; preds = %if.end117.i
...
if.then.i329.i:                                   ; preds = %lor.lhs.false.i.i, %if.end117.i
