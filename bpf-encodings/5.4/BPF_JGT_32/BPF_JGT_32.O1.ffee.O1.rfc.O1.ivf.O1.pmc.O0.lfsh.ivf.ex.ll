; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JGT_32/BPF_JGT_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JGT_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %cmp.i = icmp ugt i64 %reg_lo.i.sroa.15.0, %conv13.i
  %cmp55.not.i = icmp ule i64 %storemerge.i.i, %conv13.i
  %narrow = select i1 %cmp.i, i1 true, i1 %cmp55.not.i
...
if.then44:                                        ; preds = %if.then25, %land.lhs.true, %entry
  ...
  %and.i.i40 = and i64 %lo_reg1.sroa.1.0.copyload, 4294967295
...
if.then52:                                        ; preds = %if.then44
  ...
  %and6.i.i41 = and i64 %lo_reg1.sroa.4.0.copyload, 4294967295
  %tobool.not.i61 = icmp eq i64 %and6.i.i41, 0
  br i1 %tobool.not.i61, label %cond.end, label %if.else70

cond.end:                                         ; preds = %if.then52
  %cond52.i = add nuw nsw i64 %and.i.i40, 1
  %or.i9.i = or i64 %lo_reg0.sroa.4.0.copyload, %lo_reg0.sroa.1.0.copyload
  %and.i10.i = and i64 %or.i9.i, -4294967296
  %add57.i = or i64 %and.i10.i, %and.i.i40
  %i122.i = load i64, i64* %value3.i, align 8
  %and.i11.i = and i64 %i122.i, -4294967296
  %add60.i = add i64 %cond52.i, %and.i11.i
...
if.then.i.i67:                                    ; preds = %lor.lhs.false.i.i, %cond.end
...
cond.end90:                                       ; preds = %if.else70
  ...
  %add57.i83 = or i64 %and.i9.i, %and.i.i
  %or.i10.i = or i64 %i14.i8, %i13.i5
  %and.i11.i88 = and i64 %or.i10.i, -4294967296
  %cond52.i80 = add i64 %and.i11.i88, -1
  %add60.i89 = add i64 %cond52.i80, %and.i.i
  %cmp63.i92 = icmp ugt i64 %lo_reg1.sroa.9.0.copyload, %add57.i83
  %cond68.i93 = select i1 %cmp63.i92, i64 %lo_reg1.sroa.9.0.copyload, i64 %add57.i83
  store i64 %cond68.i93, i64* %umin_value.i16, align 8
  %i124.i95 = load i64, i64* %umax_value10.i21, align 8
  %cmp71.i96 = icmp ult i64 %i124.i95, %add60.i89
  %cond76.i97 = select i1 %cmp71.i96, i64 %i124.i95, i64 %add60.i89
  store i64 %cond76.i97, i64* %umax_value10.i21, align 8
  %i.i42.i99 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i100 = icmp sgt i64 %i.i42.i99, -1
  br i1 %cmp.i43.i100, label %if.then.i.i116, label %lor.lhs.false.i.i105

lor.lhs.false.i.i105:                             ; preds = %cond.end90
  %i33.i.i103 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i104 = icmp slt i64 %i33.i.i103, 0
  br i1 %cmp1.i45.i104, label %if.then.i.i116, label %if.end.i.i122

if.then.i.i116:                                   ; preds = %lor.lhs.false.i.i105, %cond.end90
  %i34.i.i107 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i108 = icmp ugt i64 %i.i42.i99, %i34.i.i107
  %cond.i.i109 = select i1 %cmp3.i.i108, i64 %i.i42.i99, i64 %i34.i.i107
  store i64 %cond.i.i109, i64* %umin_value.i16, align 8
  store i64 %cond.i.i109, i64* %smin_value.i10, align 8
  %i35.i.i111 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i113 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i114 = icmp ult i64 %i35.i.i111, %i36.i.i113
  %cond12.i.i115 = select i1 %cmp8.i48.i114, i64 %i35.i.i111, i64 %i36.i.i113
  store i64 %cond12.i.i115, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i134.sink.split

if.end.i.i122:                                    ; preds = %lor.lhs.false.i.i105
  %i37.i.i118 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i119 = icmp sgt i64 %i37.i.i118, -1
  %i38.i.i121 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i119, label %if.then17.i.i125, label %if.else.i.i127

if.then17.i.i125:                                 ; preds = %if.end.i.i122
  store i64 %i38.i.i121, i64* %smin_value.i10, align 8
  %cmp23.i.i123 = icmp ult i64 %i33.i.i103, %i37.i.i118
  %cond27.i.i124 = select i1 %cmp23.i.i123, i64 %i33.i.i103, i64 %i37.i.i118
  store i64 %cond27.i.i124, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i134.sink.split

if.else.i.i127:                                   ; preds = %if.end.i.i122
  %cmp31.i.i126 = icmp slt i64 %i38.i.i121, 0
  br i1 %cmp31.i.i126, label %if.then32.i.i130, label %__reg_deduce_bounds.exit.i134

if.then32.i.i130:                                 ; preds = %if.else.i.i127
  %cmp36.i.i128 = icmp ugt i64 %i.i42.i99, %i38.i.i121
  %cond40.i.i129 = select i1 %cmp36.i.i128, i64 %i.i42.i99, i64 %i38.i.i121
  store i64 %cond40.i.i129, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i129, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i134.sink.split

__reg_deduce_bounds.exit.i134.sink.split:         ; preds = %if.then32.i.i130, %if.then17.i.i125, %if.then.i.i116
  %i37.i.i118.sink = phi i64 [ %i37.i.i118, %if.then32.i.i130 ], [ %cond27.i.i124, %if.then17.i.i125 ], [ %cond12.i.i115, %if.then.i.i116 ]
  store i64 %i37.i.i118.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i134

__reg_deduce_bounds.exit.i134:                    ; preds = %__reg_deduce_bounds.exit.i134.sink.split, %if.else.i.i127
  %i.i50.i132 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i133 = icmp sgt i64 %i.i50.i132, -1
  br i1 %cmp.i51.i133, label %if.then.i66.i149, label %lor.lhs.false.i55.i138

lor.lhs.false.i55.i138:                           ; preds = %__reg_deduce_bounds.exit.i134
  %i33.i53.i136 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i137 = icmp slt i64 %i33.i53.i136, 0
  br i1 %cmp1.i54.i137, label %if.then.i66.i149, label %if.end.i72.i155

if.then.i66.i149:                                 ; preds = %lor.lhs.false.i55.i138, %__reg_deduce_bounds.exit.i134
  %i34.i57.i140 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i141 = icmp ugt i64 %i.i50.i132, %i34.i57.i140
  %cond.i59.i142 = select i1 %cmp3.i58.i141, i64 %i.i50.i132, i64 %i34.i57.i140
  store i64 %cond.i59.i142, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i142, i64* %smin_value7.i12, align 8
  %i35.i61.i144 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i146 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i147 = icmp ult i64 %i35.i61.i144, %i36.i63.i146
  %cond12.i65.i148 = select i1 %cmp8.i64.i147, i64 %i35.i61.i144, i64 %i36.i63.i146
  store i64 %cond12.i65.i148, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i170.sink.split

if.end.i72.i155:                                  ; preds = %lor.lhs.false.i55.i138
  %i37.i68.i151 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i152 = icmp sgt i64 %i37.i68.i151, -1
  %i38.i71.i154 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i152, label %if.then17.i75.i158, label %if.else.i77.i160

if.then17.i75.i158:                               ; preds = %if.end.i72.i155
  store i64 %i38.i71.i154, i64* %smin_value7.i12, align 8
  %cmp23.i73.i156 = icmp ult i64 %i33.i53.i136, %i37.i68.i151
  %cond27.i74.i157 = select i1 %cmp23.i73.i156, i64 %i33.i53.i136, i64 %i37.i68.i151
  store i64 %cond27.i74.i157, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i170.sink.split

if.else.i77.i160:                                 ; preds = %if.end.i72.i155
  %cmp31.i76.i159 = icmp slt i64 %i38.i71.i154, 0
  br i1 %cmp31.i76.i159, label %if.then32.i80.i163, label %__reg_deduce_bounds.exit81.i170

if.then32.i80.i163:                               ; preds = %if.else.i77.i160
  %cmp36.i78.i161 = icmp ugt i64 %i.i50.i132, %i38.i71.i154
  %cond40.i79.i162 = select i1 %cmp36.i78.i161, i64 %i.i50.i132, i64 %i38.i71.i154
  store i64 %cond40.i79.i162, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i162, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i170.sink.split

__reg_deduce_bounds.exit81.i170.sink.split:       ; preds = %if.then32.i80.i163, %if.then17.i75.i158, %if.then.i66.i149
  %i37.i68.i151.sink = phi i64 [ %i37.i68.i151, %if.then32.i80.i163 ], [ %cond27.i74.i157, %if.then17.i75.i158 ], [ %cond12.i65.i148, %if.then.i66.i149 ]
  store i64 %i37.i68.i151.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i170

__reg_deduce_bounds.exit81.i170:                  ; preds = %__reg_deduce_bounds.exit81.i170.sink.split, %if.else.i77.i160
  %i.i83.i165 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i167 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i168 = xor i64 %i5.i85.i167, %i.i83.i165
  %cmp.i.i.i.i169 = icmp eq i64 %xor.i.i.i168, 0
  br i1 %cmp.i.i.i.i169, label %__reg_bound_offset.exit.i228, label %if.end.i.i.i.i200

if.end.i.i.i.i200:                                ; preds = %__reg_deduce_bounds.exit81.i170
  %tobool.not.i.i.i.i.i171 = icmp ult i64 %xor.i.i.i168, 4294967296
  %shl.i.i.i.i.i172 = shl i64 %xor.i.i.i168, 32
  %spec.select.i.i.i.i.i173 = select i1 %tobool.not.i.i.i.i.i171, i64 %shl.i.i.i.i.i172, i64 %xor.i.i.i168
  %spec.select17.i.i.i.i.i174 = select i1 %tobool.not.i.i.i.i.i171, i32 31, i32 63
  %tobool2.not.i.i.i.i.i175 = icmp ult i64 %spec.select.i.i.i.i.i173, 281474976710656
  %sub4.i.i.i.i.i176 = add nsw i32 %spec.select17.i.i.i.i.i174, -16
  %shl5.i.i.i.i.i177 = shl i64 %spec.select.i.i.i.i.i173, 16
  %word.addr.1.i.i.i.i.i178 = select i1 %tobool2.not.i.i.i.i.i175, i64 %shl5.i.i.i.i.i177, i64 %spec.select.i.i.i.i.i173
  %num.1.i.i.i.i.i179 = select i1 %tobool2.not.i.i.i.i.i175, i32 %sub4.i.i.i.i.i176, i32 %spec.select17.i.i.i.i.i174
  %tobool8.not.i.i.i.i.i180 = icmp ult i64 %word.addr.1.i.i.i.i.i178, 72057594037927936
  %sub10.i.i.i.i.i181 = add nsw i32 %num.1.i.i.i.i.i179, -8
  %shl11.i.i.i.i.i182 = shl i64 %word.addr.1.i.i.i.i.i178, 8
  %word.addr.2.i.i.i.i.i183 = select i1 %tobool8.not.i.i.i.i.i180, i64 %shl11.i.i.i.i.i182, i64 %word.addr.1.i.i.i.i.i178
  %num.2.i.i.i.i.i184 = select i1 %tobool8.not.i.i.i.i.i180, i32 %sub10.i.i.i.i.i181, i32 %num.1.i.i.i.i.i179
  %tobool14.not.i.i.i.i.i185 = icmp ult i64 %word.addr.2.i.i.i.i.i183, 1152921504606846976
  %sub16.i.i.i.i.i186 = add nsw i32 %num.2.i.i.i.i.i184, -4
  %shl17.i.i.i.i.i187 = shl i64 %word.addr.2.i.i.i.i.i183, 4
  %word.addr.3.i.i.i.i.i188 = select i1 %tobool14.not.i.i.i.i.i185, i64 %shl17.i.i.i.i.i187, i64 %word.addr.2.i.i.i.i.i183
  %num.3.i.i.i.i.i189 = select i1 %tobool14.not.i.i.i.i.i185, i32 %sub16.i.i.i.i.i186, i32 %num.2.i.i.i.i.i184
  %tobool20.not.i.i.i.i.i190 = icmp ult i64 %word.addr.3.i.i.i.i.i188, 4611686018427387904
  %sub22.i.i.i.i.i191 = add i32 %num.3.i.i.i.i.i189, 254
  %shl23.i.i.i.i.i192 = shl i64 %word.addr.3.i.i.i.i.i188, 2
  %word.addr.4.i.i.i.i.i193 = select i1 %tobool20.not.i.i.i.i.i190, i64 %shl23.i.i.i.i.i192, i64 %word.addr.3.i.i.i.i.i188
  %num.4.i.i.i.i.i194 = select i1 %tobool20.not.i.i.i.i.i190, i32 %sub22.i.i.i.i.i191, i32 %num.3.i.i.i.i.i189
  %word.addr.4.lobit.i.i.i.i.i195.neg = lshr i64 %word.addr.4.i.i.i.i.i193, 63
  %i.i.i.i.i.i196.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i195.neg to i32
  %add.i.i.i.i199 = add i32 %num.4.i.i.i.i.i194, %i.i.i.i.i.i196.neg
  %phi.bo = and i32 %add.i.i.i.i199, 255
  br label %__reg_bound_offset.exit.i228

__reg_bound_offset.exit.i228:                     ; preds = %if.end.i.i.i.i200, %__reg_deduce_bounds.exit81.i170
  %retval.0.i.i.i.i201 = phi i32 [ %phi.bo, %if.end.i.i.i.i200 ], [ 0, %__reg_deduce_bounds.exit81.i170 ]
  %cmp.i.i.i203 = icmp ugt i32 %retval.0.i.i.i.i201, 63
  %sh_prom.i.i.i204 = zext i32 %retval.0.i.i.i.i201 to i64
  %notmask.i.i.i205 = shl nsw i64 -1, %sh_prom.i.i.i204
  %sub.i.i.i206 = xor i64 %notmask.i.i.i205, -1
  %and.i.i.i207 = and i64 %notmask.i.i.i205, %i.i83.i165
  %retval.sroa.0.0.i.i.i208 = select i1 %cmp.i.i.i203, i64 0, i64 %and.i.i.i207
  %retval.sroa.3.0.i.i.i209 = select i1 %cmp.i.i.i203, i64 -1, i64 %sub.i.i.i206
  %i9.i.i213 = load i64, i64* %value.i4, align 8
  %i11.i.i215 = load i64, i64* %mask.i7, align 8
  %or.i.i.i216 = or i64 %retval.sroa.0.0.i.i.i208, %i9.i.i213
  %and.i1.i.i217 = and i64 %retval.sroa.3.0.i.i.i209, %i11.i.i215
  %neg.i.i.i218 = xor i64 %and.i1.i.i217, -1
  %and4.i.i.i219 = and i64 %or.i.i.i216, %neg.i.i.i218
  store i64 %and4.i.i.i219, i64* %value.i4, align 8
  store i64 %and.i1.i.i217, i64* %mask.i7, align 8
  %i.i90.i223 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i225 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i226 = xor i64 %i5.i92.i225, %i.i90.i223
  %cmp.i.i.i94.i227 = icmp eq i64 %xor.i.i93.i226, 0
  br i1 %cmp.i.i.i94.i227, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i258

if.end.i.i.i124.i258:                             ; preds = %__reg_bound_offset.exit.i228
  %tobool.not.i.i.i.i95.i229 = icmp ult i64 %xor.i.i93.i226, 4294967296
  %shl.i.i.i.i96.i230 = shl i64 %xor.i.i93.i226, 32
  %spec.select.i.i.i.i97.i231 = select i1 %tobool.not.i.i.i.i95.i229, i64 %shl.i.i.i.i96.i230, i64 %xor.i.i93.i226
  %spec.select17.i.i.i.i98.i232 = select i1 %tobool.not.i.i.i.i95.i229, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i233 = icmp ult i64 %spec.select.i.i.i.i97.i231, 281474976710656
  %sub4.i.i.i.i100.i234 = add nsw i32 %spec.select17.i.i.i.i98.i232, -16
  %shl5.i.i.i.i101.i235 = shl i64 %spec.select.i.i.i.i97.i231, 16
  %word.addr.1.i.i.i.i102.i236 = select i1 %tobool2.not.i.i.i.i99.i233, i64 %shl5.i.i.i.i101.i235, i64 %spec.select.i.i.i.i97.i231
  %num.1.i.i.i.i103.i237 = select i1 %tobool2.not.i.i.i.i99.i233, i32 %sub4.i.i.i.i100.i234, i32 %spec.select17.i.i.i.i98.i232
  %tobool8.not.i.i.i.i104.i238 = icmp ult i64 %word.addr.1.i.i.i.i102.i236, 72057594037927936
  %sub10.i.i.i.i105.i239 = add nsw i32 %num.1.i.i.i.i103.i237, -8
  %shl11.i.i.i.i106.i240 = shl i64 %word.addr.1.i.i.i.i102.i236, 8
  %word.addr.2.i.i.i.i107.i241 = select i1 %tobool8.not.i.i.i.i104.i238, i64 %shl11.i.i.i.i106.i240, i64 %word.addr.1.i.i.i.i102.i236
  %num.2.i.i.i.i108.i242 = select i1 %tobool8.not.i.i.i.i104.i238, i32 %sub10.i.i.i.i105.i239, i32 %num.1.i.i.i.i103.i237
  %tobool14.not.i.i.i.i109.i243 = icmp ult i64 %word.addr.2.i.i.i.i107.i241, 1152921504606846976
  %sub16.i.i.i.i110.i244 = add nsw i32 %num.2.i.i.i.i108.i242, -4
  %shl17.i.i.i.i111.i245 = shl i64 %word.addr.2.i.i.i.i107.i241, 4
  %word.addr.3.i.i.i.i112.i246 = select i1 %tobool14.not.i.i.i.i109.i243, i64 %shl17.i.i.i.i111.i245, i64 %word.addr.2.i.i.i.i107.i241
  %num.3.i.i.i.i113.i247 = select i1 %tobool14.not.i.i.i.i109.i243, i32 %sub16.i.i.i.i110.i244, i32 %num.2.i.i.i.i108.i242
  %tobool20.not.i.i.i.i114.i248 = icmp ult i64 %word.addr.3.i.i.i.i112.i246, 4611686018427387904
  %sub22.i.i.i.i115.i249 = add i32 %num.3.i.i.i.i113.i247, 254
  %shl23.i.i.i.i116.i250 = shl i64 %word.addr.3.i.i.i.i112.i246, 2
  %word.addr.4.i.i.i.i117.i251 = select i1 %tobool20.not.i.i.i.i114.i248, i64 %shl23.i.i.i.i116.i250, i64 %word.addr.3.i.i.i.i112.i246
  %num.4.i.i.i.i118.i252 = select i1 %tobool20.not.i.i.i.i114.i248, i32 %sub22.i.i.i.i115.i249, i32 %num.3.i.i.i.i113.i247
  %word.addr.4.lobit.i.i.i.i119.i253.neg = lshr i64 %word.addr.4.i.i.i.i117.i251, 63
  %i.i.i.i.i120.i254.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i253.neg to i32
  %add.i.i.i123.i257 = add i32 %num.4.i.i.i.i118.i252, %i.i.i.i.i120.i254.neg
  %phi.bo34 = and i32 %add.i.i.i123.i257, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i258, %__reg_bound_offset.exit.i228
  %retval.0.i.i.i125.i259 = phi i32 [ %phi.bo34, %if.end.i.i.i124.i258 ], [ 0, %__reg_bound_offset.exit.i228 ]
  %cmp.i.i127.i261 = icmp ugt i32 %retval.0.i.i.i125.i259, 63
  %sh_prom.i.i128.i262 = zext i32 %retval.0.i.i.i125.i259 to i64
  %notmask.i.i129.i263 = shl nsw i64 -1, %sh_prom.i.i128.i262
  %sub.i.i130.i264 = xor i64 %notmask.i.i129.i263, -1
  %and.i.i131.i265 = and i64 %notmask.i.i129.i263, %i.i90.i223
  %retval.sroa.0.0.i.i132.i266 = select i1 %cmp.i.i127.i261, i64 0, i64 %and.i.i131.i265
  %retval.sroa.3.0.i.i133.i267 = select i1 %cmp.i.i127.i261, i64 -1, i64 %sub.i.i130.i264
  %i9.i137.i271 = load i64, i64* %value3.i6, align 8
  %i11.i139.i273 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i274 = or i64 %retval.sroa.0.0.i.i132.i266, %i9.i137.i271
  %and.i1.i141.i275 = and i64 %retval.sroa.3.0.i.i133.i267, %i11.i139.i273
  %neg.i.i142.i276 = xor i64 %and.i1.i141.i275, -1
  %and4.i.i143.i277 = and i64 %or.i.i140.i274, %neg.i.i142.i276
  store i64 %and4.i.i143.i277, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i275, i64* %mask6.i9, align 8
  %i.i148.i281 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i283 = load i64, i64* %value.i4, align 8
  %i24.i.i285 = load i64, i64* %mask.i7, align 8
  %and.i149.i286 = and i64 %i24.i.i285, -9223372036854775808
  %or.i150.i287 = or i64 %and.i149.i286, %i23.i.i283
  %cmp.i151.i288 = icmp sgt i64 %i.i148.i281, %or.i150.i287
  %cond.i152.i289 = select i1 %cmp.i151.i288, i64 %i.i148.i281, i64 %or.i150.i287
  store i64 %cond.i152.i289, i64* %smin_value.i10, align 8
  %i25.i.i291 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i292 = and i64 %i24.i.i285, 9223372036854775807
  %or8.i.i293 = or i64 %and7.i.i292, %i23.i.i283
  %cmp10.i.i294 = icmp slt i64 %i25.i.i291, %or8.i.i293
  %cond14.i.i295 = select i1 %cmp10.i.i294, i64 %i25.i.i291, i64 %or8.i.i293
  store i64 %cond14.i.i295, i64* %smax_value.i13, align 8
  %i26.i.i297 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i298 = icmp ugt i64 %i26.i.i297, %i23.i.i283
  %cond23.i.i299 = select i1 %cmp19.i.i298, i64 %i26.i.i297, i64 %i23.i.i283
  store i64 %cond23.i.i299, i64* %umin_value.i16, align 8
  %i27.i.i301 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i302 = or i64 %i24.i.i285, %i23.i.i283
  %cmp31.i156.i303 = icmp ult i64 %i27.i.i301, %or29.i.i302
  %cond35.i.i304 = select i1 %cmp31.i156.i303, i64 %i27.i.i301, i64 %or29.i.i302
  store i64 %cond35.i.i304, i64* %umax_value.i19, align 8
  %i.i158.i306 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i308 = load i64, i64* %value3.i6, align 8
  %i24.i162.i310 = load i64, i64* %mask6.i9, align 8
  %and.i163.i311 = and i64 %i24.i162.i310, -9223372036854775808
  %or.i164.i312 = or i64 %and.i163.i311, %i23.i160.i308
  %cmp.i165.i313 = icmp sgt i64 %i.i158.i306, %or.i164.i312
  %cond.i166.i314 = select i1 %cmp.i165.i313, i64 %i.i158.i306, i64 %or.i164.i312
  store i64 %cond.i166.i314, i64* %smin_value7.i12, align 8
  %i25.i168.i316 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i317 = and i64 %i24.i162.i310, 9223372036854775807
  %or8.i170.i318 = or i64 %and7.i169.i317, %i23.i160.i308
  %cmp10.i171.i319 = icmp slt i64 %i25.i168.i316, %or8.i170.i318
  %cond14.i172.i320 = select i1 %cmp10.i171.i319, i64 %i25.i168.i316, i64 %or8.i170.i318
  store i64 %cond14.i172.i320, i64* %smax_value8.i15, align 8
  %i26.i174.i322 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i323 = icmp ugt i64 %i26.i174.i322, %i23.i160.i308
  %cond23.i176.i324 = select i1 %cmp19.i175.i323, i64 %i26.i174.i322, i64 %i23.i160.i308
  store i64 %cond23.i176.i324, i64* %umin_value9.i18, align 8
  %i27.i178.i326 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i327 = or i64 %i24.i162.i310, %i23.i160.i308
  %cmp31.i180.i328 = icmp ult i64 %i27.i178.i326, %or29.i179.i327
  %cond35.i181.i329 = select i1 %cmp31.i180.i328, i64 %i27.i178.i326, i64 %or29.i179.i327
  store i64 %cond35.i181.i329, i64* %umax_value10.i21, align 8
  br label %if.end117
