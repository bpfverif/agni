; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_RSH/BPF_RSH.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @adjust_scalar_min_max_vals_wrapper_BPF_RSH(%struct.bpf_reg_state* noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg) local_unnamed_addr #0 {
entry:
...
sw.bb272.i:                                       ; preds = %if.end27.i
  %cmp273.not.i = icmp ult i64 %src_reg1.sroa.22.0.copyload, 64
...
if.then275.i:                                     ; preds = %sw.bb272.i
  ...
  %smin_value.i.i221.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 6
  store i64 -9223372036854775808, i64* %smin_value.i.i221.i, align 8
  %smax_value.i.i222.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 7
  store i64 9223372036854775807, i64* %smax_value.i.i222.i, align 8
  %umin_value.i.i223.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 8
  store i64 0, i64* %umin_value.i.i223.i, align 8
  %umax_value.i.i224.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 9
  store i64 -1, i64* %umax_value.i.i224.i, align 8
  br label %if.end309.i

if.end276.i:                                      ; preds = %sw.bb272.i
  %smin_value277.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 6
  store i64 -9223372036854775808, i64* %smin_value277.i, align 8
  %smax_value278.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 7
  store i64 9223372036854775807, i64* %smax_value278.i, align 8
  %i266.i = load i64, i64* %i213.i, align 8
  %sh_prom.i225.i = and i64 %src_reg1.sroa.17.0.copyload, 255
  %shr.i.i = lshr i64 %i266.i, %sh_prom.i225.i
  %shr5.i.i = lshr i64 %i215.i, %sh_prom.i225.i
  store i64 %shr.i.i, i64* %i213.i, align 8
  store i64 %shr5.i.i, i64* %i214.i, align 8
  %umin_value284.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 8
  %i269.i = load i64, i64* %umin_value284.i, align 8
  %shr.i = lshr i64 %i269.i, %src_reg1.sroa.22.0.copyload
  store i64 %shr.i, i64* %umin_value284.i, align 8
  %umax_value285.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %dst_reg, i64 0, i32 9
  %i270.i = load i64, i64* %umax_value285.i, align 8
  %shr286.i = lshr i64 %i270.i, %src_reg1.sroa.17.0.copyload
  store i64 %shr286.i, i64* %umax_value285.i, align 8
  %and.i234.i = and i64 %shr5.i.i, -9223372036854775808
  %or.i235.i = or i64 %shr.i.i, %and.i234.i
  store i64 %or.i235.i, i64* %smin_value277.i, align 8
  %and7.i240.i = and i64 %shr5.i.i, 9223372036854775807
  %or8.i241.i = or i64 %shr.i.i, %and7.i240.i
  store i64 %or8.i241.i, i64* %smax_value278.i, align 8
  %cmp19.i246.i = icmp ugt i64 %shr.i, %shr.i.i
  %cond23.i247.i = select i1 %cmp19.i246.i, i64 %shr.i, i64 %shr.i.i
  store i64 %cond23.i247.i, i64* %umin_value284.i, align 8
  %or29.i250.i = or i64 %shr.i.i, %shr5.i.i
  %cmp31.i251.i = icmp ult i64 %shr286.i, %or29.i250.i
  %cond35.i252.i = select i1 %cmp31.i251.i, i64 %shr286.i, i64 %or29.i250.i
  store i64 %cond35.i252.i, i64* %umax_value285.i, align 8
  br label %if.end309.i

if.end309.i:                                      ; preds = %if.end276.i, %if.then275.i
...
lor.lhs.false.i.i:                                ; preds = %if.end309.i
...
if.then.i329.i:                                   ; preds = %lor.lhs.false.i.i, %if.end309.i
...
__reg_deduce_bounds.exit.i:                       ; preds = %if.then32.i.i, %if.else.i331.i, %if.then17.i.i, %if.then.i329.i
...
if.end.i.i.i.i:                                   ; preds = %__reg_deduce_bounds.exit.i
...
__reg_bound_offset.exit.i:                        ; preds = %if.end.i.i.i.i, %__reg_deduce_bounds.exit.i
