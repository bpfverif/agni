; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JNE_32/BPF_JNE_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JNE_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  %reg_lo.i.sroa.6.0.copyload = load i64, i64* %mask.i, align 8
  %and6.i.i.i = and i64 %reg_lo.i.sroa.6.0.copyload, 4294967295
  %tobool.not.i3.i = icmp eq i64 %and6.i.i.i, 0
  br i1 %tobool.not.i3.i, label %if.end117, label %if.then44
...
cond.end:                                         ; preds = %if.then52
  %and.i64 = and i64 %lo_reg0.sroa.1.0.copyload, -4294967296
  %or.i = or i64 %and.i.i39, %and.i64
  store i64 %or.i, i64* %value.i, align 8
  %and22.i = and i64 %lo_reg0.sroa.4.0.copyload, -4294967296
  store i64 %and22.i, i64* %mask.i, align 8
...
cond.end90:                                       ; preds = %if.else70
  %and.i82 = and i64 %lo_reg1.sroa.1.0.copyload, -4294967296
  %or.i83 = or i64 %and.i82, %and.i.i
  store i64 %or.i83, i64* %value.i4, align 8
  %and22.i86 = and i64 %lo_reg1.sroa.4.0.copyload, -4294967296
  store i64 %and22.i86, i64* %mask.i7, align 8
  %i.i42.i88 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i89 = icmp sgt i64 %i.i42.i88, -1
  br i1 %cmp.i43.i89, label %if.then.i.i105, label %lor.lhs.false.i.i94

lor.lhs.false.i.i94:                              ; preds = %cond.end90
  %i33.i.i92 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i93 = icmp slt i64 %i33.i.i92, 0
  br i1 %cmp1.i45.i93, label %if.then.i.i105, label %if.end.i.i111

if.then.i.i105:                                   ; preds = %lor.lhs.false.i.i94, %cond.end90
  %cmp3.i.i97 = icmp ugt i64 %i.i42.i88, %lo_reg1.sroa.9.0.copyload
  %cond.i.i98 = select i1 %cmp3.i.i97, i64 %i.i42.i88, i64 %lo_reg1.sroa.9.0.copyload
  store i64 %cond.i.i98, i64* %umin_value.i16, align 8
  store i64 %cond.i.i98, i64* %smin_value.i10, align 8
  %i35.i.i100 = load i64, i64* %smax_value.i13, align 8
  %cmp8.i48.i103 = icmp ult i64 %i35.i.i100, %lo_reg1.sroa.13.0.copyload
  %cond12.i.i104 = select i1 %cmp8.i48.i103, i64 %i35.i.i100, i64 %lo_reg1.sroa.13.0.copyload
  store i64 %cond12.i.i104, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i123.sink.split

if.end.i.i111:                                    ; preds = %lor.lhs.false.i.i94
  %cmp16.i.i108 = icmp sgt i64 %lo_reg1.sroa.13.0.copyload, -1
  br i1 %cmp16.i.i108, label %if.then17.i.i114, label %if.else.i.i116

if.then17.i.i114:                                 ; preds = %if.end.i.i111
  store i64 %lo_reg1.sroa.9.0.copyload, i64* %smin_value.i10, align 8
  %cmp23.i.i112 = icmp ult i64 %i33.i.i92, %lo_reg1.sroa.13.0.copyload
  %cond27.i.i113 = select i1 %cmp23.i.i112, i64 %i33.i.i92, i64 %lo_reg1.sroa.13.0.copyload
  store i64 %cond27.i.i113, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i123.sink.split

if.else.i.i116:                                   ; preds = %if.end.i.i111
  %cmp31.i.i115 = icmp slt i64 %lo_reg1.sroa.9.0.copyload, 0
  br i1 %cmp31.i.i115, label %if.then32.i.i119, label %__reg_deduce_bounds.exit.i123

if.then32.i.i119:                                 ; preds = %if.else.i.i116
  %cmp36.i.i117 = icmp ugt i64 %i.i42.i88, %lo_reg1.sroa.9.0.copyload
  %cond40.i.i118 = select i1 %cmp36.i.i117, i64 %i.i42.i88, i64 %lo_reg1.sroa.9.0.copyload
  store i64 %cond40.i.i118, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i118, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i123.sink.split

__reg_deduce_bounds.exit.i123.sink.split:         ; preds = %if.then32.i.i119, %if.then17.i.i114, %if.then.i.i105
  %lo_reg1.sroa.13.0.copyload.sink = phi i64 [ %lo_reg1.sroa.13.0.copyload, %if.then32.i.i119 ], [ %cond27.i.i113, %if.then17.i.i114 ], [ %cond12.i.i104, %if.then.i.i105 ]
  store i64 %lo_reg1.sroa.13.0.copyload.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i123

__reg_deduce_bounds.exit.i123:                    ; preds = %__reg_deduce_bounds.exit.i123.sink.split, %if.else.i.i116
  %i.i50.i121 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i122 = icmp sgt i64 %i.i50.i121, -1
  br i1 %cmp.i51.i122, label %if.then.i66.i138, label %lor.lhs.false.i55.i127

lor.lhs.false.i55.i127:                           ; preds = %__reg_deduce_bounds.exit.i123
  %i33.i53.i125 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i126 = icmp slt i64 %i33.i53.i125, 0
  br i1 %cmp1.i54.i126, label %if.then.i66.i138, label %if.end.i72.i144

if.then.i66.i138:                                 ; preds = %lor.lhs.false.i55.i127, %__reg_deduce_bounds.exit.i123
  %i34.i57.i129 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i130 = icmp ugt i64 %i.i50.i121, %i34.i57.i129
  %cond.i59.i131 = select i1 %cmp3.i58.i130, i64 %i.i50.i121, i64 %i34.i57.i129
  store i64 %cond.i59.i131, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i131, i64* %smin_value7.i12, align 8
  %i35.i61.i133 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i135 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i136 = icmp ult i64 %i35.i61.i133, %i36.i63.i135
  %cond12.i65.i137 = select i1 %cmp8.i64.i136, i64 %i35.i61.i133, i64 %i36.i63.i135
  store i64 %cond12.i65.i137, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i159.sink.split

if.end.i72.i144:                                  ; preds = %lor.lhs.false.i55.i127
  %i37.i68.i140 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i141 = icmp sgt i64 %i37.i68.i140, -1
  %i38.i71.i143 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i141, label %if.then17.i75.i147, label %if.else.i77.i149

if.then17.i75.i147:                               ; preds = %if.end.i72.i144
  store i64 %i38.i71.i143, i64* %smin_value7.i12, align 8
  %cmp23.i73.i145 = icmp ult i64 %i33.i53.i125, %i37.i68.i140
  %cond27.i74.i146 = select i1 %cmp23.i73.i145, i64 %i33.i53.i125, i64 %i37.i68.i140
  store i64 %cond27.i74.i146, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i159.sink.split

if.else.i77.i149:                                 ; preds = %if.end.i72.i144
  %cmp31.i76.i148 = icmp slt i64 %i38.i71.i143, 0
  br i1 %cmp31.i76.i148, label %if.then32.i80.i152, label %__reg_deduce_bounds.exit81.i159

if.then32.i80.i152:                               ; preds = %if.else.i77.i149
  %cmp36.i78.i150 = icmp ugt i64 %i.i50.i121, %i38.i71.i143
  %cond40.i79.i151 = select i1 %cmp36.i78.i150, i64 %i.i50.i121, i64 %i38.i71.i143
  store i64 %cond40.i79.i151, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i151, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i159.sink.split

__reg_deduce_bounds.exit81.i159.sink.split:       ; preds = %if.then32.i80.i152, %if.then17.i75.i147, %if.then.i66.i138
  %i37.i68.i140.sink = phi i64 [ %i37.i68.i140, %if.then32.i80.i152 ], [ %cond27.i74.i146, %if.then17.i75.i147 ], [ %cond12.i65.i137, %if.then.i66.i138 ]
  store i64 %i37.i68.i140.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i159

__reg_deduce_bounds.exit81.i159:                  ; preds = %__reg_deduce_bounds.exit81.i159.sink.split, %if.else.i77.i149
  %i.i83.i154 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i156 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i157 = xor i64 %i5.i85.i156, %i.i83.i154
  %cmp.i.i.i.i158 = icmp eq i64 %xor.i.i.i157, 0
  br i1 %cmp.i.i.i.i158, label %__reg_bound_offset.exit.i217, label %if.end.i.i.i.i189

if.end.i.i.i.i189:                                ; preds = %__reg_deduce_bounds.exit81.i159
  %tobool.not.i.i.i.i.i160 = icmp ult i64 %xor.i.i.i157, 4294967296
  %shl.i.i.i.i.i161 = shl i64 %xor.i.i.i157, 32
  %spec.select.i.i.i.i.i162 = select i1 %tobool.not.i.i.i.i.i160, i64 %shl.i.i.i.i.i161, i64 %xor.i.i.i157
  %spec.select17.i.i.i.i.i163 = select i1 %tobool.not.i.i.i.i.i160, i32 31, i32 63
  %tobool2.not.i.i.i.i.i164 = icmp ult i64 %spec.select.i.i.i.i.i162, 281474976710656
  %sub4.i.i.i.i.i165 = add nsw i32 %spec.select17.i.i.i.i.i163, -16
  %shl5.i.i.i.i.i166 = shl i64 %spec.select.i.i.i.i.i162, 16
  %word.addr.1.i.i.i.i.i167 = select i1 %tobool2.not.i.i.i.i.i164, i64 %shl5.i.i.i.i.i166, i64 %spec.select.i.i.i.i.i162
  %num.1.i.i.i.i.i168 = select i1 %tobool2.not.i.i.i.i.i164, i32 %sub4.i.i.i.i.i165, i32 %spec.select17.i.i.i.i.i163
  %tobool8.not.i.i.i.i.i169 = icmp ult i64 %word.addr.1.i.i.i.i.i167, 72057594037927936
  %sub10.i.i.i.i.i170 = add nsw i32 %num.1.i.i.i.i.i168, -8
  %shl11.i.i.i.i.i171 = shl i64 %word.addr.1.i.i.i.i.i167, 8
  %word.addr.2.i.i.i.i.i172 = select i1 %tobool8.not.i.i.i.i.i169, i64 %shl11.i.i.i.i.i171, i64 %word.addr.1.i.i.i.i.i167
  %num.2.i.i.i.i.i173 = select i1 %tobool8.not.i.i.i.i.i169, i32 %sub10.i.i.i.i.i170, i32 %num.1.i.i.i.i.i168
  %tobool14.not.i.i.i.i.i174 = icmp ult i64 %word.addr.2.i.i.i.i.i172, 1152921504606846976
  %sub16.i.i.i.i.i175 = add nsw i32 %num.2.i.i.i.i.i173, -4
  %shl17.i.i.i.i.i176 = shl i64 %word.addr.2.i.i.i.i.i172, 4
  %word.addr.3.i.i.i.i.i177 = select i1 %tobool14.not.i.i.i.i.i174, i64 %shl17.i.i.i.i.i176, i64 %word.addr.2.i.i.i.i.i172
  %num.3.i.i.i.i.i178 = select i1 %tobool14.not.i.i.i.i.i174, i32 %sub16.i.i.i.i.i175, i32 %num.2.i.i.i.i.i173
  %tobool20.not.i.i.i.i.i179 = icmp ult i64 %word.addr.3.i.i.i.i.i177, 4611686018427387904
  %sub22.i.i.i.i.i180 = add i32 %num.3.i.i.i.i.i178, 254
  %shl23.i.i.i.i.i181 = shl i64 %word.addr.3.i.i.i.i.i177, 2
  %word.addr.4.i.i.i.i.i182 = select i1 %tobool20.not.i.i.i.i.i179, i64 %shl23.i.i.i.i.i181, i64 %word.addr.3.i.i.i.i.i177
  %num.4.i.i.i.i.i183 = select i1 %tobool20.not.i.i.i.i.i179, i32 %sub22.i.i.i.i.i180, i32 %num.3.i.i.i.i.i178
  %word.addr.4.lobit.i.i.i.i.i184.neg = lshr i64 %word.addr.4.i.i.i.i.i182, 63
  %i.i.i.i.i.i185.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i184.neg to i32
  %add.i.i.i.i188 = add i32 %num.4.i.i.i.i.i183, %i.i.i.i.i.i185.neg
  %phi.bo = and i32 %add.i.i.i.i188, 255
  br label %__reg_bound_offset.exit.i217

__reg_bound_offset.exit.i217:                     ; preds = %if.end.i.i.i.i189, %__reg_deduce_bounds.exit81.i159
  %retval.0.i.i.i.i190 = phi i32 [ %phi.bo, %if.end.i.i.i.i189 ], [ 0, %__reg_deduce_bounds.exit81.i159 ]
  %cmp.i.i.i192 = icmp ugt i32 %retval.0.i.i.i.i190, 63
  %sh_prom.i.i.i193 = zext i32 %retval.0.i.i.i.i190 to i64
  %notmask.i.i.i194 = shl nsw i64 -1, %sh_prom.i.i.i193
  %sub.i.i.i195 = xor i64 %notmask.i.i.i194, -1
  %and.i.i.i196 = and i64 %notmask.i.i.i194, %i.i83.i154
  %retval.sroa.0.0.i.i.i197 = select i1 %cmp.i.i.i192, i64 0, i64 %and.i.i.i196
  %retval.sroa.3.0.i.i.i198 = select i1 %cmp.i.i.i192, i64 -1, i64 %sub.i.i.i195
  %i9.i.i202 = load i64, i64* %value.i4, align 8
  %i11.i.i204 = load i64, i64* %mask.i7, align 8
  %or.i.i.i205 = or i64 %retval.sroa.0.0.i.i.i197, %i9.i.i202
  %and.i1.i.i206 = and i64 %retval.sroa.3.0.i.i.i198, %i11.i.i204
  %neg.i.i.i207 = xor i64 %and.i1.i.i206, -1
  %and4.i.i.i208 = and i64 %or.i.i.i205, %neg.i.i.i207
  store i64 %and4.i.i.i208, i64* %value.i4, align 8
  store i64 %and.i1.i.i206, i64* %mask.i7, align 8
  %i.i90.i212 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i214 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i215 = xor i64 %i5.i92.i214, %i.i90.i212
  %cmp.i.i.i94.i216 = icmp eq i64 %xor.i.i93.i215, 0
  br i1 %cmp.i.i.i94.i216, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i247

if.end.i.i.i124.i247:                             ; preds = %__reg_bound_offset.exit.i217
  %tobool.not.i.i.i.i95.i218 = icmp ult i64 %xor.i.i93.i215, 4294967296
  %shl.i.i.i.i96.i219 = shl i64 %xor.i.i93.i215, 32
  %spec.select.i.i.i.i97.i220 = select i1 %tobool.not.i.i.i.i95.i218, i64 %shl.i.i.i.i96.i219, i64 %xor.i.i93.i215
  %spec.select17.i.i.i.i98.i221 = select i1 %tobool.not.i.i.i.i95.i218, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i222 = icmp ult i64 %spec.select.i.i.i.i97.i220, 281474976710656
  %sub4.i.i.i.i100.i223 = add nsw i32 %spec.select17.i.i.i.i98.i221, -16
  %shl5.i.i.i.i101.i224 = shl i64 %spec.select.i.i.i.i97.i220, 16
  %word.addr.1.i.i.i.i102.i225 = select i1 %tobool2.not.i.i.i.i99.i222, i64 %shl5.i.i.i.i101.i224, i64 %spec.select.i.i.i.i97.i220
  %num.1.i.i.i.i103.i226 = select i1 %tobool2.not.i.i.i.i99.i222, i32 %sub4.i.i.i.i100.i223, i32 %spec.select17.i.i.i.i98.i221
  %tobool8.not.i.i.i.i104.i227 = icmp ult i64 %word.addr.1.i.i.i.i102.i225, 72057594037927936
  %sub10.i.i.i.i105.i228 = add nsw i32 %num.1.i.i.i.i103.i226, -8
  %shl11.i.i.i.i106.i229 = shl i64 %word.addr.1.i.i.i.i102.i225, 8
  %word.addr.2.i.i.i.i107.i230 = select i1 %tobool8.not.i.i.i.i104.i227, i64 %shl11.i.i.i.i106.i229, i64 %word.addr.1.i.i.i.i102.i225
  %num.2.i.i.i.i108.i231 = select i1 %tobool8.not.i.i.i.i104.i227, i32 %sub10.i.i.i.i105.i228, i32 %num.1.i.i.i.i103.i226
  %tobool14.not.i.i.i.i109.i232 = icmp ult i64 %word.addr.2.i.i.i.i107.i230, 1152921504606846976
  %sub16.i.i.i.i110.i233 = add nsw i32 %num.2.i.i.i.i108.i231, -4
  %shl17.i.i.i.i111.i234 = shl i64 %word.addr.2.i.i.i.i107.i230, 4
  %word.addr.3.i.i.i.i112.i235 = select i1 %tobool14.not.i.i.i.i109.i232, i64 %shl17.i.i.i.i111.i234, i64 %word.addr.2.i.i.i.i107.i230
  %num.3.i.i.i.i113.i236 = select i1 %tobool14.not.i.i.i.i109.i232, i32 %sub16.i.i.i.i110.i233, i32 %num.2.i.i.i.i108.i231
  %tobool20.not.i.i.i.i114.i237 = icmp ult i64 %word.addr.3.i.i.i.i112.i235, 4611686018427387904
  %sub22.i.i.i.i115.i238 = add i32 %num.3.i.i.i.i113.i236, 254
  %shl23.i.i.i.i116.i239 = shl i64 %word.addr.3.i.i.i.i112.i235, 2
  %word.addr.4.i.i.i.i117.i240 = select i1 %tobool20.not.i.i.i.i114.i237, i64 %shl23.i.i.i.i116.i239, i64 %word.addr.3.i.i.i.i112.i235
  %num.4.i.i.i.i118.i241 = select i1 %tobool20.not.i.i.i.i114.i237, i32 %sub22.i.i.i.i115.i238, i32 %num.3.i.i.i.i113.i236
  %word.addr.4.lobit.i.i.i.i119.i242.neg = lshr i64 %word.addr.4.i.i.i.i117.i240, 63
  %i.i.i.i.i120.i243.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i242.neg to i32
  %add.i.i.i123.i246 = add i32 %num.4.i.i.i.i118.i241, %i.i.i.i.i120.i243.neg
  %phi.bo34 = and i32 %add.i.i.i123.i246, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i247, %__reg_bound_offset.exit.i217
  %retval.0.i.i.i125.i248 = phi i32 [ %phi.bo34, %if.end.i.i.i124.i247 ], [ 0, %__reg_bound_offset.exit.i217 ]
  %cmp.i.i127.i250 = icmp ugt i32 %retval.0.i.i.i125.i248, 63
  %sh_prom.i.i128.i251 = zext i32 %retval.0.i.i.i125.i248 to i64
  %notmask.i.i129.i252 = shl nsw i64 -1, %sh_prom.i.i128.i251
  %sub.i.i130.i253 = xor i64 %notmask.i.i129.i252, -1
  %and.i.i131.i254 = and i64 %notmask.i.i129.i252, %i.i90.i212
  %retval.sroa.0.0.i.i132.i255 = select i1 %cmp.i.i127.i250, i64 0, i64 %and.i.i131.i254
  %retval.sroa.3.0.i.i133.i256 = select i1 %cmp.i.i127.i250, i64 -1, i64 %sub.i.i130.i253
  %i9.i137.i260 = load i64, i64* %value3.i6, align 8
  %i11.i139.i262 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i263 = or i64 %retval.sroa.0.0.i.i132.i255, %i9.i137.i260
  %and.i1.i141.i264 = and i64 %retval.sroa.3.0.i.i133.i256, %i11.i139.i262
  %neg.i.i142.i265 = xor i64 %and.i1.i141.i264, -1
  %and4.i.i143.i266 = and i64 %or.i.i140.i263, %neg.i.i142.i265
  store i64 %and4.i.i143.i266, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i264, i64* %mask6.i9, align 8
  %i.i148.i270 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i272 = load i64, i64* %value.i4, align 8
  %i24.i.i274 = load i64, i64* %mask.i7, align 8
  %and.i149.i275 = and i64 %i24.i.i274, -9223372036854775808
  %or.i150.i276 = or i64 %and.i149.i275, %i23.i.i272
  %cmp.i151.i277 = icmp sgt i64 %i.i148.i270, %or.i150.i276
  %cond.i152.i278 = select i1 %cmp.i151.i277, i64 %i.i148.i270, i64 %or.i150.i276
  store i64 %cond.i152.i278, i64* %smin_value.i10, align 8
  %i25.i.i280 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i281 = and i64 %i24.i.i274, 9223372036854775807
  %or8.i.i282 = or i64 %and7.i.i281, %i23.i.i272
  %cmp10.i.i283 = icmp slt i64 %i25.i.i280, %or8.i.i282
  %cond14.i.i284 = select i1 %cmp10.i.i283, i64 %i25.i.i280, i64 %or8.i.i282
  store i64 %cond14.i.i284, i64* %smax_value.i13, align 8
  %i26.i.i286 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i287 = icmp ugt i64 %i26.i.i286, %i23.i.i272
  %cond23.i.i288 = select i1 %cmp19.i.i287, i64 %i26.i.i286, i64 %i23.i.i272
  store i64 %cond23.i.i288, i64* %umin_value.i16, align 8
  %i27.i.i290 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i291 = or i64 %i24.i.i274, %i23.i.i272
  %cmp31.i156.i292 = icmp ult i64 %i27.i.i290, %or29.i.i291
  %cond35.i.i293 = select i1 %cmp31.i156.i292, i64 %i27.i.i290, i64 %or29.i.i291
  store i64 %cond35.i.i293, i64* %umax_value.i19, align 8
  %i.i158.i295 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i297 = load i64, i64* %value3.i6, align 8
  %i24.i162.i299 = load i64, i64* %mask6.i9, align 8
  %and.i163.i300 = and i64 %i24.i162.i299, -9223372036854775808
  %or.i164.i301 = or i64 %and.i163.i300, %i23.i160.i297
  %cmp.i165.i302 = icmp sgt i64 %i.i158.i295, %or.i164.i301
  %cond.i166.i303 = select i1 %cmp.i165.i302, i64 %i.i158.i295, i64 %or.i164.i301
  store i64 %cond.i166.i303, i64* %smin_value7.i12, align 8
  %i25.i168.i305 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i306 = and i64 %i24.i162.i299, 9223372036854775807
  %or8.i170.i307 = or i64 %and7.i169.i306, %i23.i160.i297
  %cmp10.i171.i308 = icmp slt i64 %i25.i168.i305, %or8.i170.i307
  %cond14.i172.i309 = select i1 %cmp10.i171.i308, i64 %i25.i168.i305, i64 %or8.i170.i307
  store i64 %cond14.i172.i309, i64* %smax_value8.i15, align 8
  %i26.i174.i311 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i312 = icmp ugt i64 %i26.i174.i311, %i23.i160.i297
  %cond23.i176.i313 = select i1 %cmp19.i175.i312, i64 %i26.i174.i311, i64 %i23.i160.i297
  store i64 %cond23.i176.i313, i64* %umin_value9.i18, align 8
  %i27.i178.i315 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i316 = or i64 %i24.i162.i299, %i23.i160.i297
  %cmp31.i180.i317 = icmp ult i64 %i27.i178.i315, %or29.i179.i316
  %cond35.i181.i318 = select i1 %cmp31.i180.i317, i64 %i27.i178.i315, i64 %or29.i179.i316
  store i64 %cond35.i181.i318, i64* %umax_value10.i21, align 8
  br label %if.end117
