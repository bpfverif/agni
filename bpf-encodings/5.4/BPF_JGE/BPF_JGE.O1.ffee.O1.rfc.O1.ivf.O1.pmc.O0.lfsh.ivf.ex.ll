; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JGE/BPF_JGE.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JGE(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %i83.i = load i64, i64* %umin_value.i, align 8
  %cmp98.not.i = icmp ult i64 %i83.i, %i58
  br i1 %cmp98.not.i, label %if.else101.i, label %is_branch_taken.exit

if.else101.i:                                     ; preds = %if.then25
  %i84.i = load i64, i64* %umax_value.i, align 8
  %cmp103.i = icmp uge i64 %i84.i, %i58
  %spec.select = sext i1 %cmp103.i to i32
  br label %is_branch_taken.exit

is_branch_taken.exit:                             ; preds = %if.else101.i, %if.then25
  %retval.0.i = phi i32 [ 1, %if.then25 ], [ %spec.select, %if.else101.i ]
...
cond.end:                                         ; preds = %if.then52
  ...
  %cond45.i = add i64 %i67, -1
  %i123.i = load i64, i64* %umax_value.i, align 8
  %cmp63.i = icmp ult i64 %i123.i, %cond45.i
  %cond68.i = select i1 %cmp63.i, i64 %i123.i, i64 %cond45.i
  store i64 %cond68.i, i64* %umax_value.i, align 8
  %i124.i = load i64, i64* %umin_value9.i, align 8
  %cmp71.i = icmp ugt i64 %i124.i, %i67
  %cond76.i = select i1 %cmp71.i, i64 %i124.i, i64 %i67
...
if.else70:                                        ; preds = %if.then52
  ...
  %tobool.not.i56 = icmp eq i64 %i69, 0
  br i1 %tobool.not.i56, label %cond.end90, label %if.end117

cond.end90:                                       ; preds = %if.else70
  %i70 = load i64, i64* %value.i, align 8
  %cond45.i60 = add i64 %i70, 1
  %cmp63.i63 = icmp ugt i64 %lo_reg1.sroa.7.0.copyload, %cond45.i60
  %cond68.i64 = select i1 %cmp63.i63, i64 %lo_reg1.sroa.7.0.copyload, i64 %cond45.i60
  store i64 %cond68.i64, i64* %umin_value.i16, align 8
  %i124.i66 = load i64, i64* %umax_value10.i21, align 8
  %cmp71.i67 = icmp ult i64 %i124.i66, %i70
  %cond76.i68 = select i1 %cmp71.i67, i64 %i124.i66, i64 %i70
  store i64 %cond76.i68, i64* %umax_value10.i21, align 8
  %i.i42.i70 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i71 = icmp sgt i64 %i.i42.i70, -1
  br i1 %cmp.i43.i71, label %if.then.i.i87, label %lor.lhs.false.i.i76

lor.lhs.false.i.i76:                              ; preds = %cond.end90
  %i33.i.i74 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i75 = icmp slt i64 %i33.i.i74, 0
  br i1 %cmp1.i45.i75, label %if.then.i.i87, label %if.end.i.i93

if.then.i.i87:                                    ; preds = %lor.lhs.false.i.i76, %cond.end90
  %i34.i.i78 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i79 = icmp ugt i64 %i.i42.i70, %i34.i.i78
  %cond.i.i80 = select i1 %cmp3.i.i79, i64 %i.i42.i70, i64 %i34.i.i78
  store i64 %cond.i.i80, i64* %umin_value.i16, align 8
  store i64 %cond.i.i80, i64* %smin_value.i10, align 8
  %i35.i.i82 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i84 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i85 = icmp ult i64 %i35.i.i82, %i36.i.i84
  %cond12.i.i86 = select i1 %cmp8.i48.i85, i64 %i35.i.i82, i64 %i36.i.i84
  store i64 %cond12.i.i86, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i105.sink.split

if.end.i.i93:                                     ; preds = %lor.lhs.false.i.i76
  %i37.i.i89 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i90 = icmp sgt i64 %i37.i.i89, -1
  %i38.i.i92 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i90, label %if.then17.i.i96, label %if.else.i.i98

if.then17.i.i96:                                  ; preds = %if.end.i.i93
  store i64 %i38.i.i92, i64* %smin_value.i10, align 8
  %cmp23.i.i94 = icmp ult i64 %i33.i.i74, %i37.i.i89
  %cond27.i.i95 = select i1 %cmp23.i.i94, i64 %i33.i.i74, i64 %i37.i.i89
  store i64 %cond27.i.i95, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i105.sink.split

if.else.i.i98:                                    ; preds = %if.end.i.i93
  %cmp31.i.i97 = icmp slt i64 %i38.i.i92, 0
  br i1 %cmp31.i.i97, label %if.then32.i.i101, label %__reg_deduce_bounds.exit.i105

if.then32.i.i101:                                 ; preds = %if.else.i.i98
  %cmp36.i.i99 = icmp ugt i64 %i.i42.i70, %i38.i.i92
  %cond40.i.i100 = select i1 %cmp36.i.i99, i64 %i.i42.i70, i64 %i38.i.i92
  store i64 %cond40.i.i100, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i100, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i105.sink.split

__reg_deduce_bounds.exit.i105.sink.split:         ; preds = %if.then32.i.i101, %if.then17.i.i96, %if.then.i.i87
  %i37.i.i89.sink = phi i64 [ %i37.i.i89, %if.then32.i.i101 ], [ %cond27.i.i95, %if.then17.i.i96 ], [ %cond12.i.i86, %if.then.i.i87 ]
  store i64 %i37.i.i89.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i105

__reg_deduce_bounds.exit.i105:                    ; preds = %__reg_deduce_bounds.exit.i105.sink.split, %if.else.i.i98
  %i.i50.i103 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i104 = icmp sgt i64 %i.i50.i103, -1
  br i1 %cmp.i51.i104, label %if.then.i66.i120, label %lor.lhs.false.i55.i109

lor.lhs.false.i55.i109:                           ; preds = %__reg_deduce_bounds.exit.i105
  %i33.i53.i107 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i108 = icmp slt i64 %i33.i53.i107, 0
  br i1 %cmp1.i54.i108, label %if.then.i66.i120, label %if.end.i72.i126

if.then.i66.i120:                                 ; preds = %lor.lhs.false.i55.i109, %__reg_deduce_bounds.exit.i105
  %i34.i57.i111 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i112 = icmp ugt i64 %i.i50.i103, %i34.i57.i111
  %cond.i59.i113 = select i1 %cmp3.i58.i112, i64 %i.i50.i103, i64 %i34.i57.i111
  store i64 %cond.i59.i113, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i113, i64* %smin_value7.i12, align 8
  %i35.i61.i115 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i117 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i118 = icmp ult i64 %i35.i61.i115, %i36.i63.i117
  %cond12.i65.i119 = select i1 %cmp8.i64.i118, i64 %i35.i61.i115, i64 %i36.i63.i117
  store i64 %cond12.i65.i119, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i141.sink.split

if.end.i72.i126:                                  ; preds = %lor.lhs.false.i55.i109
  %i37.i68.i122 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i123 = icmp sgt i64 %i37.i68.i122, -1
  %i38.i71.i125 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i123, label %if.then17.i75.i129, label %if.else.i77.i131

if.then17.i75.i129:                               ; preds = %if.end.i72.i126
  store i64 %i38.i71.i125, i64* %smin_value7.i12, align 8
  %cmp23.i73.i127 = icmp ult i64 %i33.i53.i107, %i37.i68.i122
  %cond27.i74.i128 = select i1 %cmp23.i73.i127, i64 %i33.i53.i107, i64 %i37.i68.i122
  store i64 %cond27.i74.i128, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i141.sink.split

if.else.i77.i131:                                 ; preds = %if.end.i72.i126
  %cmp31.i76.i130 = icmp slt i64 %i38.i71.i125, 0
  br i1 %cmp31.i76.i130, label %if.then32.i80.i134, label %__reg_deduce_bounds.exit81.i141

if.then32.i80.i134:                               ; preds = %if.else.i77.i131
  %cmp36.i78.i132 = icmp ugt i64 %i.i50.i103, %i38.i71.i125
  %cond40.i79.i133 = select i1 %cmp36.i78.i132, i64 %i.i50.i103, i64 %i38.i71.i125
  store i64 %cond40.i79.i133, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i133, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i141.sink.split

__reg_deduce_bounds.exit81.i141.sink.split:       ; preds = %if.then32.i80.i134, %if.then17.i75.i129, %if.then.i66.i120
  %i37.i68.i122.sink = phi i64 [ %i37.i68.i122, %if.then32.i80.i134 ], [ %cond27.i74.i128, %if.then17.i75.i129 ], [ %cond12.i65.i119, %if.then.i66.i120 ]
  store i64 %i37.i68.i122.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i141

__reg_deduce_bounds.exit81.i141:                  ; preds = %__reg_deduce_bounds.exit81.i141.sink.split, %if.else.i77.i131
  %i.i83.i136 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i138 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i139 = xor i64 %i5.i85.i138, %i.i83.i136
  %cmp.i.i.i.i140 = icmp eq i64 %xor.i.i.i139, 0
  br i1 %cmp.i.i.i.i140, label %__reg_bound_offset.exit.i199, label %if.end.i.i.i.i171

if.end.i.i.i.i171:                                ; preds = %__reg_deduce_bounds.exit81.i141
  %tobool.not.i.i.i.i.i142 = icmp ult i64 %xor.i.i.i139, 4294967296
  %shl.i.i.i.i.i143 = shl i64 %xor.i.i.i139, 32
  %spec.select.i.i.i.i.i144 = select i1 %tobool.not.i.i.i.i.i142, i64 %shl.i.i.i.i.i143, i64 %xor.i.i.i139
  %spec.select17.i.i.i.i.i145 = select i1 %tobool.not.i.i.i.i.i142, i32 31, i32 63
  %tobool2.not.i.i.i.i.i146 = icmp ult i64 %spec.select.i.i.i.i.i144, 281474976710656
  %sub4.i.i.i.i.i147 = add nsw i32 %spec.select17.i.i.i.i.i145, -16
  %shl5.i.i.i.i.i148 = shl i64 %spec.select.i.i.i.i.i144, 16
  %word.addr.1.i.i.i.i.i149 = select i1 %tobool2.not.i.i.i.i.i146, i64 %shl5.i.i.i.i.i148, i64 %spec.select.i.i.i.i.i144
  %num.1.i.i.i.i.i150 = select i1 %tobool2.not.i.i.i.i.i146, i32 %sub4.i.i.i.i.i147, i32 %spec.select17.i.i.i.i.i145
  %tobool8.not.i.i.i.i.i151 = icmp ult i64 %word.addr.1.i.i.i.i.i149, 72057594037927936
  %sub10.i.i.i.i.i152 = add nsw i32 %num.1.i.i.i.i.i150, -8
  %shl11.i.i.i.i.i153 = shl i64 %word.addr.1.i.i.i.i.i149, 8
  %word.addr.2.i.i.i.i.i154 = select i1 %tobool8.not.i.i.i.i.i151, i64 %shl11.i.i.i.i.i153, i64 %word.addr.1.i.i.i.i.i149
  %num.2.i.i.i.i.i155 = select i1 %tobool8.not.i.i.i.i.i151, i32 %sub10.i.i.i.i.i152, i32 %num.1.i.i.i.i.i150
  %tobool14.not.i.i.i.i.i156 = icmp ult i64 %word.addr.2.i.i.i.i.i154, 1152921504606846976
  %sub16.i.i.i.i.i157 = add nsw i32 %num.2.i.i.i.i.i155, -4
  %shl17.i.i.i.i.i158 = shl i64 %word.addr.2.i.i.i.i.i154, 4
  %word.addr.3.i.i.i.i.i159 = select i1 %tobool14.not.i.i.i.i.i156, i64 %shl17.i.i.i.i.i158, i64 %word.addr.2.i.i.i.i.i154
  %num.3.i.i.i.i.i160 = select i1 %tobool14.not.i.i.i.i.i156, i32 %sub16.i.i.i.i.i157, i32 %num.2.i.i.i.i.i155
  %tobool20.not.i.i.i.i.i161 = icmp ult i64 %word.addr.3.i.i.i.i.i159, 4611686018427387904
  %sub22.i.i.i.i.i162 = add i32 %num.3.i.i.i.i.i160, 254
  %shl23.i.i.i.i.i163 = shl i64 %word.addr.3.i.i.i.i.i159, 2
  %word.addr.4.i.i.i.i.i164 = select i1 %tobool20.not.i.i.i.i.i161, i64 %shl23.i.i.i.i.i163, i64 %word.addr.3.i.i.i.i.i159
  %num.4.i.i.i.i.i165 = select i1 %tobool20.not.i.i.i.i.i161, i32 %sub22.i.i.i.i.i162, i32 %num.3.i.i.i.i.i160
  %word.addr.4.lobit.i.i.i.i.i166.neg = lshr i64 %word.addr.4.i.i.i.i.i164, 63
  %i.i.i.i.i.i167.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i166.neg to i32
  %add.i.i.i.i170 = add i32 %num.4.i.i.i.i.i165, %i.i.i.i.i.i167.neg
  %phi.bo = and i32 %add.i.i.i.i170, 255
  br label %__reg_bound_offset.exit.i199

__reg_bound_offset.exit.i199:                     ; preds = %if.end.i.i.i.i171, %__reg_deduce_bounds.exit81.i141
  %retval.0.i.i.i.i172 = phi i32 [ %phi.bo, %if.end.i.i.i.i171 ], [ 0, %__reg_deduce_bounds.exit81.i141 ]
  %cmp.i.i.i174 = icmp ugt i32 %retval.0.i.i.i.i172, 63
  %sh_prom.i.i.i175 = zext i32 %retval.0.i.i.i.i172 to i64
  %notmask.i.i.i176 = shl nsw i64 -1, %sh_prom.i.i.i175
  %sub.i.i.i177 = xor i64 %notmask.i.i.i176, -1
  %and.i.i.i178 = and i64 %notmask.i.i.i176, %i.i83.i136
  %retval.sroa.0.0.i.i.i179 = select i1 %cmp.i.i.i174, i64 0, i64 %and.i.i.i178
  %retval.sroa.3.0.i.i.i180 = select i1 %cmp.i.i.i174, i64 -1, i64 %sub.i.i.i177
  %i9.i.i184 = load i64, i64* %value.i4, align 8
  %i11.i.i186 = load i64, i64* %mask.i7, align 8
  %or.i.i.i187 = or i64 %retval.sroa.0.0.i.i.i179, %i9.i.i184
  %and.i1.i.i188 = and i64 %retval.sroa.3.0.i.i.i180, %i11.i.i186
  %neg.i.i.i189 = xor i64 %and.i1.i.i188, -1
  %and4.i.i.i190 = and i64 %or.i.i.i187, %neg.i.i.i189
  store i64 %and4.i.i.i190, i64* %value.i4, align 8
  store i64 %and.i1.i.i188, i64* %mask.i7, align 8
  %i.i90.i194 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i196 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i197 = xor i64 %i5.i92.i196, %i.i90.i194
  %cmp.i.i.i94.i198 = icmp eq i64 %xor.i.i93.i197, 0
  br i1 %cmp.i.i.i94.i198, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i229

if.end.i.i.i124.i229:                             ; preds = %__reg_bound_offset.exit.i199
  %tobool.not.i.i.i.i95.i200 = icmp ult i64 %xor.i.i93.i197, 4294967296
  %shl.i.i.i.i96.i201 = shl i64 %xor.i.i93.i197, 32
  %spec.select.i.i.i.i97.i202 = select i1 %tobool.not.i.i.i.i95.i200, i64 %shl.i.i.i.i96.i201, i64 %xor.i.i93.i197
  %spec.select17.i.i.i.i98.i203 = select i1 %tobool.not.i.i.i.i95.i200, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i204 = icmp ult i64 %spec.select.i.i.i.i97.i202, 281474976710656
  %sub4.i.i.i.i100.i205 = add nsw i32 %spec.select17.i.i.i.i98.i203, -16
  %shl5.i.i.i.i101.i206 = shl i64 %spec.select.i.i.i.i97.i202, 16
  %word.addr.1.i.i.i.i102.i207 = select i1 %tobool2.not.i.i.i.i99.i204, i64 %shl5.i.i.i.i101.i206, i64 %spec.select.i.i.i.i97.i202
  %num.1.i.i.i.i103.i208 = select i1 %tobool2.not.i.i.i.i99.i204, i32 %sub4.i.i.i.i100.i205, i32 %spec.select17.i.i.i.i98.i203
  %tobool8.not.i.i.i.i104.i209 = icmp ult i64 %word.addr.1.i.i.i.i102.i207, 72057594037927936
  %sub10.i.i.i.i105.i210 = add nsw i32 %num.1.i.i.i.i103.i208, -8
  %shl11.i.i.i.i106.i211 = shl i64 %word.addr.1.i.i.i.i102.i207, 8
  %word.addr.2.i.i.i.i107.i212 = select i1 %tobool8.not.i.i.i.i104.i209, i64 %shl11.i.i.i.i106.i211, i64 %word.addr.1.i.i.i.i102.i207
  %num.2.i.i.i.i108.i213 = select i1 %tobool8.not.i.i.i.i104.i209, i32 %sub10.i.i.i.i105.i210, i32 %num.1.i.i.i.i103.i208
  %tobool14.not.i.i.i.i109.i214 = icmp ult i64 %word.addr.2.i.i.i.i107.i212, 1152921504606846976
  %sub16.i.i.i.i110.i215 = add nsw i32 %num.2.i.i.i.i108.i213, -4
  %shl17.i.i.i.i111.i216 = shl i64 %word.addr.2.i.i.i.i107.i212, 4
  %word.addr.3.i.i.i.i112.i217 = select i1 %tobool14.not.i.i.i.i109.i214, i64 %shl17.i.i.i.i111.i216, i64 %word.addr.2.i.i.i.i107.i212
  %num.3.i.i.i.i113.i218 = select i1 %tobool14.not.i.i.i.i109.i214, i32 %sub16.i.i.i.i110.i215, i32 %num.2.i.i.i.i108.i213
  %tobool20.not.i.i.i.i114.i219 = icmp ult i64 %word.addr.3.i.i.i.i112.i217, 4611686018427387904
  %sub22.i.i.i.i115.i220 = add i32 %num.3.i.i.i.i113.i218, 254
  %shl23.i.i.i.i116.i221 = shl i64 %word.addr.3.i.i.i.i112.i217, 2
  %word.addr.4.i.i.i.i117.i222 = select i1 %tobool20.not.i.i.i.i114.i219, i64 %shl23.i.i.i.i116.i221, i64 %word.addr.3.i.i.i.i112.i217
  %num.4.i.i.i.i118.i223 = select i1 %tobool20.not.i.i.i.i114.i219, i32 %sub22.i.i.i.i115.i220, i32 %num.3.i.i.i.i113.i218
  %word.addr.4.lobit.i.i.i.i119.i224.neg = lshr i64 %word.addr.4.i.i.i.i117.i222, 63
  %i.i.i.i.i120.i225.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i224.neg to i32
  %add.i.i.i123.i228 = add i32 %num.4.i.i.i.i118.i223, %i.i.i.i.i120.i225.neg
  %phi.bo13 = and i32 %add.i.i.i123.i228, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i229, %__reg_bound_offset.exit.i199
  %retval.0.i.i.i125.i230 = phi i32 [ %phi.bo13, %if.end.i.i.i124.i229 ], [ 0, %__reg_bound_offset.exit.i199 ]
  %cmp.i.i127.i232 = icmp ugt i32 %retval.0.i.i.i125.i230, 63
  %sh_prom.i.i128.i233 = zext i32 %retval.0.i.i.i125.i230 to i64
  %notmask.i.i129.i234 = shl nsw i64 -1, %sh_prom.i.i128.i233
  %sub.i.i130.i235 = xor i64 %notmask.i.i129.i234, -1
  %and.i.i131.i236 = and i64 %notmask.i.i129.i234, %i.i90.i194
  %retval.sroa.0.0.i.i132.i237 = select i1 %cmp.i.i127.i232, i64 0, i64 %and.i.i131.i236
  %retval.sroa.3.0.i.i133.i238 = select i1 %cmp.i.i127.i232, i64 -1, i64 %sub.i.i130.i235
  %i9.i137.i242 = load i64, i64* %value3.i6, align 8
  %i11.i139.i244 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i245 = or i64 %retval.sroa.0.0.i.i132.i237, %i9.i137.i242
  %and.i1.i141.i246 = and i64 %retval.sroa.3.0.i.i133.i238, %i11.i139.i244
  %neg.i.i142.i247 = xor i64 %and.i1.i141.i246, -1
  %and4.i.i143.i248 = and i64 %or.i.i140.i245, %neg.i.i142.i247
  store i64 %and4.i.i143.i248, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i246, i64* %mask6.i9, align 8
  %i.i148.i252 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i254 = load i64, i64* %value.i4, align 8
  %i24.i.i256 = load i64, i64* %mask.i7, align 8
  %and.i149.i257 = and i64 %i24.i.i256, -9223372036854775808
  %or.i150.i258 = or i64 %and.i149.i257, %i23.i.i254
  %cmp.i151.i259 = icmp sgt i64 %i.i148.i252, %or.i150.i258
  %cond.i152.i260 = select i1 %cmp.i151.i259, i64 %i.i148.i252, i64 %or.i150.i258
  store i64 %cond.i152.i260, i64* %smin_value.i10, align 8
  %i25.i.i262 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i263 = and i64 %i24.i.i256, 9223372036854775807
  %or8.i.i264 = or i64 %and7.i.i263, %i23.i.i254
  %cmp10.i.i265 = icmp slt i64 %i25.i.i262, %or8.i.i264
  %cond14.i.i266 = select i1 %cmp10.i.i265, i64 %i25.i.i262, i64 %or8.i.i264
  store i64 %cond14.i.i266, i64* %smax_value.i13, align 8
  %i26.i.i268 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i269 = icmp ugt i64 %i26.i.i268, %i23.i.i254
  %cond23.i.i270 = select i1 %cmp19.i.i269, i64 %i26.i.i268, i64 %i23.i.i254
  store i64 %cond23.i.i270, i64* %umin_value.i16, align 8
  %i27.i.i272 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i273 = or i64 %i24.i.i256, %i23.i.i254
  %cmp31.i156.i274 = icmp ult i64 %i27.i.i272, %or29.i.i273
  %cond35.i.i275 = select i1 %cmp31.i156.i274, i64 %i27.i.i272, i64 %or29.i.i273
  store i64 %cond35.i.i275, i64* %umax_value.i19, align 8
  %i.i158.i277 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i279 = load i64, i64* %value3.i6, align 8
  %i24.i162.i281 = load i64, i64* %mask6.i9, align 8
  %and.i163.i282 = and i64 %i24.i162.i281, -9223372036854775808
  %or.i164.i283 = or i64 %and.i163.i282, %i23.i160.i279
  %cmp.i165.i284 = icmp sgt i64 %i.i158.i277, %or.i164.i283
  %cond.i166.i285 = select i1 %cmp.i165.i284, i64 %i.i158.i277, i64 %or.i164.i283
  store i64 %cond.i166.i285, i64* %smin_value7.i12, align 8
  %i25.i168.i287 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i288 = and i64 %i24.i162.i281, 9223372036854775807
  %or8.i170.i289 = or i64 %and7.i169.i288, %i23.i160.i279
  %cmp10.i171.i290 = icmp slt i64 %i25.i168.i287, %or8.i170.i289
  %cond14.i172.i291 = select i1 %cmp10.i171.i290, i64 %i25.i168.i287, i64 %or8.i170.i289
  store i64 %cond14.i172.i291, i64* %smax_value8.i15, align 8
  %i26.i174.i293 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i294 = icmp ugt i64 %i26.i174.i293, %i23.i160.i279
  %cond23.i176.i295 = select i1 %cmp19.i175.i294, i64 %i26.i174.i293, i64 %i23.i160.i279
  store i64 %cond23.i176.i295, i64* %umin_value9.i18, align 8
  %i27.i178.i297 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i298 = or i64 %i24.i162.i281, %i23.i160.i279
  %cmp31.i180.i299 = icmp ult i64 %i27.i178.i297, %or29.i179.i298
  %cond35.i181.i300 = select i1 %cmp31.i180.i299, i64 %i27.i178.i297, i64 %or29.i179.i298
  store i64 %cond35.i181.i300, i64* %umax_value10.i21, align 8
  br label %if.end117
