; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_ADD/BPF_ADD.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @adjust_scalar_min_max_vals_wrapper_BPF_ADD(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg) local_unnamed_addr #0 {
entry:
...
lor.lhs.false52.i:                                ; preds = %if.end27.i
...
if.then56.i:                                      ; preds = %lor.lhs.false52.i, %if.end27.i
...
if.then72.i:                                      ; preds = %lor.lhs.false67.i, %if.end62.i
...
if.else75.i:                                      ; preds = %lor.lhs.false67.i
...
if.end80.i:                                       ; preds = %if.else75.i, %if.then72.i
...
if.then.i329.i:                                   ; preds = %lor.lhs.false.i.i, %if.end80.i
