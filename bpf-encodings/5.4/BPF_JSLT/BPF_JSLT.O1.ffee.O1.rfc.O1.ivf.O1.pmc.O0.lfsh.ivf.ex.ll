; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JSLT/BPF_JSLT.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JSLT(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %i81.i = load i64, i64* %smax_value.i, align 8
  %cmp86.i = icmp slt i64 %i81.i, %i58
  br i1 %cmp86.i, label %is_branch_taken.exit, label %if.else89.i

if.else89.i:                                      ; preds = %if.then25
  %i82.i = load i64, i64* %smin_value.i, align 8
  %cmp91.not.i = icmp slt i64 %i82.i, %i58
  %spec.select = sext i1 %cmp91.not.i to i32
  br label %is_branch_taken.exit

is_branch_taken.exit:                             ; preds = %if.else89.i, %if.then25
  %retval.0.i = phi i32 [ 1, %if.then25 ], [ %spec.select, %if.else89.i ]
...
cond.end:                                         ; preds = %if.then52
  ...
  %cond176.i = add i64 %i67, -1
  %i135.i = load i64, i64* %smin_value.i, align 8
  %cmp185.i = icmp sgt i64 %i135.i, %i67
  %cond190.i = select i1 %cmp185.i, i64 %i135.i, i64 %i67
...
cond.end90:                                       ; preds = %if.else70
  ...
  %cond176.i58 = add i64 %i70, 1
  %i135.i59 = load i64, i64* %smax_value.i13, align 8
  %cmp185.i60 = icmp slt i64 %i135.i59, %i70
  %cond190.i61 = select i1 %cmp185.i60, i64 %i135.i59, i64 %i70
  store i64 %cond190.i61, i64* %smax_value.i13, align 8
  %i136.i62 = load i64, i64* %smin_value7.i12, align 8
  %cmp194.i63 = icmp sgt i64 %i136.i62, %cond176.i58
  %cond199.i64 = select i1 %cmp194.i63, i64 %i136.i62, i64 %cond176.i58
