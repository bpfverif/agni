; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JGE_32/BPF_JGE_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JGE_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %cmp98.not.i = icmp uge i64 %reg_lo.i.sroa.15.0, %conv13.i
  %cmp103.i = icmp ult i64 %storemerge.i.i, %conv13.i
  %narrow = select i1 %cmp98.not.i, i1 true, i1 %cmp103.i
...
if.then44:                                        ; preds = %if.then25, %land.lhs.true, %entry
  ...
  %lo_reg1.sroa.9.0.copyload = load i64, i64* %umin_value.i16, align 8
...
cond.end:                                         ; preds = %if.then52
  %cond45.i = add nsw i64 %and.i.i39, -1
  %or.i9.i = or i64 %lo_reg0.sroa.4.0.copyload, %lo_reg0.sroa.1.0.copyload
  %and.i10.i = and i64 %or.i9.i, -4294967296
  %add57.i = add i64 %cond45.i, %and.i10.i
  %i122.i = load i64, i64* %value3.i, align 8
  %and.i11.i = and i64 %i122.i, -4294967296
  %add60.i = or i64 %and.i11.i, %and.i.i39
  %i123.i = load i64, i64* %umax_value.i, align 8
  %cmp63.i = icmp ult i64 %i123.i, %add57.i
  %cond68.i = select i1 %cmp63.i, i64 %i123.i, i64 %add57.i
  store i64 %cond68.i, i64* %umax_value.i, align 8
  %i124.i = load i64, i64* %umin_value9.i, align 8
  %cmp71.i = icmp ugt i64 %i124.i, %add60.i
  %cond76.i = select i1 %cmp71.i, i64 %i124.i, i64 %add60.i
  store i64 %cond76.i, i64* %umin_value9.i, align 8
  %i.i42.i = load i64, i64* %smin_value.i, align 8
  %cmp.i43.i = icmp sgt i64 %i.i42.i, -1
  br i1 %cmp.i43.i, label %if.then.i.i66, label %lor.lhs.false.i.i

lor.lhs.false.i.i:                                ; preds = %cond.end
  %i33.i.i = load i64, i64* %smax_value.i, align 8
  %cmp1.i45.i = icmp slt i64 %i33.i.i, 0
  br i1 %cmp1.i45.i, label %if.then.i.i66, label %if.end.i.i

if.then.i.i66:                                    ; preds = %lor.lhs.false.i.i, %cond.end
...
if.end.i.i:                                       ; preds = %lor.lhs.false.i.i
  ...
  br i1 %cmp16.i.i, label %if.then17.i.i, label %if.else.i.i67
...
__reg_deduce_bounds.exit.i.sink.split:            ; preds = %if.then32.i.i, %if.then17.i.i, %if.then.i.i66
  %i37.i.i.sink = phi i64 [ %i37.i.i, %if.then32.i.i ], [ %cond27.i.i, %if.then17.i.i ], [ %cond12.i.i, %if.then.i.i66 ]
  store i64 %i37.i.i.sink, i64* %smax_value.i, align 8
  br label %__reg_deduce_bounds.exit.i

__reg_deduce_bounds.exit.i:                       ; preds = %__reg_deduce_bounds.exit.i.sink.split, %if.else.i.i67
...
__reg_bound_offset.exit.i:                        ; preds = %if.end.i.i.i.i, %__reg_deduce_bounds.exit81.i
  ...
  %and.i.i.i68 = and i64 %notmask.i.i.i, %i.i83.i
  %retval.sroa.0.0.i.i.i = select i1 %cmp.i.i.i, i64 0, i64 %and.i.i.i68
...
reg_set_min_max.exit:                             ; preds = %if.end.i.i.i124.i, %__reg_bound_offset.exit.i
  ...
  %i23.i.i69 = load i64, i64* %value.i, align 8
  %i24.i.i70 = load i64, i64* %mask.i, align 8
  %and.i149.i = and i64 %i24.i.i70, -9223372036854775808
  %or.i150.i = or i64 %and.i149.i, %i23.i.i69
  ...
  %i25.i.i71 = load i64, i64* %smax_value.i, align 8
  %and7.i.i = and i64 %i24.i.i70, 9223372036854775807
  %or8.i.i = or i64 %and7.i.i, %i23.i.i69
  %cmp10.i.i = icmp slt i64 %i25.i.i71, %or8.i.i
  %cond14.i.i = select i1 %cmp10.i.i, i64 %i25.i.i71, i64 %or8.i.i
  store i64 %cond14.i.i, i64* %smax_value.i, align 8
  %i26.i.i72 = load i64, i64* %umin_value.i, align 8
  %cmp19.i.i = icmp ugt i64 %i26.i.i72, %i23.i.i69
  %cond23.i.i = select i1 %cmp19.i.i, i64 %i26.i.i72, i64 %i23.i.i69
  store i64 %cond23.i.i, i64* %umin_value.i, align 8
  %i27.i.i73 = load i64, i64* %umax_value.i, align 8
  %or29.i.i = or i64 %i24.i.i70, %i23.i.i69
  %cmp31.i156.i = icmp ult i64 %i27.i.i73, %or29.i.i
  %cond35.i.i = select i1 %cmp31.i156.i, i64 %i27.i.i73, i64 %or29.i.i
...
if.else70:                                        ; preds = %if.then52
  %tobool.not.i75 = icmp eq i64 %and6.i.i30, 0
  br i1 %tobool.not.i75, label %cond.end90, label %if.end117

cond.end90:                                       ; preds = %if.else70
  %cond45.i79 = add nuw nsw i64 %and.i.i, 1
  %and.i9.i = and i64 %lo_reg1.sroa.1.0.copyload, -4294967296
  %add57.i82 = add i64 %cond45.i79, %and.i9.i
  %or.i10.i = or i64 %i14.i8, %i13.i5
  %and.i11.i87 = and i64 %or.i10.i, -4294967296
  %add60.i88 = or i64 %and.i.i, %and.i11.i87
  %cmp63.i91 = icmp ugt i64 %lo_reg1.sroa.9.0.copyload, %add57.i82
  %cond68.i92 = select i1 %cmp63.i91, i64 %lo_reg1.sroa.9.0.copyload, i64 %add57.i82
  store i64 %cond68.i92, i64* %umin_value.i16, align 8
  %i124.i94 = load i64, i64* %umax_value10.i21, align 8
  %cmp71.i95 = icmp ult i64 %i124.i94, %add60.i88
  %cond76.i96 = select i1 %cmp71.i95, i64 %i124.i94, i64 %add60.i88
  store i64 %cond76.i96, i64* %umax_value10.i21, align 8
  %i.i42.i98 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i99 = icmp sgt i64 %i.i42.i98, -1
  br i1 %cmp.i43.i99, label %if.then.i.i115, label %lor.lhs.false.i.i104

lor.lhs.false.i.i104:                             ; preds = %cond.end90
  %i33.i.i102 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i103 = icmp slt i64 %i33.i.i102, 0
  br i1 %cmp1.i45.i103, label %if.then.i.i115, label %if.end.i.i121

if.then.i.i115:                                   ; preds = %lor.lhs.false.i.i104, %cond.end90
  %i34.i.i106 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i107 = icmp ugt i64 %i.i42.i98, %i34.i.i106
  %cond.i.i108 = select i1 %cmp3.i.i107, i64 %i.i42.i98, i64 %i34.i.i106
  store i64 %cond.i.i108, i64* %umin_value.i16, align 8
  store i64 %cond.i.i108, i64* %smin_value.i10, align 8
  %i35.i.i110 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i112 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i113 = icmp ult i64 %i35.i.i110, %i36.i.i112
  %cond12.i.i114 = select i1 %cmp8.i48.i113, i64 %i35.i.i110, i64 %i36.i.i112
  store i64 %cond12.i.i114, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i133.sink.split

if.end.i.i121:                                    ; preds = %lor.lhs.false.i.i104
  %i37.i.i117 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i118 = icmp sgt i64 %i37.i.i117, -1
  %i38.i.i120 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i118, label %if.then17.i.i124, label %if.else.i.i126

if.then17.i.i124:                                 ; preds = %if.end.i.i121
  store i64 %i38.i.i120, i64* %smin_value.i10, align 8
  %cmp23.i.i122 = icmp ult i64 %i33.i.i102, %i37.i.i117
  %cond27.i.i123 = select i1 %cmp23.i.i122, i64 %i33.i.i102, i64 %i37.i.i117
  store i64 %cond27.i.i123, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i133.sink.split

if.else.i.i126:                                   ; preds = %if.end.i.i121
  %cmp31.i.i125 = icmp slt i64 %i38.i.i120, 0
  br i1 %cmp31.i.i125, label %if.then32.i.i129, label %__reg_deduce_bounds.exit.i133

if.then32.i.i129:                                 ; preds = %if.else.i.i126
  %cmp36.i.i127 = icmp ugt i64 %i.i42.i98, %i38.i.i120
  %cond40.i.i128 = select i1 %cmp36.i.i127, i64 %i.i42.i98, i64 %i38.i.i120
  store i64 %cond40.i.i128, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i128, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i133.sink.split

__reg_deduce_bounds.exit.i133.sink.split:         ; preds = %if.then32.i.i129, %if.then17.i.i124, %if.then.i.i115
  %i37.i.i117.sink = phi i64 [ %i37.i.i117, %if.then32.i.i129 ], [ %cond27.i.i123, %if.then17.i.i124 ], [ %cond12.i.i114, %if.then.i.i115 ]
  store i64 %i37.i.i117.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i133

__reg_deduce_bounds.exit.i133:                    ; preds = %__reg_deduce_bounds.exit.i133.sink.split, %if.else.i.i126
  %i.i50.i131 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i132 = icmp sgt i64 %i.i50.i131, -1
  br i1 %cmp.i51.i132, label %if.then.i66.i148, label %lor.lhs.false.i55.i137

lor.lhs.false.i55.i137:                           ; preds = %__reg_deduce_bounds.exit.i133
  %i33.i53.i135 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i136 = icmp slt i64 %i33.i53.i135, 0
  br i1 %cmp1.i54.i136, label %if.then.i66.i148, label %if.end.i72.i154

if.then.i66.i148:                                 ; preds = %lor.lhs.false.i55.i137, %__reg_deduce_bounds.exit.i133
  %i34.i57.i139 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i140 = icmp ugt i64 %i.i50.i131, %i34.i57.i139
  %cond.i59.i141 = select i1 %cmp3.i58.i140, i64 %i.i50.i131, i64 %i34.i57.i139
  store i64 %cond.i59.i141, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i141, i64* %smin_value7.i12, align 8
  %i35.i61.i143 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i145 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i146 = icmp ult i64 %i35.i61.i143, %i36.i63.i145
  %cond12.i65.i147 = select i1 %cmp8.i64.i146, i64 %i35.i61.i143, i64 %i36.i63.i145
  store i64 %cond12.i65.i147, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i169.sink.split

if.end.i72.i154:                                  ; preds = %lor.lhs.false.i55.i137
  %i37.i68.i150 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i151 = icmp sgt i64 %i37.i68.i150, -1
  %i38.i71.i153 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i151, label %if.then17.i75.i157, label %if.else.i77.i159

if.then17.i75.i157:                               ; preds = %if.end.i72.i154
  store i64 %i38.i71.i153, i64* %smin_value7.i12, align 8
  %cmp23.i73.i155 = icmp ult i64 %i33.i53.i135, %i37.i68.i150
  %cond27.i74.i156 = select i1 %cmp23.i73.i155, i64 %i33.i53.i135, i64 %i37.i68.i150
  store i64 %cond27.i74.i156, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i169.sink.split

if.else.i77.i159:                                 ; preds = %if.end.i72.i154
  %cmp31.i76.i158 = icmp slt i64 %i38.i71.i153, 0
  br i1 %cmp31.i76.i158, label %if.then32.i80.i162, label %__reg_deduce_bounds.exit81.i169

if.then32.i80.i162:                               ; preds = %if.else.i77.i159
  %cmp36.i78.i160 = icmp ugt i64 %i.i50.i131, %i38.i71.i153
  %cond40.i79.i161 = select i1 %cmp36.i78.i160, i64 %i.i50.i131, i64 %i38.i71.i153
  store i64 %cond40.i79.i161, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i161, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i169.sink.split

__reg_deduce_bounds.exit81.i169.sink.split:       ; preds = %if.then32.i80.i162, %if.then17.i75.i157, %if.then.i66.i148
  %i37.i68.i150.sink = phi i64 [ %i37.i68.i150, %if.then32.i80.i162 ], [ %cond27.i74.i156, %if.then17.i75.i157 ], [ %cond12.i65.i147, %if.then.i66.i148 ]
  store i64 %i37.i68.i150.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i169

__reg_deduce_bounds.exit81.i169:                  ; preds = %__reg_deduce_bounds.exit81.i169.sink.split, %if.else.i77.i159
  %i.i83.i164 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i166 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i167 = xor i64 %i5.i85.i166, %i.i83.i164
  %cmp.i.i.i.i168 = icmp eq i64 %xor.i.i.i167, 0
  br i1 %cmp.i.i.i.i168, label %__reg_bound_offset.exit.i227, label %if.end.i.i.i.i199

if.end.i.i.i.i199:                                ; preds = %__reg_deduce_bounds.exit81.i169
  %tobool.not.i.i.i.i.i170 = icmp ult i64 %xor.i.i.i167, 4294967296
  %shl.i.i.i.i.i171 = shl i64 %xor.i.i.i167, 32
  %spec.select.i.i.i.i.i172 = select i1 %tobool.not.i.i.i.i.i170, i64 %shl.i.i.i.i.i171, i64 %xor.i.i.i167
  %spec.select17.i.i.i.i.i173 = select i1 %tobool.not.i.i.i.i.i170, i32 31, i32 63
  %tobool2.not.i.i.i.i.i174 = icmp ult i64 %spec.select.i.i.i.i.i172, 281474976710656
  %sub4.i.i.i.i.i175 = add nsw i32 %spec.select17.i.i.i.i.i173, -16
  %shl5.i.i.i.i.i176 = shl i64 %spec.select.i.i.i.i.i172, 16
  %word.addr.1.i.i.i.i.i177 = select i1 %tobool2.not.i.i.i.i.i174, i64 %shl5.i.i.i.i.i176, i64 %spec.select.i.i.i.i.i172
  %num.1.i.i.i.i.i178 = select i1 %tobool2.not.i.i.i.i.i174, i32 %sub4.i.i.i.i.i175, i32 %spec.select17.i.i.i.i.i173
  %tobool8.not.i.i.i.i.i179 = icmp ult i64 %word.addr.1.i.i.i.i.i177, 72057594037927936
  %sub10.i.i.i.i.i180 = add nsw i32 %num.1.i.i.i.i.i178, -8
  %shl11.i.i.i.i.i181 = shl i64 %word.addr.1.i.i.i.i.i177, 8
  %word.addr.2.i.i.i.i.i182 = select i1 %tobool8.not.i.i.i.i.i179, i64 %shl11.i.i.i.i.i181, i64 %word.addr.1.i.i.i.i.i177
  %num.2.i.i.i.i.i183 = select i1 %tobool8.not.i.i.i.i.i179, i32 %sub10.i.i.i.i.i180, i32 %num.1.i.i.i.i.i178
  %tobool14.not.i.i.i.i.i184 = icmp ult i64 %word.addr.2.i.i.i.i.i182, 1152921504606846976
  %sub16.i.i.i.i.i185 = add nsw i32 %num.2.i.i.i.i.i183, -4
  %shl17.i.i.i.i.i186 = shl i64 %word.addr.2.i.i.i.i.i182, 4
  %word.addr.3.i.i.i.i.i187 = select i1 %tobool14.not.i.i.i.i.i184, i64 %shl17.i.i.i.i.i186, i64 %word.addr.2.i.i.i.i.i182
  %num.3.i.i.i.i.i188 = select i1 %tobool14.not.i.i.i.i.i184, i32 %sub16.i.i.i.i.i185, i32 %num.2.i.i.i.i.i183
  %tobool20.not.i.i.i.i.i189 = icmp ult i64 %word.addr.3.i.i.i.i.i187, 4611686018427387904
  %sub22.i.i.i.i.i190 = add i32 %num.3.i.i.i.i.i188, 254
  %shl23.i.i.i.i.i191 = shl i64 %word.addr.3.i.i.i.i.i187, 2
  %word.addr.4.i.i.i.i.i192 = select i1 %tobool20.not.i.i.i.i.i189, i64 %shl23.i.i.i.i.i191, i64 %word.addr.3.i.i.i.i.i187
  %num.4.i.i.i.i.i193 = select i1 %tobool20.not.i.i.i.i.i189, i32 %sub22.i.i.i.i.i190, i32 %num.3.i.i.i.i.i188
  %word.addr.4.lobit.i.i.i.i.i194.neg = lshr i64 %word.addr.4.i.i.i.i.i192, 63
  %i.i.i.i.i.i195.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i194.neg to i32
  %add.i.i.i.i198 = add i32 %num.4.i.i.i.i.i193, %i.i.i.i.i.i195.neg
  %phi.bo = and i32 %add.i.i.i.i198, 255
  br label %__reg_bound_offset.exit.i227

__reg_bound_offset.exit.i227:                     ; preds = %if.end.i.i.i.i199, %__reg_deduce_bounds.exit81.i169
  %retval.0.i.i.i.i200 = phi i32 [ %phi.bo, %if.end.i.i.i.i199 ], [ 0, %__reg_deduce_bounds.exit81.i169 ]
  %cmp.i.i.i202 = icmp ugt i32 %retval.0.i.i.i.i200, 63
  %sh_prom.i.i.i203 = zext i32 %retval.0.i.i.i.i200 to i64
  %notmask.i.i.i204 = shl nsw i64 -1, %sh_prom.i.i.i203
  %sub.i.i.i205 = xor i64 %notmask.i.i.i204, -1
  %and.i.i.i206 = and i64 %notmask.i.i.i204, %i.i83.i164
  %retval.sroa.0.0.i.i.i207 = select i1 %cmp.i.i.i202, i64 0, i64 %and.i.i.i206
  %retval.sroa.3.0.i.i.i208 = select i1 %cmp.i.i.i202, i64 -1, i64 %sub.i.i.i205
  %i9.i.i212 = load i64, i64* %value.i4, align 8
  %i11.i.i214 = load i64, i64* %mask.i7, align 8
  %or.i.i.i215 = or i64 %retval.sroa.0.0.i.i.i207, %i9.i.i212
  %and.i1.i.i216 = and i64 %retval.sroa.3.0.i.i.i208, %i11.i.i214
  %neg.i.i.i217 = xor i64 %and.i1.i.i216, -1
  %and4.i.i.i218 = and i64 %or.i.i.i215, %neg.i.i.i217
  store i64 %and4.i.i.i218, i64* %value.i4, align 8
  store i64 %and.i1.i.i216, i64* %mask.i7, align 8
  %i.i90.i222 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i224 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i225 = xor i64 %i5.i92.i224, %i.i90.i222
  %cmp.i.i.i94.i226 = icmp eq i64 %xor.i.i93.i225, 0
  br i1 %cmp.i.i.i94.i226, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i257

if.end.i.i.i124.i257:                             ; preds = %__reg_bound_offset.exit.i227
  %tobool.not.i.i.i.i95.i228 = icmp ult i64 %xor.i.i93.i225, 4294967296
  %shl.i.i.i.i96.i229 = shl i64 %xor.i.i93.i225, 32
  %spec.select.i.i.i.i97.i230 = select i1 %tobool.not.i.i.i.i95.i228, i64 %shl.i.i.i.i96.i229, i64 %xor.i.i93.i225
  %spec.select17.i.i.i.i98.i231 = select i1 %tobool.not.i.i.i.i95.i228, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i232 = icmp ult i64 %spec.select.i.i.i.i97.i230, 281474976710656
  %sub4.i.i.i.i100.i233 = add nsw i32 %spec.select17.i.i.i.i98.i231, -16
  %shl5.i.i.i.i101.i234 = shl i64 %spec.select.i.i.i.i97.i230, 16
  %word.addr.1.i.i.i.i102.i235 = select i1 %tobool2.not.i.i.i.i99.i232, i64 %shl5.i.i.i.i101.i234, i64 %spec.select.i.i.i.i97.i230
  %num.1.i.i.i.i103.i236 = select i1 %tobool2.not.i.i.i.i99.i232, i32 %sub4.i.i.i.i100.i233, i32 %spec.select17.i.i.i.i98.i231
  %tobool8.not.i.i.i.i104.i237 = icmp ult i64 %word.addr.1.i.i.i.i102.i235, 72057594037927936
  %sub10.i.i.i.i105.i238 = add nsw i32 %num.1.i.i.i.i103.i236, -8
  %shl11.i.i.i.i106.i239 = shl i64 %word.addr.1.i.i.i.i102.i235, 8
  %word.addr.2.i.i.i.i107.i240 = select i1 %tobool8.not.i.i.i.i104.i237, i64 %shl11.i.i.i.i106.i239, i64 %word.addr.1.i.i.i.i102.i235
  %num.2.i.i.i.i108.i241 = select i1 %tobool8.not.i.i.i.i104.i237, i32 %sub10.i.i.i.i105.i238, i32 %num.1.i.i.i.i103.i236
  %tobool14.not.i.i.i.i109.i242 = icmp ult i64 %word.addr.2.i.i.i.i107.i240, 1152921504606846976
  %sub16.i.i.i.i110.i243 = add nsw i32 %num.2.i.i.i.i108.i241, -4
  %shl17.i.i.i.i111.i244 = shl i64 %word.addr.2.i.i.i.i107.i240, 4
  %word.addr.3.i.i.i.i112.i245 = select i1 %tobool14.not.i.i.i.i109.i242, i64 %shl17.i.i.i.i111.i244, i64 %word.addr.2.i.i.i.i107.i240
  %num.3.i.i.i.i113.i246 = select i1 %tobool14.not.i.i.i.i109.i242, i32 %sub16.i.i.i.i110.i243, i32 %num.2.i.i.i.i108.i241
  %tobool20.not.i.i.i.i114.i247 = icmp ult i64 %word.addr.3.i.i.i.i112.i245, 4611686018427387904
  %sub22.i.i.i.i115.i248 = add i32 %num.3.i.i.i.i113.i246, 254
  %shl23.i.i.i.i116.i249 = shl i64 %word.addr.3.i.i.i.i112.i245, 2
  %word.addr.4.i.i.i.i117.i250 = select i1 %tobool20.not.i.i.i.i114.i247, i64 %shl23.i.i.i.i116.i249, i64 %word.addr.3.i.i.i.i112.i245
  %num.4.i.i.i.i118.i251 = select i1 %tobool20.not.i.i.i.i114.i247, i32 %sub22.i.i.i.i115.i248, i32 %num.3.i.i.i.i113.i246
  %word.addr.4.lobit.i.i.i.i119.i252.neg = lshr i64 %word.addr.4.i.i.i.i117.i250, 63
  %i.i.i.i.i120.i253.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i252.neg to i32
  %add.i.i.i123.i256 = add i32 %num.4.i.i.i.i118.i251, %i.i.i.i.i120.i253.neg
  %phi.bo34 = and i32 %add.i.i.i123.i256, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i257, %__reg_bound_offset.exit.i227
  %retval.0.i.i.i125.i258 = phi i32 [ %phi.bo34, %if.end.i.i.i124.i257 ], [ 0, %__reg_bound_offset.exit.i227 ]
  %cmp.i.i127.i260 = icmp ugt i32 %retval.0.i.i.i125.i258, 63
  %sh_prom.i.i128.i261 = zext i32 %retval.0.i.i.i125.i258 to i64
  %notmask.i.i129.i262 = shl nsw i64 -1, %sh_prom.i.i128.i261
  %sub.i.i130.i263 = xor i64 %notmask.i.i129.i262, -1
  %and.i.i131.i264 = and i64 %notmask.i.i129.i262, %i.i90.i222
  %retval.sroa.0.0.i.i132.i265 = select i1 %cmp.i.i127.i260, i64 0, i64 %and.i.i131.i264
  %retval.sroa.3.0.i.i133.i266 = select i1 %cmp.i.i127.i260, i64 -1, i64 %sub.i.i130.i263
  %i9.i137.i270 = load i64, i64* %value3.i6, align 8
  %i11.i139.i272 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i273 = or i64 %retval.sroa.0.0.i.i132.i265, %i9.i137.i270
  %and.i1.i141.i274 = and i64 %retval.sroa.3.0.i.i133.i266, %i11.i139.i272
  %neg.i.i142.i275 = xor i64 %and.i1.i141.i274, -1
  %and4.i.i143.i276 = and i64 %or.i.i140.i273, %neg.i.i142.i275
  store i64 %and4.i.i143.i276, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i274, i64* %mask6.i9, align 8
  %i.i148.i280 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i282 = load i64, i64* %value.i4, align 8
  %i24.i.i284 = load i64, i64* %mask.i7, align 8
  %and.i149.i285 = and i64 %i24.i.i284, -9223372036854775808
  %or.i150.i286 = or i64 %and.i149.i285, %i23.i.i282
  %cmp.i151.i287 = icmp sgt i64 %i.i148.i280, %or.i150.i286
  %cond.i152.i288 = select i1 %cmp.i151.i287, i64 %i.i148.i280, i64 %or.i150.i286
  store i64 %cond.i152.i288, i64* %smin_value.i10, align 8
  %i25.i.i290 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i291 = and i64 %i24.i.i284, 9223372036854775807
  %or8.i.i292 = or i64 %and7.i.i291, %i23.i.i282
  %cmp10.i.i293 = icmp slt i64 %i25.i.i290, %or8.i.i292
  %cond14.i.i294 = select i1 %cmp10.i.i293, i64 %i25.i.i290, i64 %or8.i.i292
  store i64 %cond14.i.i294, i64* %smax_value.i13, align 8
  %i26.i.i296 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i297 = icmp ugt i64 %i26.i.i296, %i23.i.i282
  %cond23.i.i298 = select i1 %cmp19.i.i297, i64 %i26.i.i296, i64 %i23.i.i282
  store i64 %cond23.i.i298, i64* %umin_value.i16, align 8
  %i27.i.i300 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i301 = or i64 %i24.i.i284, %i23.i.i282
  %cmp31.i156.i302 = icmp ult i64 %i27.i.i300, %or29.i.i301
  %cond35.i.i303 = select i1 %cmp31.i156.i302, i64 %i27.i.i300, i64 %or29.i.i301
  store i64 %cond35.i.i303, i64* %umax_value.i19, align 8
  %i.i158.i305 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i307 = load i64, i64* %value3.i6, align 8
  %i24.i162.i309 = load i64, i64* %mask6.i9, align 8
  %and.i163.i310 = and i64 %i24.i162.i309, -9223372036854775808
  %or.i164.i311 = or i64 %and.i163.i310, %i23.i160.i307
  %cmp.i165.i312 = icmp sgt i64 %i.i158.i305, %or.i164.i311
  %cond.i166.i313 = select i1 %cmp.i165.i312, i64 %i.i158.i305, i64 %or.i164.i311
  store i64 %cond.i166.i313, i64* %smin_value7.i12, align 8
  %i25.i168.i315 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i316 = and i64 %i24.i162.i309, 9223372036854775807
  %or8.i170.i317 = or i64 %and7.i169.i316, %i23.i160.i307
  %cmp10.i171.i318 = icmp slt i64 %i25.i168.i315, %or8.i170.i317
  %cond14.i172.i319 = select i1 %cmp10.i171.i318, i64 %i25.i168.i315, i64 %or8.i170.i317
  store i64 %cond14.i172.i319, i64* %smax_value8.i15, align 8
  %i26.i174.i321 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i322 = icmp ugt i64 %i26.i174.i321, %i23.i160.i307
  %cond23.i176.i323 = select i1 %cmp19.i175.i322, i64 %i26.i174.i321, i64 %i23.i160.i307
  store i64 %cond23.i176.i323, i64* %umin_value9.i18, align 8
  %i27.i178.i325 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i326 = or i64 %i24.i162.i309, %i23.i160.i307
  %cmp31.i180.i327 = icmp ult i64 %i27.i178.i325, %or29.i179.i326
  %cond35.i181.i328 = select i1 %cmp31.i180.i327, i64 %i27.i178.i325, i64 %or29.i179.i326
  store i64 %cond35.i181.i328, i64* %umax_value10.i21, align 8
  br label %if.end117
