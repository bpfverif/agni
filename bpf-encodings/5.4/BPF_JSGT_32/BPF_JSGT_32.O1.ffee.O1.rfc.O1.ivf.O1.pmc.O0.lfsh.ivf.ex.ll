; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JSGT_32/BPF_JSGT_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JSGT_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %cmp62.i = icmp sgt i64 %conv6.i, %conv15.i
  %cmp67.i = icmp slt i64 %conv10.i, %conv15.i
  %narrow = select i1 %cmp62.i, i1 true, i1 %cmp67.i
...
cond.end:                                         ; preds = %if.then52
  ...
  %cond94.i = add nsw i64 %conv6.i62, 1
...
if.end99.i:                                       ; preds = %land.rhs.i15.i, %land.lhs.true4.i.i
  ...
  %cmp101.i = icmp slt i64 %i125.i, %conv6.i62
  %cond106.i = select i1 %cmp101.i, i64 %i125.i, i64 %conv6.i62
  store i64 %cond106.i, i64* %smax_value.i, align 8
  %i126.i = load i64, i64* %smin_value7.i, align 8
  %cmp109.i = icmp sgt i64 %i126.i, %cond94.i
  %cond114.i = select i1 %cmp109.i, i64 %i126.i, i64 %cond94.i
...
cond.end90:                                       ; preds = %if.else70
  ...
  %cond94.i80 = add nsw i64 %conv6.i79, -1
...
if.end99.i111:                                    ; preds = %land.rhs.i15.i100, %land.lhs.true4.i.i90
  ...
  %cmp101.i105 = icmp sgt i64 %i125.i104, %conv6.i79
  %cond106.i106 = select i1 %cmp101.i105, i64 %i125.i104, i64 %conv6.i79
  store i64 %cond106.i106, i64* %smin_value.i10, align 8
  %i126.i108 = load i64, i64* %smax_value8.i15, align 8
  %cmp109.i109 = icmp slt i64 %i126.i108, %cond94.i80
  %cond114.i110 = select i1 %cmp109.i109, i64 %i126.i108, i64 %cond94.i80
