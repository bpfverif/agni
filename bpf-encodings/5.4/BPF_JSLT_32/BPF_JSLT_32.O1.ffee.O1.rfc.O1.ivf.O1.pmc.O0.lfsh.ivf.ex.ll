; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JSLT_32/BPF_JSLT_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JSLT_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %reg_lo.i.sroa.17.0.copyload = load i64, i64* %umin_value.i, align 8
  %reg_lo.i.sroa.22.0.copyload = load i64, i64* %umax_value.i, align 8
  %i25.i.i = xor i64 %reg_lo.i.sroa.22.0.copyload, %reg_lo.i.sroa.17.0.copyload
  %cmp.i.i = icmp ult i64 %i25.i.i, 4294967296
  %and6.i.i = and i64 %reg_lo.i.sroa.17.0.copyload, 4294967295
  %and8.i.i = and i64 %reg_lo.i.sroa.22.0.copyload, 4294967295
  %reg_lo.i.sroa.17.0 = select i1 %cmp.i.i, i64 %and6.i.i, i64 0
  %storemerge.i.i = select i1 %cmp.i.i, i64 %and8.i.i, i64 4294967295
  %xor.i = xor i64 %reg_lo.i.sroa.17.0, %storemerge.i.i
  %and.i = and i64 %xor.i, 2147483648
  %tobool2.not.i = icmp eq i64 %and.i, 0
  %reg_lo.i.sroa.17.0.op = shl nuw i64 %reg_lo.i.sroa.17.0, 32
  %reg_lo.i.sroa.17.0.op.op = ashr exact i64 %reg_lo.i.sroa.17.0.op, 32
  %conv6.i = select i1 %tobool2.not.i, i64 %reg_lo.i.sroa.17.0.op.op, i64 -2147483648
  %storemerge.i.i.op = shl nuw i64 %storemerge.i.i, 32
  %storemerge.i.i.op.op = ashr exact i64 %storemerge.i.i.op, 32
  %conv10.i = select i1 %tobool2.not.i, i64 %storemerge.i.i.op.op, i64 2147483647
  %sext57.i = shl i64 %i58, 32
  %conv15.i = ashr exact i64 %sext57.i, 32
  %cmp86.i = icmp slt i64 %conv10.i, %conv15.i
  %cmp91.not.i = icmp sge i64 %conv6.i, %conv15.i
  %narrow = select i1 %cmp86.i, i1 true, i1 %cmp91.not.i
  br i1 %narrow, label %if.end117, label %if.then44

if.then44:                                        ; preds = %if.then25, %land.lhs.true, %entry
  %lo_reg0.sroa.1.0.copyload = load i64, i64* %value.i, align 8
  %lo_reg0.sroa.4.0.copyload = load i64, i64* %mask.i, align 8
  %lo_reg1.sroa.1.0.copyload = load i64, i64* %value.i4, align 8
  %and6.i.i30 = and i64 %lo_reg0.sroa.4.0.copyload, 4294967295
...
if.then52:                                        ; preds = %if.then44
  %lo_reg1.sroa.4.0.copyload = load i64, i64* %mask.i7, align 8
  %and6.i.i40 = and i64 %lo_reg1.sroa.4.0.copyload, 4294967295
  %tobool.not.i60 = icmp eq i64 %and6.i.i40, 0
  br i1 %tobool.not.i60, label %cond.end, label %if.else70

cond.end:                                         ; preds = %if.then52
  %sext.i61 = shl i64 %lo_reg1.sroa.1.0.copyload, 32
  %conv6.i62 = ashr exact i64 %sext.i61, 32
  %cond176.i = add nsw i64 %conv6.i62, -1
  %conv.i19.i = trunc i64 %lo_reg1.sroa.1.0.copyload to i32
  %cmp.i20.i = icmp sgt i32 %conv.i19.i, -1
  br i1 %cmp.i20.i, label %land.lhs.true.i24.i, label %lor.rhs.i30.i

land.lhs.true.i24.i:                              ; preds = %cond.end
  %i.i22.i = load i64, i64* %smin_value.i, align 8
  %cmp2.i23.i = icmp sgt i64 %i.i22.i, -1
  br i1 %cmp2.i23.i, label %land.lhs.true4.i28.i, label %lor.rhs.i30.i

land.lhs.true4.i28.i:                             ; preds = %land.lhs.true.i24.i
  %i5.i26.i = load i64, i64* %smax_value.i, align 8
  %cmp5.i27.i = icmp slt i64 %i5.i26.i, 2147483648
  br i1 %cmp5.i27.i, label %if.end182.i, label %lor.rhs.i30.i

lor.rhs.i30.i:                                    ; preds = %land.lhs.true4.i28.i, %land.lhs.true.i24.i, %cond.end
  %cmp8.i29.i = icmp slt i32 %conv.i19.i, 0
  br i1 %cmp8.i29.i, label %land.lhs.true10.i34.i, label %sw.epilog.i63

land.lhs.true10.i34.i:                            ; preds = %lor.rhs.i30.i
  %i6.i32.i = load i64, i64* %smax_value.i, align 8
  %cmp12.i33.i = icmp slt i64 %i6.i32.i, 1
  br i1 %cmp12.i33.i, label %land.rhs.i38.i, label %sw.epilog.i63

land.rhs.i38.i:                                   ; preds = %land.lhs.true10.i34.i
  %i7.i36.i = load i64, i64* %smin_value.i, align 8
  %cmp15.i37.i = icmp sgt i64 %i7.i36.i, -2147483649
  br i1 %cmp15.i37.i, label %if.end182.i, label %sw.epilog.i63

if.end182.i:                                      ; preds = %land.rhs.i38.i, %land.lhs.true4.i28.i
  %i135.i = load i64, i64* %smin_value.i, align 8
  %cmp185.i = icmp sgt i64 %i135.i, %conv6.i62
  %cond190.i = select i1 %cmp185.i, i64 %i135.i, i64 %conv6.i62
  store i64 %cond190.i, i64* %smin_value.i, align 8
  %i136.i = load i64, i64* %smax_value8.i, align 8
  %cmp194.i = icmp slt i64 %i136.i, %cond176.i
  %cond199.i = select i1 %cmp194.i, i64 %i136.i, i64 %cond176.i
  store i64 %cond199.i, i64* %smax_value8.i, align 8
  br label %sw.epilog.i63

sw.epilog.i63:                                    ; preds = %if.end182.i, %land.rhs.i38.i, %land.lhs.true10.i34.i, %lor.rhs.i30.i
  %i.i42.i = load i64, i64* %smin_value.i, align 8
  %cmp.i43.i = icmp sgt i64 %i.i42.i, -1
  br i1 %cmp.i43.i, label %if.then.i.i64, label %lor.lhs.false.i.i

lor.lhs.false.i.i:                                ; preds = %sw.epilog.i63
  %i33.i.i = load i64, i64* %smax_value.i, align 8
  %cmp1.i45.i = icmp slt i64 %i33.i.i, 0
  br i1 %cmp1.i45.i, label %if.then.i.i64, label %if.end.i.i

if.then.i.i64:                                    ; preds = %lor.lhs.false.i.i, %sw.epilog.i63
...
if.end.i.i:                                       ; preds = %lor.lhs.false.i.i
  ...
  br i1 %cmp16.i.i, label %if.then17.i.i, label %if.else.i.i65
...
__reg_deduce_bounds.exit.i.sink.split:            ; preds = %if.then32.i.i, %if.then17.i.i, %if.then.i.i64
  %i37.i.i.sink = phi i64 [ %i37.i.i, %if.then32.i.i ], [ %cond27.i.i, %if.then17.i.i ], [ %cond12.i.i, %if.then.i.i64 ]
  store i64 %i37.i.i.sink, i64* %smax_value.i, align 8
  br label %__reg_deduce_bounds.exit.i

__reg_deduce_bounds.exit.i:                       ; preds = %__reg_deduce_bounds.exit.i.sink.split, %if.else.i.i65
...
if.end.i.i.i.i:                                   ; preds = %__reg_deduce_bounds.exit81.i
  ...
  %phi.bo37 = and i32 %add.i.i.i.i, 255
  br label %__reg_bound_offset.exit.i

__reg_bound_offset.exit.i:                        ; preds = %if.end.i.i.i.i, %__reg_deduce_bounds.exit81.i
  %retval.0.i.i.i.i = phi i32 [ %phi.bo37, %if.end.i.i.i.i ], [ 0, %__reg_deduce_bounds.exit81.i ]
  %cmp.i.i.i = icmp ugt i32 %retval.0.i.i.i.i, 63
  %sh_prom.i.i.i = zext i32 %retval.0.i.i.i.i to i64
  %notmask.i.i.i = shl nsw i64 -1, %sh_prom.i.i.i
  %sub.i.i.i = xor i64 %notmask.i.i.i, -1
  %and.i.i.i66 = and i64 %notmask.i.i.i, %i.i83.i
  %retval.sroa.0.0.i.i.i = select i1 %cmp.i.i.i, i64 0, i64 %and.i.i.i66
...
if.end.i.i.i124.i:                                ; preds = %__reg_bound_offset.exit.i
  ...
  %phi.bo38 = and i32 %add.i.i.i123.i, 255
  br label %reg_set_min_max.exit

reg_set_min_max.exit:                             ; preds = %if.end.i.i.i124.i, %__reg_bound_offset.exit.i
  %retval.0.i.i.i125.i = phi i32 [ %phi.bo38, %if.end.i.i.i124.i ], [ 0, %__reg_bound_offset.exit.i ]
  ...
  %i23.i.i67 = load i64, i64* %value.i, align 8
  %i24.i.i68 = load i64, i64* %mask.i, align 8
  %and.i149.i = and i64 %i24.i.i68, -9223372036854775808
  %or.i150.i = or i64 %and.i149.i, %i23.i.i67
  ...
  %i25.i.i69 = load i64, i64* %smax_value.i, align 8
  %and7.i.i = and i64 %i24.i.i68, 9223372036854775807
  %or8.i.i = or i64 %and7.i.i, %i23.i.i67
  %cmp10.i.i = icmp slt i64 %i25.i.i69, %or8.i.i
  %cond14.i.i = select i1 %cmp10.i.i, i64 %i25.i.i69, i64 %or8.i.i
  store i64 %cond14.i.i, i64* %smax_value.i, align 8
  %i26.i.i70 = load i64, i64* %umin_value.i, align 8
  %cmp19.i.i = icmp ugt i64 %i26.i.i70, %i23.i.i67
  %cond23.i.i = select i1 %cmp19.i.i, i64 %i26.i.i70, i64 %i23.i.i67
  store i64 %cond23.i.i, i64* %umin_value.i, align 8
  %i27.i.i71 = load i64, i64* %umax_value.i, align 8
  %or29.i.i = or i64 %i24.i.i68, %i23.i.i67
  %cmp31.i156.i = icmp ult i64 %i27.i.i71, %or29.i.i
  %cond35.i.i = select i1 %cmp31.i156.i, i64 %i27.i.i71, i64 %or29.i.i
...
if.else70:                                        ; preds = %if.then52
  %tobool.not.i73 = icmp eq i64 %and6.i.i30, 0
  br i1 %tobool.not.i73, label %cond.end90, label %if.end117

cond.end90:                                       ; preds = %if.else70
  %sext.i75 = shl i64 %lo_reg0.sroa.1.0.copyload, 32
  %conv6.i76 = ashr exact i64 %sext.i75, 32
  %cond176.i77 = add nsw i64 %conv6.i76, 1
  %conv.i19.i78 = trunc i64 %lo_reg0.sroa.1.0.copyload to i32
  %cmp.i20.i79 = icmp sgt i32 %conv.i19.i78, -1
  br i1 %cmp.i20.i79, label %land.lhs.true.i24.i83, label %lor.rhs.i30.i89

land.lhs.true.i24.i83:                            ; preds = %cond.end90
  %i.i22.i81 = load i64, i64* %smin_value.i10, align 8
  %cmp2.i23.i82 = icmp sgt i64 %i.i22.i81, -1
  br i1 %cmp2.i23.i82, label %land.lhs.true4.i28.i87, label %lor.rhs.i30.i89

land.lhs.true4.i28.i87:                           ; preds = %land.lhs.true.i24.i83
  %i5.i26.i85 = load i64, i64* %smax_value.i13, align 8
  %cmp5.i27.i86 = icmp slt i64 %i5.i26.i85, 2147483648
  br i1 %cmp5.i27.i86, label %if.end182.i106, label %lor.rhs.i30.i89

lor.rhs.i30.i89:                                  ; preds = %land.lhs.true4.i28.i87, %land.lhs.true.i24.i83, %cond.end90
  %cmp8.i29.i88 = icmp slt i32 %conv.i19.i78, 0
  br i1 %cmp8.i29.i88, label %land.lhs.true10.i34.i93, label %sw.epilog.i110

land.lhs.true10.i34.i93:                          ; preds = %lor.rhs.i30.i89
  %i6.i32.i91 = load i64, i64* %smax_value.i13, align 8
  %cmp12.i33.i92 = icmp slt i64 %i6.i32.i91, 1
  br i1 %cmp12.i33.i92, label %land.rhs.i38.i97, label %sw.epilog.i110

land.rhs.i38.i97:                                 ; preds = %land.lhs.true10.i34.i93
  %i7.i36.i95 = load i64, i64* %smin_value.i10, align 8
  %cmp15.i37.i96 = icmp sgt i64 %i7.i36.i95, -2147483649
  br i1 %cmp15.i37.i96, label %if.end182.i106, label %sw.epilog.i110

if.end182.i106:                                   ; preds = %land.rhs.i38.i97, %land.lhs.true4.i28.i87
  %i135.i100 = load i64, i64* %smax_value.i13, align 8
  %cmp185.i101 = icmp slt i64 %i135.i100, %conv6.i76
  %cond190.i102 = select i1 %cmp185.i101, i64 %i135.i100, i64 %conv6.i76
  store i64 %cond190.i102, i64* %smax_value.i13, align 8
  %i136.i103 = load i64, i64* %smin_value7.i12, align 8
  %cmp194.i104 = icmp sgt i64 %i136.i103, %cond176.i77
  %cond199.i105 = select i1 %cmp194.i104, i64 %i136.i103, i64 %cond176.i77
  store i64 %cond199.i105, i64* %smin_value7.i12, align 8
  br label %sw.epilog.i110

sw.epilog.i110:                                   ; preds = %if.end182.i106, %land.rhs.i38.i97, %land.lhs.true10.i34.i93, %lor.rhs.i30.i89
  %i.i42.i108 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i109 = icmp sgt i64 %i.i42.i108, -1
  br i1 %cmp.i43.i109, label %if.then.i.i125, label %lor.lhs.false.i.i114

lor.lhs.false.i.i114:                             ; preds = %sw.epilog.i110
  %i33.i.i112 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i113 = icmp slt i64 %i33.i.i112, 0
  br i1 %cmp1.i45.i113, label %if.then.i.i125, label %if.end.i.i131

if.then.i.i125:                                   ; preds = %lor.lhs.false.i.i114, %sw.epilog.i110
  %i34.i.i116 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i117 = icmp ugt i64 %i.i42.i108, %i34.i.i116
  %cond.i.i118 = select i1 %cmp3.i.i117, i64 %i.i42.i108, i64 %i34.i.i116
  store i64 %cond.i.i118, i64* %umin_value.i16, align 8
  store i64 %cond.i.i118, i64* %smin_value.i10, align 8
  %i35.i.i120 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i122 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i123 = icmp ult i64 %i35.i.i120, %i36.i.i122
  %cond12.i.i124 = select i1 %cmp8.i48.i123, i64 %i35.i.i120, i64 %i36.i.i122
  store i64 %cond12.i.i124, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i143.sink.split

if.end.i.i131:                                    ; preds = %lor.lhs.false.i.i114
  %i37.i.i127 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i128 = icmp sgt i64 %i37.i.i127, -1
  %i38.i.i130 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i128, label %if.then17.i.i134, label %if.else.i.i136

if.then17.i.i134:                                 ; preds = %if.end.i.i131
  store i64 %i38.i.i130, i64* %smin_value.i10, align 8
  %cmp23.i.i132 = icmp ult i64 %i33.i.i112, %i37.i.i127
  %cond27.i.i133 = select i1 %cmp23.i.i132, i64 %i33.i.i112, i64 %i37.i.i127
  store i64 %cond27.i.i133, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i143.sink.split

if.else.i.i136:                                   ; preds = %if.end.i.i131
  %cmp31.i.i135 = icmp slt i64 %i38.i.i130, 0
  br i1 %cmp31.i.i135, label %if.then32.i.i139, label %__reg_deduce_bounds.exit.i143

if.then32.i.i139:                                 ; preds = %if.else.i.i136
  %cmp36.i.i137 = icmp ugt i64 %i.i42.i108, %i38.i.i130
  %cond40.i.i138 = select i1 %cmp36.i.i137, i64 %i.i42.i108, i64 %i38.i.i130
  store i64 %cond40.i.i138, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i138, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i143.sink.split

__reg_deduce_bounds.exit.i143.sink.split:         ; preds = %if.then32.i.i139, %if.then17.i.i134, %if.then.i.i125
  %i37.i.i127.sink = phi i64 [ %i37.i.i127, %if.then32.i.i139 ], [ %cond27.i.i133, %if.then17.i.i134 ], [ %cond12.i.i124, %if.then.i.i125 ]
  store i64 %i37.i.i127.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i143

__reg_deduce_bounds.exit.i143:                    ; preds = %__reg_deduce_bounds.exit.i143.sink.split, %if.else.i.i136
  %i.i50.i141 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i142 = icmp sgt i64 %i.i50.i141, -1
  br i1 %cmp.i51.i142, label %if.then.i66.i158, label %lor.lhs.false.i55.i147

lor.lhs.false.i55.i147:                           ; preds = %__reg_deduce_bounds.exit.i143
  %i33.i53.i145 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i146 = icmp slt i64 %i33.i53.i145, 0
  br i1 %cmp1.i54.i146, label %if.then.i66.i158, label %if.end.i72.i164

if.then.i66.i158:                                 ; preds = %lor.lhs.false.i55.i147, %__reg_deduce_bounds.exit.i143
  %i34.i57.i149 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i150 = icmp ugt i64 %i.i50.i141, %i34.i57.i149
  %cond.i59.i151 = select i1 %cmp3.i58.i150, i64 %i.i50.i141, i64 %i34.i57.i149
  store i64 %cond.i59.i151, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i151, i64* %smin_value7.i12, align 8
  %i35.i61.i153 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i155 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i156 = icmp ult i64 %i35.i61.i153, %i36.i63.i155
  %cond12.i65.i157 = select i1 %cmp8.i64.i156, i64 %i35.i61.i153, i64 %i36.i63.i155
  store i64 %cond12.i65.i157, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i179.sink.split

if.end.i72.i164:                                  ; preds = %lor.lhs.false.i55.i147
  %i37.i68.i160 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i161 = icmp sgt i64 %i37.i68.i160, -1
  %i38.i71.i163 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i161, label %if.then17.i75.i167, label %if.else.i77.i169

if.then17.i75.i167:                               ; preds = %if.end.i72.i164
  store i64 %i38.i71.i163, i64* %smin_value7.i12, align 8
  %cmp23.i73.i165 = icmp ult i64 %i33.i53.i145, %i37.i68.i160
  %cond27.i74.i166 = select i1 %cmp23.i73.i165, i64 %i33.i53.i145, i64 %i37.i68.i160
  store i64 %cond27.i74.i166, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i179.sink.split

if.else.i77.i169:                                 ; preds = %if.end.i72.i164
  %cmp31.i76.i168 = icmp slt i64 %i38.i71.i163, 0
  br i1 %cmp31.i76.i168, label %if.then32.i80.i172, label %__reg_deduce_bounds.exit81.i179

if.then32.i80.i172:                               ; preds = %if.else.i77.i169
  %cmp36.i78.i170 = icmp ugt i64 %i.i50.i141, %i38.i71.i163
  %cond40.i79.i171 = select i1 %cmp36.i78.i170, i64 %i.i50.i141, i64 %i38.i71.i163
  store i64 %cond40.i79.i171, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i171, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i179.sink.split

__reg_deduce_bounds.exit81.i179.sink.split:       ; preds = %if.then32.i80.i172, %if.then17.i75.i167, %if.then.i66.i158
  %i37.i68.i160.sink = phi i64 [ %i37.i68.i160, %if.then32.i80.i172 ], [ %cond27.i74.i166, %if.then17.i75.i167 ], [ %cond12.i65.i157, %if.then.i66.i158 ]
  store i64 %i37.i68.i160.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i179

__reg_deduce_bounds.exit81.i179:                  ; preds = %__reg_deduce_bounds.exit81.i179.sink.split, %if.else.i77.i169
  %i.i83.i174 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i176 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i177 = xor i64 %i5.i85.i176, %i.i83.i174
  %cmp.i.i.i.i178 = icmp eq i64 %xor.i.i.i177, 0
  br i1 %cmp.i.i.i.i178, label %__reg_bound_offset.exit.i237, label %if.end.i.i.i.i209

if.end.i.i.i.i209:                                ; preds = %__reg_deduce_bounds.exit81.i179
  %tobool.not.i.i.i.i.i180 = icmp ult i64 %xor.i.i.i177, 4294967296
  %shl.i.i.i.i.i181 = shl i64 %xor.i.i.i177, 32
  %spec.select.i.i.i.i.i182 = select i1 %tobool.not.i.i.i.i.i180, i64 %shl.i.i.i.i.i181, i64 %xor.i.i.i177
  %spec.select17.i.i.i.i.i183 = select i1 %tobool.not.i.i.i.i.i180, i32 31, i32 63
  %tobool2.not.i.i.i.i.i184 = icmp ult i64 %spec.select.i.i.i.i.i182, 281474976710656
  %sub4.i.i.i.i.i185 = add nsw i32 %spec.select17.i.i.i.i.i183, -16
  %shl5.i.i.i.i.i186 = shl i64 %spec.select.i.i.i.i.i182, 16
  %word.addr.1.i.i.i.i.i187 = select i1 %tobool2.not.i.i.i.i.i184, i64 %shl5.i.i.i.i.i186, i64 %spec.select.i.i.i.i.i182
  %num.1.i.i.i.i.i188 = select i1 %tobool2.not.i.i.i.i.i184, i32 %sub4.i.i.i.i.i185, i32 %spec.select17.i.i.i.i.i183
  %tobool8.not.i.i.i.i.i189 = icmp ult i64 %word.addr.1.i.i.i.i.i187, 72057594037927936
  %sub10.i.i.i.i.i190 = add nsw i32 %num.1.i.i.i.i.i188, -8
  %shl11.i.i.i.i.i191 = shl i64 %word.addr.1.i.i.i.i.i187, 8
  %word.addr.2.i.i.i.i.i192 = select i1 %tobool8.not.i.i.i.i.i189, i64 %shl11.i.i.i.i.i191, i64 %word.addr.1.i.i.i.i.i187
  %num.2.i.i.i.i.i193 = select i1 %tobool8.not.i.i.i.i.i189, i32 %sub10.i.i.i.i.i190, i32 %num.1.i.i.i.i.i188
  %tobool14.not.i.i.i.i.i194 = icmp ult i64 %word.addr.2.i.i.i.i.i192, 1152921504606846976
  %sub16.i.i.i.i.i195 = add nsw i32 %num.2.i.i.i.i.i193, -4
  %shl17.i.i.i.i.i196 = shl i64 %word.addr.2.i.i.i.i.i192, 4
  %word.addr.3.i.i.i.i.i197 = select i1 %tobool14.not.i.i.i.i.i194, i64 %shl17.i.i.i.i.i196, i64 %word.addr.2.i.i.i.i.i192
  %num.3.i.i.i.i.i198 = select i1 %tobool14.not.i.i.i.i.i194, i32 %sub16.i.i.i.i.i195, i32 %num.2.i.i.i.i.i193
  %tobool20.not.i.i.i.i.i199 = icmp ult i64 %word.addr.3.i.i.i.i.i197, 4611686018427387904
  %sub22.i.i.i.i.i200 = add i32 %num.3.i.i.i.i.i198, 254
  %shl23.i.i.i.i.i201 = shl i64 %word.addr.3.i.i.i.i.i197, 2
  %word.addr.4.i.i.i.i.i202 = select i1 %tobool20.not.i.i.i.i.i199, i64 %shl23.i.i.i.i.i201, i64 %word.addr.3.i.i.i.i.i197
  %num.4.i.i.i.i.i203 = select i1 %tobool20.not.i.i.i.i.i199, i32 %sub22.i.i.i.i.i200, i32 %num.3.i.i.i.i.i198
  %word.addr.4.lobit.i.i.i.i.i204.neg = lshr i64 %word.addr.4.i.i.i.i.i202, 63
  %i.i.i.i.i.i205.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i204.neg to i32
  %add.i.i.i.i208 = add i32 %num.4.i.i.i.i.i203, %i.i.i.i.i.i205.neg
  %phi.bo = and i32 %add.i.i.i.i208, 255
  br label %__reg_bound_offset.exit.i237

__reg_bound_offset.exit.i237:                     ; preds = %if.end.i.i.i.i209, %__reg_deduce_bounds.exit81.i179
  %retval.0.i.i.i.i210 = phi i32 [ %phi.bo, %if.end.i.i.i.i209 ], [ 0, %__reg_deduce_bounds.exit81.i179 ]
  %cmp.i.i.i212 = icmp ugt i32 %retval.0.i.i.i.i210, 63
  %sh_prom.i.i.i213 = zext i32 %retval.0.i.i.i.i210 to i64
  %notmask.i.i.i214 = shl nsw i64 -1, %sh_prom.i.i.i213
  %sub.i.i.i215 = xor i64 %notmask.i.i.i214, -1
  %and.i.i.i216 = and i64 %notmask.i.i.i214, %i.i83.i174
  %retval.sroa.0.0.i.i.i217 = select i1 %cmp.i.i.i212, i64 0, i64 %and.i.i.i216
  %retval.sroa.3.0.i.i.i218 = select i1 %cmp.i.i.i212, i64 -1, i64 %sub.i.i.i215
  %i9.i.i222 = load i64, i64* %value.i4, align 8
  %i11.i.i224 = load i64, i64* %mask.i7, align 8
  %or.i.i.i225 = or i64 %retval.sroa.0.0.i.i.i217, %i9.i.i222
  %and.i1.i.i226 = and i64 %retval.sroa.3.0.i.i.i218, %i11.i.i224
  %neg.i.i.i227 = xor i64 %and.i1.i.i226, -1
  %and4.i.i.i228 = and i64 %or.i.i.i225, %neg.i.i.i227
  store i64 %and4.i.i.i228, i64* %value.i4, align 8
  store i64 %and.i1.i.i226, i64* %mask.i7, align 8
  %i.i90.i232 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i234 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i235 = xor i64 %i5.i92.i234, %i.i90.i232
  %cmp.i.i.i94.i236 = icmp eq i64 %xor.i.i93.i235, 0
  br i1 %cmp.i.i.i94.i236, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i267

if.end.i.i.i124.i267:                             ; preds = %__reg_bound_offset.exit.i237
  %tobool.not.i.i.i.i95.i238 = icmp ult i64 %xor.i.i93.i235, 4294967296
  %shl.i.i.i.i96.i239 = shl i64 %xor.i.i93.i235, 32
  %spec.select.i.i.i.i97.i240 = select i1 %tobool.not.i.i.i.i95.i238, i64 %shl.i.i.i.i96.i239, i64 %xor.i.i93.i235
  %spec.select17.i.i.i.i98.i241 = select i1 %tobool.not.i.i.i.i95.i238, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i242 = icmp ult i64 %spec.select.i.i.i.i97.i240, 281474976710656
  %sub4.i.i.i.i100.i243 = add nsw i32 %spec.select17.i.i.i.i98.i241, -16
  %shl5.i.i.i.i101.i244 = shl i64 %spec.select.i.i.i.i97.i240, 16
  %word.addr.1.i.i.i.i102.i245 = select i1 %tobool2.not.i.i.i.i99.i242, i64 %shl5.i.i.i.i101.i244, i64 %spec.select.i.i.i.i97.i240
  %num.1.i.i.i.i103.i246 = select i1 %tobool2.not.i.i.i.i99.i242, i32 %sub4.i.i.i.i100.i243, i32 %spec.select17.i.i.i.i98.i241
  %tobool8.not.i.i.i.i104.i247 = icmp ult i64 %word.addr.1.i.i.i.i102.i245, 72057594037927936
  %sub10.i.i.i.i105.i248 = add nsw i32 %num.1.i.i.i.i103.i246, -8
  %shl11.i.i.i.i106.i249 = shl i64 %word.addr.1.i.i.i.i102.i245, 8
  %word.addr.2.i.i.i.i107.i250 = select i1 %tobool8.not.i.i.i.i104.i247, i64 %shl11.i.i.i.i106.i249, i64 %word.addr.1.i.i.i.i102.i245
  %num.2.i.i.i.i108.i251 = select i1 %tobool8.not.i.i.i.i104.i247, i32 %sub10.i.i.i.i105.i248, i32 %num.1.i.i.i.i103.i246
  %tobool14.not.i.i.i.i109.i252 = icmp ult i64 %word.addr.2.i.i.i.i107.i250, 1152921504606846976
  %sub16.i.i.i.i110.i253 = add nsw i32 %num.2.i.i.i.i108.i251, -4
  %shl17.i.i.i.i111.i254 = shl i64 %word.addr.2.i.i.i.i107.i250, 4
  %word.addr.3.i.i.i.i112.i255 = select i1 %tobool14.not.i.i.i.i109.i252, i64 %shl17.i.i.i.i111.i254, i64 %word.addr.2.i.i.i.i107.i250
  %num.3.i.i.i.i113.i256 = select i1 %tobool14.not.i.i.i.i109.i252, i32 %sub16.i.i.i.i110.i253, i32 %num.2.i.i.i.i108.i251
  %tobool20.not.i.i.i.i114.i257 = icmp ult i64 %word.addr.3.i.i.i.i112.i255, 4611686018427387904
  %sub22.i.i.i.i115.i258 = add i32 %num.3.i.i.i.i113.i256, 254
  %shl23.i.i.i.i116.i259 = shl i64 %word.addr.3.i.i.i.i112.i255, 2
  %word.addr.4.i.i.i.i117.i260 = select i1 %tobool20.not.i.i.i.i114.i257, i64 %shl23.i.i.i.i116.i259, i64 %word.addr.3.i.i.i.i112.i255
  %num.4.i.i.i.i118.i261 = select i1 %tobool20.not.i.i.i.i114.i257, i32 %sub22.i.i.i.i115.i258, i32 %num.3.i.i.i.i113.i256
  %word.addr.4.lobit.i.i.i.i119.i262.neg = lshr i64 %word.addr.4.i.i.i.i117.i260, 63
  %i.i.i.i.i120.i263.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i262.neg to i32
  %add.i.i.i123.i266 = add i32 %num.4.i.i.i.i118.i261, %i.i.i.i.i120.i263.neg
  %phi.bo36 = and i32 %add.i.i.i123.i266, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i267, %__reg_bound_offset.exit.i237
  %retval.0.i.i.i125.i268 = phi i32 [ %phi.bo36, %if.end.i.i.i124.i267 ], [ 0, %__reg_bound_offset.exit.i237 ]
  %cmp.i.i127.i270 = icmp ugt i32 %retval.0.i.i.i125.i268, 63
  %sh_prom.i.i128.i271 = zext i32 %retval.0.i.i.i125.i268 to i64
  %notmask.i.i129.i272 = shl nsw i64 -1, %sh_prom.i.i128.i271
  %sub.i.i130.i273 = xor i64 %notmask.i.i129.i272, -1
  %and.i.i131.i274 = and i64 %notmask.i.i129.i272, %i.i90.i232
  %retval.sroa.0.0.i.i132.i275 = select i1 %cmp.i.i127.i270, i64 0, i64 %and.i.i131.i274
  %retval.sroa.3.0.i.i133.i276 = select i1 %cmp.i.i127.i270, i64 -1, i64 %sub.i.i130.i273
  %i9.i137.i280 = load i64, i64* %value3.i6, align 8
  %i11.i139.i282 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i283 = or i64 %retval.sroa.0.0.i.i132.i275, %i9.i137.i280
  %and.i1.i141.i284 = and i64 %retval.sroa.3.0.i.i133.i276, %i11.i139.i282
  %neg.i.i142.i285 = xor i64 %and.i1.i141.i284, -1
  %and4.i.i143.i286 = and i64 %or.i.i140.i283, %neg.i.i142.i285
  store i64 %and4.i.i143.i286, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i284, i64* %mask6.i9, align 8
  %i.i148.i290 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i292 = load i64, i64* %value.i4, align 8
  %i24.i.i294 = load i64, i64* %mask.i7, align 8
  %and.i149.i295 = and i64 %i24.i.i294, -9223372036854775808
  %or.i150.i296 = or i64 %and.i149.i295, %i23.i.i292
  %cmp.i151.i297 = icmp sgt i64 %i.i148.i290, %or.i150.i296
  %cond.i152.i298 = select i1 %cmp.i151.i297, i64 %i.i148.i290, i64 %or.i150.i296
  store i64 %cond.i152.i298, i64* %smin_value.i10, align 8
  %i25.i.i300 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i301 = and i64 %i24.i.i294, 9223372036854775807
  %or8.i.i302 = or i64 %and7.i.i301, %i23.i.i292
  %cmp10.i.i303 = icmp slt i64 %i25.i.i300, %or8.i.i302
  %cond14.i.i304 = select i1 %cmp10.i.i303, i64 %i25.i.i300, i64 %or8.i.i302
  store i64 %cond14.i.i304, i64* %smax_value.i13, align 8
  %i26.i.i306 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i307 = icmp ugt i64 %i26.i.i306, %i23.i.i292
  %cond23.i.i308 = select i1 %cmp19.i.i307, i64 %i26.i.i306, i64 %i23.i.i292
  store i64 %cond23.i.i308, i64* %umin_value.i16, align 8
  %i27.i.i310 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i311 = or i64 %i24.i.i294, %i23.i.i292
  %cmp31.i156.i312 = icmp ult i64 %i27.i.i310, %or29.i.i311
  %cond35.i.i313 = select i1 %cmp31.i156.i312, i64 %i27.i.i310, i64 %or29.i.i311
  store i64 %cond35.i.i313, i64* %umax_value.i19, align 8
  %i.i158.i315 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i317 = load i64, i64* %value3.i6, align 8
  %i24.i162.i319 = load i64, i64* %mask6.i9, align 8
  %and.i163.i320 = and i64 %i24.i162.i319, -9223372036854775808
  %or.i164.i321 = or i64 %and.i163.i320, %i23.i160.i317
  %cmp.i165.i322 = icmp sgt i64 %i.i158.i315, %or.i164.i321
  %cond.i166.i323 = select i1 %cmp.i165.i322, i64 %i.i158.i315, i64 %or.i164.i321
  store i64 %cond.i166.i323, i64* %smin_value7.i12, align 8
  %i25.i168.i325 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i326 = and i64 %i24.i162.i319, 9223372036854775807
  %or8.i170.i327 = or i64 %and7.i169.i326, %i23.i160.i317
  %cmp10.i171.i328 = icmp slt i64 %i25.i168.i325, %or8.i170.i327
  %cond14.i172.i329 = select i1 %cmp10.i171.i328, i64 %i25.i168.i325, i64 %or8.i170.i327
  store i64 %cond14.i172.i329, i64* %smax_value8.i15, align 8
  %i26.i174.i331 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i332 = icmp ugt i64 %i26.i174.i331, %i23.i160.i317
  %cond23.i176.i333 = select i1 %cmp19.i175.i332, i64 %i26.i174.i331, i64 %i23.i160.i317
  store i64 %cond23.i176.i333, i64* %umin_value9.i18, align 8
  %i27.i178.i335 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i336 = or i64 %i24.i162.i319, %i23.i160.i317
  %cmp31.i180.i337 = icmp ult i64 %i27.i178.i335, %or29.i179.i336
  %cond35.i181.i338 = select i1 %cmp31.i180.i337, i64 %i27.i178.i335, i64 %or29.i179.i336
  store i64 %cond35.i181.i338, i64* %umax_value10.i21, align 8
  br label %if.end117

if.end117:                                        ; preds = %reg_set_min_max_inv.exit, %if.else70, %reg_set_min_max.exit, %if.then44, %if.then25
  ret void
}
