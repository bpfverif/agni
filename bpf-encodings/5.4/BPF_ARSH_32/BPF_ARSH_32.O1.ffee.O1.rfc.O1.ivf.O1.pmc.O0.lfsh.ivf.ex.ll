; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_ARSH_32/BPF_ARSH_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @adjust_scalar_min_max_vals_wrapper_BPF_ARSH_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg) local_unnamed_addr #0 {
entry:
...
sw.bb287.i:                                       ; preds = %if.end27.i
  %cmp288.not.i = icmp ult i64 %storemerge.i20.i, 32
  br i1 %cmp288.not.i, label %if.end291.i, label %if.then290.i

if.then290.i:                                     ; preds = %sw.bb287.i
  store i32 1, i32* %type, align 8
...
if.end291.i:                                      ; preds = %sw.bb287.i
  %shr293.i = ashr i64 %i27.i.i, %src_reg1.sroa.17.0
  store i64 %shr293.i, i64* %smin_value.i.i, align 8
  %shr295.i = lshr i64 %storemerge.i.i, %src_reg1.sroa.17.0
  store i64 %shr295.i, i64* %smax_value.i.i, align 8
  %sh_prom.i260.i = and i64 %src_reg1.sroa.17.0, 255
  %shr.i261.i = lshr i64 %and.i.i.i, %sh_prom.i260.i
  %shr5.i262.i = lshr i64 %and6.i.i.i, %sh_prom.i260.i
  store i64 %shr.i261.i, i64* %i.i.i, align 8
  store i64 %shr5.i262.i, i64* %i19.i.i, align 8
  store i64 0, i64* %umin_value.i.i, align 8
  store i64 -1, i64* %umax_value.i.i, align 8
  %and.i271.i = and i64 %shr5.i262.i, -9223372036854775808
  %or.i272.i = or i64 %and.i271.i, %shr.i261.i
  %cmp.i273.i = icmp sgt i64 %shr293.i, %or.i272.i
  %cond.i274.i = select i1 %cmp.i273.i, i64 %shr293.i, i64 %or.i272.i
  store i64 %cond.i274.i, i64* %smin_value.i.i, align 8
  %and7.i277.i = and i64 %shr5.i262.i, 9223372036854775807
  %or8.i278.i = or i64 %and7.i277.i, %shr.i261.i
  %cmp10.i279.i = icmp slt i64 %shr295.i, %or8.i278.i
  %cond14.i280.i = select i1 %cmp10.i279.i, i64 %shr295.i, i64 %or8.i278.i
  store i64 %cond14.i280.i, i64* %smax_value.i.i, align 8
  store i64 %shr.i261.i, i64* %umin_value.i.i, align 8
  %or29.i287.i = or i64 %shr5.i262.i, %shr.i261.i
  br label %if.then308.i

if.then308.i:                                     ; preds = %if.end291.i, %if.then290.i
  %storemerge = phi i64 [ -1, %if.then290.i ], [ %or29.i287.i, %if.end291.i ]
