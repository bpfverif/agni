; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JSGE_32/BPF_JSGE_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JSGE_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %cmp110.not.i = icmp sge i64 %conv6.i, %conv15.i
  %cmp115.i = icmp slt i64 %conv10.i, %conv15.i
  %narrow = select i1 %cmp110.not.i, i1 true, i1 %cmp115.i
...
cond.end:                                         ; preds = %if.then52
  ...
  %cond86.i = add nsw i64 %conv6.i62, -1
  %conv.i.i = trunc i64 %lo_reg1.sroa.1.0.copyload to i32
  %cmp.i.i63 = icmp sgt i32 %conv.i.i, -1
  br i1 %cmp.i.i63, label %land.lhs.true.i.i, label %lor.rhs.i.i

land.lhs.true.i.i:                                ; preds = %cond.end
  %i.i13.i = load i64, i64* %smin_value.i, align 8
  %cmp2.i.i = icmp sgt i64 %i.i13.i, -1
  br i1 %cmp2.i.i, label %land.lhs.true4.i.i, label %lor.rhs.i.i

land.lhs.true4.i.i:                               ; preds = %land.lhs.true.i.i
  %i5.i.i = load i64, i64* %smax_value.i, align 8
  %cmp5.i.i = icmp slt i64 %i5.i.i, 2147483648
  br i1 %cmp5.i.i, label %if.end99.i, label %lor.rhs.i.i

lor.rhs.i.i:                                      ; preds = %land.lhs.true4.i.i, %land.lhs.true.i.i, %cond.end
  %cmp8.i.i = icmp slt i32 %conv.i.i, 0
  br i1 %cmp8.i.i, label %land.lhs.true10.i.i, label %sw.epilog.i66

land.lhs.true10.i.i:                              ; preds = %lor.rhs.i.i
  %i6.i.i = load i64, i64* %smax_value.i, align 8
  %cmp12.i.i = icmp slt i64 %i6.i.i, 1
  br i1 %cmp12.i.i, label %land.rhs.i15.i, label %sw.epilog.i66

land.rhs.i15.i:                                   ; preds = %land.lhs.true10.i.i
  %i7.i.i = load i64, i64* %smin_value.i, align 8
  %cmp15.i.i = icmp sgt i64 %i7.i.i, -2147483649
  br i1 %cmp15.i.i, label %if.end99.i, label %sw.epilog.i66

if.end99.i:                                       ; preds = %land.rhs.i15.i, %land.lhs.true4.i.i
  %i125.i = load i64, i64* %smax_value.i, align 8
  %cmp101.i = icmp slt i64 %i125.i, %cond86.i
  %cond106.i = select i1 %cmp101.i, i64 %i125.i, i64 %cond86.i
  store i64 %cond106.i, i64* %smax_value.i, align 8
  %i126.i = load i64, i64* %smin_value7.i, align 8
  %cmp109.i = icmp sgt i64 %i126.i, %conv6.i62
  %cond114.i = select i1 %cmp109.i, i64 %i126.i, i64 %conv6.i62
  store i64 %cond114.i, i64* %smin_value7.i, align 8
  br label %sw.epilog.i66

sw.epilog.i66:                                    ; preds = %if.end99.i, %land.rhs.i15.i, %land.lhs.true10.i.i, %lor.rhs.i.i
  %i.i42.i = load i64, i64* %smin_value.i, align 8
  %cmp.i43.i = icmp sgt i64 %i.i42.i, -1
  br i1 %cmp.i43.i, label %if.then.i.i67, label %lor.lhs.false.i.i

lor.lhs.false.i.i:                                ; preds = %sw.epilog.i66
  %i33.i.i = load i64, i64* %smax_value.i, align 8
  %cmp1.i45.i = icmp slt i64 %i33.i.i, 0
  br i1 %cmp1.i45.i, label %if.then.i.i67, label %if.end.i.i

if.then.i.i67:                                    ; preds = %lor.lhs.false.i.i, %sw.epilog.i66
...
if.end.i.i:                                       ; preds = %lor.lhs.false.i.i
  ...
  br i1 %cmp16.i.i, label %if.then17.i.i, label %if.else.i.i68
...
__reg_deduce_bounds.exit.i.sink.split:            ; preds = %if.then32.i.i, %if.then17.i.i, %if.then.i.i67
  %i37.i.i.sink = phi i64 [ %i37.i.i, %if.then32.i.i ], [ %cond27.i.i, %if.then17.i.i ], [ %cond12.i.i, %if.then.i.i67 ]
  store i64 %i37.i.i.sink, i64* %smax_value.i, align 8
  br label %__reg_deduce_bounds.exit.i

__reg_deduce_bounds.exit.i:                       ; preds = %__reg_deduce_bounds.exit.i.sink.split, %if.else.i.i68
...
__reg_bound_offset.exit.i:                        ; preds = %if.end.i.i.i.i, %__reg_deduce_bounds.exit81.i
  ...
  %and.i.i.i69 = and i64 %notmask.i.i.i, %i.i83.i
  %retval.sroa.0.0.i.i.i = select i1 %cmp.i.i.i, i64 0, i64 %and.i.i.i69
...
reg_set_min_max.exit:                             ; preds = %if.end.i.i.i124.i, %__reg_bound_offset.exit.i
  ...
  %i23.i.i70 = load i64, i64* %value.i, align 8
  %i24.i.i71 = load i64, i64* %mask.i, align 8
  %and.i149.i = and i64 %i24.i.i71, -9223372036854775808
  %or.i150.i = or i64 %and.i149.i, %i23.i.i70
  ...
  %i25.i.i72 = load i64, i64* %smax_value.i, align 8
  %and7.i.i = and i64 %i24.i.i71, 9223372036854775807
  %or8.i.i = or i64 %and7.i.i, %i23.i.i70
  %cmp10.i.i = icmp slt i64 %i25.i.i72, %or8.i.i
  %cond14.i.i = select i1 %cmp10.i.i, i64 %i25.i.i72, i64 %or8.i.i
  store i64 %cond14.i.i, i64* %smax_value.i, align 8
  %i26.i.i73 = load i64, i64* %umin_value.i, align 8
  %cmp19.i.i = icmp ugt i64 %i26.i.i73, %i23.i.i70
  %cond23.i.i = select i1 %cmp19.i.i, i64 %i26.i.i73, i64 %i23.i.i70
  store i64 %cond23.i.i, i64* %umin_value.i, align 8
  %i27.i.i74 = load i64, i64* %umax_value.i, align 8
  %or29.i.i = or i64 %i24.i.i71, %i23.i.i70
  %cmp31.i156.i = icmp ult i64 %i27.i.i74, %or29.i.i
  %cond35.i.i = select i1 %cmp31.i156.i, i64 %i27.i.i74, i64 %or29.i.i
...
if.else70:                                        ; preds = %if.then52
  %tobool.not.i76 = icmp eq i64 %and6.i.i30, 0
  br i1 %tobool.not.i76, label %cond.end90, label %if.end117

cond.end90:                                       ; preds = %if.else70
  %sext.i78 = shl i64 %lo_reg0.sroa.1.0.copyload, 32
  %conv6.i79 = ashr exact i64 %sext.i78, 32
  %cond86.i80 = add nsw i64 %conv6.i79, 1
  %conv.i.i81 = trunc i64 %lo_reg0.sroa.1.0.copyload to i32
  %cmp.i.i82 = icmp sgt i32 %conv.i.i81, -1
  br i1 %cmp.i.i82, label %land.lhs.true.i.i86, label %lor.rhs.i.i92

land.lhs.true.i.i86:                              ; preds = %cond.end90
  %i.i13.i84 = load i64, i64* %smin_value.i10, align 8
  %cmp2.i.i85 = icmp sgt i64 %i.i13.i84, -1
  br i1 %cmp2.i.i85, label %land.lhs.true4.i.i90, label %lor.rhs.i.i92

land.lhs.true4.i.i90:                             ; preds = %land.lhs.true.i.i86
  %i5.i.i88 = load i64, i64* %smax_value.i13, align 8
  %cmp5.i.i89 = icmp slt i64 %i5.i.i88, 2147483648
  br i1 %cmp5.i.i89, label %if.end99.i111, label %lor.rhs.i.i92

lor.rhs.i.i92:                                    ; preds = %land.lhs.true4.i.i90, %land.lhs.true.i.i86, %cond.end90
  %cmp8.i.i91 = icmp slt i32 %conv.i.i81, 0
  br i1 %cmp8.i.i91, label %land.lhs.true10.i.i96, label %sw.epilog.i115

land.lhs.true10.i.i96:                            ; preds = %lor.rhs.i.i92
  %i6.i.i94 = load i64, i64* %smax_value.i13, align 8
  %cmp12.i.i95 = icmp slt i64 %i6.i.i94, 1
  br i1 %cmp12.i.i95, label %land.rhs.i15.i100, label %sw.epilog.i115

land.rhs.i15.i100:                                ; preds = %land.lhs.true10.i.i96
  %i7.i.i98 = load i64, i64* %smin_value.i10, align 8
  %cmp15.i.i99 = icmp sgt i64 %i7.i.i98, -2147483649
  br i1 %cmp15.i.i99, label %if.end99.i111, label %sw.epilog.i115

if.end99.i111:                                    ; preds = %land.rhs.i15.i100, %land.lhs.true4.i.i90
  %i125.i104 = load i64, i64* %smin_value.i10, align 8
  %cmp101.i105 = icmp sgt i64 %i125.i104, %cond86.i80
  %cond106.i106 = select i1 %cmp101.i105, i64 %i125.i104, i64 %cond86.i80
  store i64 %cond106.i106, i64* %smin_value.i10, align 8
  %i126.i108 = load i64, i64* %smax_value8.i15, align 8
  %cmp109.i109 = icmp slt i64 %i126.i108, %conv6.i79
  %cond114.i110 = select i1 %cmp109.i109, i64 %i126.i108, i64 %conv6.i79
  store i64 %cond114.i110, i64* %smax_value8.i15, align 8
  br label %sw.epilog.i115

sw.epilog.i115:                                   ; preds = %if.end99.i111, %land.rhs.i15.i100, %land.lhs.true10.i.i96, %lor.rhs.i.i92
  %i.i42.i113 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i114 = icmp sgt i64 %i.i42.i113, -1
  br i1 %cmp.i43.i114, label %if.then.i.i130, label %lor.lhs.false.i.i119

lor.lhs.false.i.i119:                             ; preds = %sw.epilog.i115
  %i33.i.i117 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i118 = icmp slt i64 %i33.i.i117, 0
  br i1 %cmp1.i45.i118, label %if.then.i.i130, label %if.end.i.i136

if.then.i.i130:                                   ; preds = %lor.lhs.false.i.i119, %sw.epilog.i115
  %i34.i.i121 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i122 = icmp ugt i64 %i.i42.i113, %i34.i.i121
  %cond.i.i123 = select i1 %cmp3.i.i122, i64 %i.i42.i113, i64 %i34.i.i121
  store i64 %cond.i.i123, i64* %umin_value.i16, align 8
  store i64 %cond.i.i123, i64* %smin_value.i10, align 8
  %i35.i.i125 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i127 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i128 = icmp ult i64 %i35.i.i125, %i36.i.i127
  %cond12.i.i129 = select i1 %cmp8.i48.i128, i64 %i35.i.i125, i64 %i36.i.i127
  store i64 %cond12.i.i129, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i148.sink.split

if.end.i.i136:                                    ; preds = %lor.lhs.false.i.i119
  %i37.i.i132 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i133 = icmp sgt i64 %i37.i.i132, -1
  %i38.i.i135 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i133, label %if.then17.i.i139, label %if.else.i.i141

if.then17.i.i139:                                 ; preds = %if.end.i.i136
  store i64 %i38.i.i135, i64* %smin_value.i10, align 8
  %cmp23.i.i137 = icmp ult i64 %i33.i.i117, %i37.i.i132
  %cond27.i.i138 = select i1 %cmp23.i.i137, i64 %i33.i.i117, i64 %i37.i.i132
  store i64 %cond27.i.i138, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i148.sink.split

if.else.i.i141:                                   ; preds = %if.end.i.i136
  %cmp31.i.i140 = icmp slt i64 %i38.i.i135, 0
  br i1 %cmp31.i.i140, label %if.then32.i.i144, label %__reg_deduce_bounds.exit.i148

if.then32.i.i144:                                 ; preds = %if.else.i.i141
  %cmp36.i.i142 = icmp ugt i64 %i.i42.i113, %i38.i.i135
  %cond40.i.i143 = select i1 %cmp36.i.i142, i64 %i.i42.i113, i64 %i38.i.i135
  store i64 %cond40.i.i143, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i143, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i148.sink.split

__reg_deduce_bounds.exit.i148.sink.split:         ; preds = %if.then32.i.i144, %if.then17.i.i139, %if.then.i.i130
  %i37.i.i132.sink = phi i64 [ %i37.i.i132, %if.then32.i.i144 ], [ %cond27.i.i138, %if.then17.i.i139 ], [ %cond12.i.i129, %if.then.i.i130 ]
  store i64 %i37.i.i132.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i148

__reg_deduce_bounds.exit.i148:                    ; preds = %__reg_deduce_bounds.exit.i148.sink.split, %if.else.i.i141
  %i.i50.i146 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i147 = icmp sgt i64 %i.i50.i146, -1
  br i1 %cmp.i51.i147, label %if.then.i66.i163, label %lor.lhs.false.i55.i152

lor.lhs.false.i55.i152:                           ; preds = %__reg_deduce_bounds.exit.i148
  %i33.i53.i150 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i151 = icmp slt i64 %i33.i53.i150, 0
  br i1 %cmp1.i54.i151, label %if.then.i66.i163, label %if.end.i72.i169

if.then.i66.i163:                                 ; preds = %lor.lhs.false.i55.i152, %__reg_deduce_bounds.exit.i148
  %i34.i57.i154 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i155 = icmp ugt i64 %i.i50.i146, %i34.i57.i154
  %cond.i59.i156 = select i1 %cmp3.i58.i155, i64 %i.i50.i146, i64 %i34.i57.i154
  store i64 %cond.i59.i156, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i156, i64* %smin_value7.i12, align 8
  %i35.i61.i158 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i160 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i161 = icmp ult i64 %i35.i61.i158, %i36.i63.i160
  %cond12.i65.i162 = select i1 %cmp8.i64.i161, i64 %i35.i61.i158, i64 %i36.i63.i160
  store i64 %cond12.i65.i162, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i184.sink.split

if.end.i72.i169:                                  ; preds = %lor.lhs.false.i55.i152
  %i37.i68.i165 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i166 = icmp sgt i64 %i37.i68.i165, -1
  %i38.i71.i168 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i166, label %if.then17.i75.i172, label %if.else.i77.i174

if.then17.i75.i172:                               ; preds = %if.end.i72.i169
  store i64 %i38.i71.i168, i64* %smin_value7.i12, align 8
  %cmp23.i73.i170 = icmp ult i64 %i33.i53.i150, %i37.i68.i165
  %cond27.i74.i171 = select i1 %cmp23.i73.i170, i64 %i33.i53.i150, i64 %i37.i68.i165
  store i64 %cond27.i74.i171, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i184.sink.split

if.else.i77.i174:                                 ; preds = %if.end.i72.i169
  %cmp31.i76.i173 = icmp slt i64 %i38.i71.i168, 0
  br i1 %cmp31.i76.i173, label %if.then32.i80.i177, label %__reg_deduce_bounds.exit81.i184

if.then32.i80.i177:                               ; preds = %if.else.i77.i174
  %cmp36.i78.i175 = icmp ugt i64 %i.i50.i146, %i38.i71.i168
  %cond40.i79.i176 = select i1 %cmp36.i78.i175, i64 %i.i50.i146, i64 %i38.i71.i168
  store i64 %cond40.i79.i176, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i176, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i184.sink.split

__reg_deduce_bounds.exit81.i184.sink.split:       ; preds = %if.then32.i80.i177, %if.then17.i75.i172, %if.then.i66.i163
  %i37.i68.i165.sink = phi i64 [ %i37.i68.i165, %if.then32.i80.i177 ], [ %cond27.i74.i171, %if.then17.i75.i172 ], [ %cond12.i65.i162, %if.then.i66.i163 ]
  store i64 %i37.i68.i165.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i184

__reg_deduce_bounds.exit81.i184:                  ; preds = %__reg_deduce_bounds.exit81.i184.sink.split, %if.else.i77.i174
  %i.i83.i179 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i181 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i182 = xor i64 %i5.i85.i181, %i.i83.i179
  %cmp.i.i.i.i183 = icmp eq i64 %xor.i.i.i182, 0
  br i1 %cmp.i.i.i.i183, label %__reg_bound_offset.exit.i242, label %if.end.i.i.i.i214

if.end.i.i.i.i214:                                ; preds = %__reg_deduce_bounds.exit81.i184
  %tobool.not.i.i.i.i.i185 = icmp ult i64 %xor.i.i.i182, 4294967296
  %shl.i.i.i.i.i186 = shl i64 %xor.i.i.i182, 32
  %spec.select.i.i.i.i.i187 = select i1 %tobool.not.i.i.i.i.i185, i64 %shl.i.i.i.i.i186, i64 %xor.i.i.i182
  %spec.select17.i.i.i.i.i188 = select i1 %tobool.not.i.i.i.i.i185, i32 31, i32 63
  %tobool2.not.i.i.i.i.i189 = icmp ult i64 %spec.select.i.i.i.i.i187, 281474976710656
  %sub4.i.i.i.i.i190 = add nsw i32 %spec.select17.i.i.i.i.i188, -16
  %shl5.i.i.i.i.i191 = shl i64 %spec.select.i.i.i.i.i187, 16
  %word.addr.1.i.i.i.i.i192 = select i1 %tobool2.not.i.i.i.i.i189, i64 %shl5.i.i.i.i.i191, i64 %spec.select.i.i.i.i.i187
  %num.1.i.i.i.i.i193 = select i1 %tobool2.not.i.i.i.i.i189, i32 %sub4.i.i.i.i.i190, i32 %spec.select17.i.i.i.i.i188
  %tobool8.not.i.i.i.i.i194 = icmp ult i64 %word.addr.1.i.i.i.i.i192, 72057594037927936
  %sub10.i.i.i.i.i195 = add nsw i32 %num.1.i.i.i.i.i193, -8
  %shl11.i.i.i.i.i196 = shl i64 %word.addr.1.i.i.i.i.i192, 8
  %word.addr.2.i.i.i.i.i197 = select i1 %tobool8.not.i.i.i.i.i194, i64 %shl11.i.i.i.i.i196, i64 %word.addr.1.i.i.i.i.i192
  %num.2.i.i.i.i.i198 = select i1 %tobool8.not.i.i.i.i.i194, i32 %sub10.i.i.i.i.i195, i32 %num.1.i.i.i.i.i193
  %tobool14.not.i.i.i.i.i199 = icmp ult i64 %word.addr.2.i.i.i.i.i197, 1152921504606846976
  %sub16.i.i.i.i.i200 = add nsw i32 %num.2.i.i.i.i.i198, -4
  %shl17.i.i.i.i.i201 = shl i64 %word.addr.2.i.i.i.i.i197, 4
  %word.addr.3.i.i.i.i.i202 = select i1 %tobool14.not.i.i.i.i.i199, i64 %shl17.i.i.i.i.i201, i64 %word.addr.2.i.i.i.i.i197
  %num.3.i.i.i.i.i203 = select i1 %tobool14.not.i.i.i.i.i199, i32 %sub16.i.i.i.i.i200, i32 %num.2.i.i.i.i.i198
  %tobool20.not.i.i.i.i.i204 = icmp ult i64 %word.addr.3.i.i.i.i.i202, 4611686018427387904
  %sub22.i.i.i.i.i205 = add i32 %num.3.i.i.i.i.i203, 254
  %shl23.i.i.i.i.i206 = shl i64 %word.addr.3.i.i.i.i.i202, 2
  %word.addr.4.i.i.i.i.i207 = select i1 %tobool20.not.i.i.i.i.i204, i64 %shl23.i.i.i.i.i206, i64 %word.addr.3.i.i.i.i.i202
  %num.4.i.i.i.i.i208 = select i1 %tobool20.not.i.i.i.i.i204, i32 %sub22.i.i.i.i.i205, i32 %num.3.i.i.i.i.i203
  %word.addr.4.lobit.i.i.i.i.i209.neg = lshr i64 %word.addr.4.i.i.i.i.i207, 63
  %i.i.i.i.i.i210.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i209.neg to i32
  %add.i.i.i.i213 = add i32 %num.4.i.i.i.i.i208, %i.i.i.i.i.i210.neg
  %phi.bo = and i32 %add.i.i.i.i213, 255
  br label %__reg_bound_offset.exit.i242

__reg_bound_offset.exit.i242:                     ; preds = %if.end.i.i.i.i214, %__reg_deduce_bounds.exit81.i184
  %retval.0.i.i.i.i215 = phi i32 [ %phi.bo, %if.end.i.i.i.i214 ], [ 0, %__reg_deduce_bounds.exit81.i184 ]
  %cmp.i.i.i217 = icmp ugt i32 %retval.0.i.i.i.i215, 63
  %sh_prom.i.i.i218 = zext i32 %retval.0.i.i.i.i215 to i64
  %notmask.i.i.i219 = shl nsw i64 -1, %sh_prom.i.i.i218
  %sub.i.i.i220 = xor i64 %notmask.i.i.i219, -1
  %and.i.i.i221 = and i64 %notmask.i.i.i219, %i.i83.i179
  %retval.sroa.0.0.i.i.i222 = select i1 %cmp.i.i.i217, i64 0, i64 %and.i.i.i221
  %retval.sroa.3.0.i.i.i223 = select i1 %cmp.i.i.i217, i64 -1, i64 %sub.i.i.i220
  %i9.i.i227 = load i64, i64* %value.i4, align 8
  %i11.i.i229 = load i64, i64* %mask.i7, align 8
  %or.i.i.i230 = or i64 %retval.sroa.0.0.i.i.i222, %i9.i.i227
  %and.i1.i.i231 = and i64 %retval.sroa.3.0.i.i.i223, %i11.i.i229
  %neg.i.i.i232 = xor i64 %and.i1.i.i231, -1
  %and4.i.i.i233 = and i64 %or.i.i.i230, %neg.i.i.i232
  store i64 %and4.i.i.i233, i64* %value.i4, align 8
  store i64 %and.i1.i.i231, i64* %mask.i7, align 8
  %i.i90.i237 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i239 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i240 = xor i64 %i5.i92.i239, %i.i90.i237
  %cmp.i.i.i94.i241 = icmp eq i64 %xor.i.i93.i240, 0
  br i1 %cmp.i.i.i94.i241, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i272

if.end.i.i.i124.i272:                             ; preds = %__reg_bound_offset.exit.i242
  %tobool.not.i.i.i.i95.i243 = icmp ult i64 %xor.i.i93.i240, 4294967296
  %shl.i.i.i.i96.i244 = shl i64 %xor.i.i93.i240, 32
  %spec.select.i.i.i.i97.i245 = select i1 %tobool.not.i.i.i.i95.i243, i64 %shl.i.i.i.i96.i244, i64 %xor.i.i93.i240
  %spec.select17.i.i.i.i98.i246 = select i1 %tobool.not.i.i.i.i95.i243, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i247 = icmp ult i64 %spec.select.i.i.i.i97.i245, 281474976710656
  %sub4.i.i.i.i100.i248 = add nsw i32 %spec.select17.i.i.i.i98.i246, -16
  %shl5.i.i.i.i101.i249 = shl i64 %spec.select.i.i.i.i97.i245, 16
  %word.addr.1.i.i.i.i102.i250 = select i1 %tobool2.not.i.i.i.i99.i247, i64 %shl5.i.i.i.i101.i249, i64 %spec.select.i.i.i.i97.i245
  %num.1.i.i.i.i103.i251 = select i1 %tobool2.not.i.i.i.i99.i247, i32 %sub4.i.i.i.i100.i248, i32 %spec.select17.i.i.i.i98.i246
  %tobool8.not.i.i.i.i104.i252 = icmp ult i64 %word.addr.1.i.i.i.i102.i250, 72057594037927936
  %sub10.i.i.i.i105.i253 = add nsw i32 %num.1.i.i.i.i103.i251, -8
  %shl11.i.i.i.i106.i254 = shl i64 %word.addr.1.i.i.i.i102.i250, 8
  %word.addr.2.i.i.i.i107.i255 = select i1 %tobool8.not.i.i.i.i104.i252, i64 %shl11.i.i.i.i106.i254, i64 %word.addr.1.i.i.i.i102.i250
  %num.2.i.i.i.i108.i256 = select i1 %tobool8.not.i.i.i.i104.i252, i32 %sub10.i.i.i.i105.i253, i32 %num.1.i.i.i.i103.i251
  %tobool14.not.i.i.i.i109.i257 = icmp ult i64 %word.addr.2.i.i.i.i107.i255, 1152921504606846976
  %sub16.i.i.i.i110.i258 = add nsw i32 %num.2.i.i.i.i108.i256, -4
  %shl17.i.i.i.i111.i259 = shl i64 %word.addr.2.i.i.i.i107.i255, 4
  %word.addr.3.i.i.i.i112.i260 = select i1 %tobool14.not.i.i.i.i109.i257, i64 %shl17.i.i.i.i111.i259, i64 %word.addr.2.i.i.i.i107.i255
  %num.3.i.i.i.i113.i261 = select i1 %tobool14.not.i.i.i.i109.i257, i32 %sub16.i.i.i.i110.i258, i32 %num.2.i.i.i.i108.i256
  %tobool20.not.i.i.i.i114.i262 = icmp ult i64 %word.addr.3.i.i.i.i112.i260, 4611686018427387904
  %sub22.i.i.i.i115.i263 = add i32 %num.3.i.i.i.i113.i261, 254
  %shl23.i.i.i.i116.i264 = shl i64 %word.addr.3.i.i.i.i112.i260, 2
  %word.addr.4.i.i.i.i117.i265 = select i1 %tobool20.not.i.i.i.i114.i262, i64 %shl23.i.i.i.i116.i264, i64 %word.addr.3.i.i.i.i112.i260
  %num.4.i.i.i.i118.i266 = select i1 %tobool20.not.i.i.i.i114.i262, i32 %sub22.i.i.i.i115.i263, i32 %num.3.i.i.i.i113.i261
  %word.addr.4.lobit.i.i.i.i119.i267.neg = lshr i64 %word.addr.4.i.i.i.i117.i265, 63
  %i.i.i.i.i120.i268.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i267.neg to i32
  %add.i.i.i123.i271 = add i32 %num.4.i.i.i.i118.i266, %i.i.i.i.i120.i268.neg
  %phi.bo36 = and i32 %add.i.i.i123.i271, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i272, %__reg_bound_offset.exit.i242
  %retval.0.i.i.i125.i273 = phi i32 [ %phi.bo36, %if.end.i.i.i124.i272 ], [ 0, %__reg_bound_offset.exit.i242 ]
  %cmp.i.i127.i275 = icmp ugt i32 %retval.0.i.i.i125.i273, 63
  %sh_prom.i.i128.i276 = zext i32 %retval.0.i.i.i125.i273 to i64
  %notmask.i.i129.i277 = shl nsw i64 -1, %sh_prom.i.i128.i276
  %sub.i.i130.i278 = xor i64 %notmask.i.i129.i277, -1
  %and.i.i131.i279 = and i64 %notmask.i.i129.i277, %i.i90.i237
  %retval.sroa.0.0.i.i132.i280 = select i1 %cmp.i.i127.i275, i64 0, i64 %and.i.i131.i279
  %retval.sroa.3.0.i.i133.i281 = select i1 %cmp.i.i127.i275, i64 -1, i64 %sub.i.i130.i278
  %i9.i137.i285 = load i64, i64* %value3.i6, align 8
  %i11.i139.i287 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i288 = or i64 %retval.sroa.0.0.i.i132.i280, %i9.i137.i285
  %and.i1.i141.i289 = and i64 %retval.sroa.3.0.i.i133.i281, %i11.i139.i287
  %neg.i.i142.i290 = xor i64 %and.i1.i141.i289, -1
  %and4.i.i143.i291 = and i64 %or.i.i140.i288, %neg.i.i142.i290
  store i64 %and4.i.i143.i291, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i289, i64* %mask6.i9, align 8
  %i.i148.i295 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i297 = load i64, i64* %value.i4, align 8
  %i24.i.i299 = load i64, i64* %mask.i7, align 8
  %and.i149.i300 = and i64 %i24.i.i299, -9223372036854775808
  %or.i150.i301 = or i64 %and.i149.i300, %i23.i.i297
  %cmp.i151.i302 = icmp sgt i64 %i.i148.i295, %or.i150.i301
  %cond.i152.i303 = select i1 %cmp.i151.i302, i64 %i.i148.i295, i64 %or.i150.i301
  store i64 %cond.i152.i303, i64* %smin_value.i10, align 8
  %i25.i.i305 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i306 = and i64 %i24.i.i299, 9223372036854775807
  %or8.i.i307 = or i64 %and7.i.i306, %i23.i.i297
  %cmp10.i.i308 = icmp slt i64 %i25.i.i305, %or8.i.i307
  %cond14.i.i309 = select i1 %cmp10.i.i308, i64 %i25.i.i305, i64 %or8.i.i307
  store i64 %cond14.i.i309, i64* %smax_value.i13, align 8
  %i26.i.i311 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i312 = icmp ugt i64 %i26.i.i311, %i23.i.i297
  %cond23.i.i313 = select i1 %cmp19.i.i312, i64 %i26.i.i311, i64 %i23.i.i297
  store i64 %cond23.i.i313, i64* %umin_value.i16, align 8
  %i27.i.i315 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i316 = or i64 %i24.i.i299, %i23.i.i297
  %cmp31.i156.i317 = icmp ult i64 %i27.i.i315, %or29.i.i316
  %cond35.i.i318 = select i1 %cmp31.i156.i317, i64 %i27.i.i315, i64 %or29.i.i316
  store i64 %cond35.i.i318, i64* %umax_value.i19, align 8
  %i.i158.i320 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i322 = load i64, i64* %value3.i6, align 8
  %i24.i162.i324 = load i64, i64* %mask6.i9, align 8
  %and.i163.i325 = and i64 %i24.i162.i324, -9223372036854775808
  %or.i164.i326 = or i64 %and.i163.i325, %i23.i160.i322
  %cmp.i165.i327 = icmp sgt i64 %i.i158.i320, %or.i164.i326
  %cond.i166.i328 = select i1 %cmp.i165.i327, i64 %i.i158.i320, i64 %or.i164.i326
  store i64 %cond.i166.i328, i64* %smin_value7.i12, align 8
  %i25.i168.i330 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i331 = and i64 %i24.i162.i324, 9223372036854775807
  %or8.i170.i332 = or i64 %and7.i169.i331, %i23.i160.i322
  %cmp10.i171.i333 = icmp slt i64 %i25.i168.i330, %or8.i170.i332
  %cond14.i172.i334 = select i1 %cmp10.i171.i333, i64 %i25.i168.i330, i64 %or8.i170.i332
  store i64 %cond14.i172.i334, i64* %smax_value8.i15, align 8
  %i26.i174.i336 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i337 = icmp ugt i64 %i26.i174.i336, %i23.i160.i322
  %cond23.i176.i338 = select i1 %cmp19.i175.i337, i64 %i26.i174.i336, i64 %i23.i160.i322
  store i64 %cond23.i176.i338, i64* %umin_value9.i18, align 8
  %i27.i178.i340 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i341 = or i64 %i24.i162.i324, %i23.i160.i322
  %cmp31.i180.i342 = icmp ult i64 %i27.i178.i340, %or29.i179.i341
  %cond35.i181.i343 = select i1 %cmp31.i180.i342, i64 %i27.i178.i340, i64 %or29.i179.i341
  store i64 %cond35.i181.i343, i64* %umax_value10.i21, align 8
  br label %if.end117
