; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JSLE_32/BPF_JSLE_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JSLE_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %cmp134.not.i = icmp sle i64 %conv10.i, %conv15.i
  %cmp139.i = icmp sgt i64 %conv6.i, %conv15.i
  %narrow = select i1 %cmp134.not.i, i1 true, i1 %cmp139.i
...
cond.end:                                         ; preds = %if.then52
  ...
  %cond168.i = add nsw i64 %conv6.i62, 1
...
if.end182.i:                                      ; preds = %land.rhs.i38.i, %land.lhs.true4.i28.i
  ...
  %cmp194.i = icmp slt i64 %i136.i, %conv6.i62
  %cond199.i = select i1 %cmp194.i, i64 %i136.i, i64 %conv6.i62
...
cond.end90:                                       ; preds = %if.else70
  ...
  %cond168.i77 = add nsw i64 %conv6.i76, -1
...
if.end182.i106:                                   ; preds = %land.rhs.i38.i97, %land.lhs.true4.i28.i87
  ...
  %cmp185.i101 = icmp slt i64 %i135.i100, %cond168.i77
  %cond190.i102 = select i1 %cmp185.i101, i64 %i135.i100, i64 %cond168.i77
  store i64 %cond190.i102, i64* %smax_value.i13, align 8
  %i136.i103 = load i64, i64* %smin_value7.i12, align 8
  %cmp194.i104 = icmp sgt i64 %i136.i103, %conv6.i76
  %cond199.i105 = select i1 %cmp194.i104, i64 %i136.i103, i64 %conv6.i76
