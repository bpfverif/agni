; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_AND_32/BPF_AND_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @adjust_scalar_min_max_vals_wrapper_BPF_AND_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg) local_unnamed_addr #0 {
entry:
...
if.end171.i:                                      ; preds = %if.end27.i, %lor.lhs.false20.i
...
if.then308.i:                                     ; preds = %if.end171.i, %if.then166.i
