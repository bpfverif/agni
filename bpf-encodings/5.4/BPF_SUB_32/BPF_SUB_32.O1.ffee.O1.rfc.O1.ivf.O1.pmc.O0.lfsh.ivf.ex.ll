; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_SUB_32/BPF_SUB_32.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @adjust_scalar_min_max_vals_wrapper_BPF_SUB_32(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg) local_unnamed_addr #0 {
entry:
...
if.end27.i:                                       ; preds = %lor.lhs.false20.i, %land.lhs.true.i
  %sub.i.i = sub i64 %i27.i.i, %storemerge.i20.i
  %cmp2.i44.i = icmp sgt i64 %sub.i.i, %i27.i.i
  %sub.i46.i = sub nsw i64 %storemerge.i.i, %src_reg1.sroa.17.0
  %storemerge21 = select i1 %cmp2.i44.i, i64 -9223372036854775808, i64 %sub.i.i
  %storemerge = select i1 %cmp2.i44.i, i64 9223372036854775807, i64 %sub.i46.i
  store i64 %storemerge21, i64* %smin_value.i.i, align 8
  store i64 %storemerge, i64* %smax_value.i.i, align 8
  %cmp107.i = icmp ult i64 %i27.i.i, %storemerge.i20.i
  br i1 %cmp107.i, label %if.then109.i, label %if.else112.i

if.then109.i:                                     ; preds = %if.end27.i
  store i64 0, i64* %umin_value.i.i, align 8
  br label %if.end117.i

if.else112.i:                                     ; preds = %if.end27.i
  store i64 %sub.i.i, i64* %umin_value.i.i, align 8
  %sub116.i = sub nsw i64 %storemerge.i.i, %src_reg1.sroa.17.0
  br label %if.end117.i

if.end117.i:                                      ; preds = %if.else112.i, %if.then109.i
  %storemerge22 = phi i64 [ %sub116.i, %if.else112.i ], [ -1, %if.then109.i ]
  store i64 %storemerge22, i64* %umax_value.i.i, align 8
  %sub.i51.i = sub nsw i64 %and.i.i.i, %and.i.i5.i
  %add.i52.i = add nsw i64 %sub.i51.i, %and6.i.i.i
  %sub3.i.i = sub nsw i64 %sub.i51.i, %and6.i.i6.i
  %xor.i53.i = xor i64 %add.i52.i, %sub3.i.i
  %or.i54.i = or i64 %and6.i.i.i, %and6.i.i6.i
  %or6.i.i = or i64 %or.i54.i, %xor.i53.i
  %neg.i55.i = xor i64 %or6.i.i, -1
  %and.i56.i = and i64 %sub.i51.i, %neg.i55.i
  store i64 %and.i56.i, i64* %i.i.i, align 8
  store i64 %or6.i.i, i64* %i19.i.i, align 8
  %and.i.i301.i = and i64 %and.i56.i, 4294967295
  %and6.i.i302.i = and i64 %or6.i.i, 4294967295
...
if.then.i314.i:                                   ; preds = %if.end117.i
...
if.else.i315.i:                                   ; preds = %if.end117.i
  store i64 0, i64* %umin_value.i.i, align 8
  br label %coerce_reg_to_size.exit320.i
...
adjust_scalar_min_max_vals.exit:                  ; preds = %__reg_bound_offset.exit.i, %if.then26.i
  ret void
}
