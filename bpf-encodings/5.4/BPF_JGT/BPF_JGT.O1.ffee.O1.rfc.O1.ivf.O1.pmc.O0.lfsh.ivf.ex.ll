; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JGT/BPF_JGT.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JGT(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  ...
  %i75.i = load i64, i64* %umin_value.i, align 8
  %cmp.i = icmp ugt i64 %i75.i, %i58
  br i1 %cmp.i, label %is_branch_taken.exit, label %if.else53.i

if.else53.i:                                      ; preds = %if.then25
  %i76.i = load i64, i64* %umax_value.i, align 8
  %cmp55.not.i = icmp ugt i64 %i76.i, %i58
  %spec.select = sext i1 %cmp55.not.i to i32
  br label %is_branch_taken.exit

is_branch_taken.exit:                             ; preds = %if.else53.i, %if.then25
  %retval.0.i = phi i32 [ 1, %if.then25 ], [ %spec.select, %if.else53.i ]
...
if.then52:                                        ; preds = %if.then44
  ...
  %tobool.not.i53 = icmp eq i64 %i66, 0
  br i1 %tobool.not.i53, label %cond.end, label %if.else70

cond.end:                                         ; preds = %if.then52
  %i67 = load i64, i64* %value.i4, align 8
  %cond52.i = add i64 %i67, 1
  %i123.i = load i64, i64* %umax_value.i, align 8
  %cmp63.i = icmp ult i64 %i123.i, %i67
  %cond68.i = select i1 %cmp63.i, i64 %i123.i, i64 %i67
  store i64 %cond68.i, i64* %umax_value.i, align 8
  %i124.i = load i64, i64* %umin_value9.i, align 8
  %cmp71.i = icmp ugt i64 %i124.i, %cond52.i
  %cond76.i = select i1 %cmp71.i, i64 %i124.i, i64 %cond52.i
...
if.else70:                                        ; preds = %if.then52
  ...
  %tobool.not.i57 = icmp eq i64 %i69, 0
  br i1 %tobool.not.i57, label %cond.end90, label %if.end117

cond.end90:                                       ; preds = %if.else70
  %i70 = load i64, i64* %value.i, align 8
  %cond52.i61 = add i64 %i70, -1
  %cmp63.i64 = icmp ugt i64 %lo_reg1.sroa.7.0.copyload, %i70
  %cond68.i65 = select i1 %cmp63.i64, i64 %lo_reg1.sroa.7.0.copyload, i64 %i70
  store i64 %cond68.i65, i64* %umin_value.i16, align 8
  %i124.i67 = load i64, i64* %umax_value10.i21, align 8
  %cmp71.i68 = icmp ult i64 %i124.i67, %cond52.i61
  %cond76.i69 = select i1 %cmp71.i68, i64 %i124.i67, i64 %cond52.i61
  store i64 %cond76.i69, i64* %umax_value10.i21, align 8
  %i.i42.i71 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i72 = icmp sgt i64 %i.i42.i71, -1
  br i1 %cmp.i43.i72, label %if.then.i.i88, label %lor.lhs.false.i.i77

lor.lhs.false.i.i77:                              ; preds = %cond.end90
  %i33.i.i75 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i76 = icmp slt i64 %i33.i.i75, 0
  br i1 %cmp1.i45.i76, label %if.then.i.i88, label %if.end.i.i94

if.then.i.i88:                                    ; preds = %lor.lhs.false.i.i77, %cond.end90
  %i34.i.i79 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i80 = icmp ugt i64 %i.i42.i71, %i34.i.i79
  %cond.i.i81 = select i1 %cmp3.i.i80, i64 %i.i42.i71, i64 %i34.i.i79
  store i64 %cond.i.i81, i64* %umin_value.i16, align 8
  store i64 %cond.i.i81, i64* %smin_value.i10, align 8
  %i35.i.i83 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i85 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i86 = icmp ult i64 %i35.i.i83, %i36.i.i85
  %cond12.i.i87 = select i1 %cmp8.i48.i86, i64 %i35.i.i83, i64 %i36.i.i85
  store i64 %cond12.i.i87, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i106.sink.split

if.end.i.i94:                                     ; preds = %lor.lhs.false.i.i77
  %i37.i.i90 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i91 = icmp sgt i64 %i37.i.i90, -1
  %i38.i.i93 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i91, label %if.then17.i.i97, label %if.else.i.i99

if.then17.i.i97:                                  ; preds = %if.end.i.i94
  store i64 %i38.i.i93, i64* %smin_value.i10, align 8
  %cmp23.i.i95 = icmp ult i64 %i33.i.i75, %i37.i.i90
  %cond27.i.i96 = select i1 %cmp23.i.i95, i64 %i33.i.i75, i64 %i37.i.i90
  store i64 %cond27.i.i96, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i106.sink.split

if.else.i.i99:                                    ; preds = %if.end.i.i94
  %cmp31.i.i98 = icmp slt i64 %i38.i.i93, 0
  br i1 %cmp31.i.i98, label %if.then32.i.i102, label %__reg_deduce_bounds.exit.i106

if.then32.i.i102:                                 ; preds = %if.else.i.i99
  %cmp36.i.i100 = icmp ugt i64 %i.i42.i71, %i38.i.i93
  %cond40.i.i101 = select i1 %cmp36.i.i100, i64 %i.i42.i71, i64 %i38.i.i93
  store i64 %cond40.i.i101, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i101, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i106.sink.split

__reg_deduce_bounds.exit.i106.sink.split:         ; preds = %if.then32.i.i102, %if.then17.i.i97, %if.then.i.i88
  %i37.i.i90.sink = phi i64 [ %i37.i.i90, %if.then32.i.i102 ], [ %cond27.i.i96, %if.then17.i.i97 ], [ %cond12.i.i87, %if.then.i.i88 ]
  store i64 %i37.i.i90.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i106

__reg_deduce_bounds.exit.i106:                    ; preds = %__reg_deduce_bounds.exit.i106.sink.split, %if.else.i.i99
  %i.i50.i104 = load i64, i64* %smin_value7.i12, align 8
  %cmp.i51.i105 = icmp sgt i64 %i.i50.i104, -1
  br i1 %cmp.i51.i105, label %if.then.i66.i121, label %lor.lhs.false.i55.i110

lor.lhs.false.i55.i110:                           ; preds = %__reg_deduce_bounds.exit.i106
  %i33.i53.i108 = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i54.i109 = icmp slt i64 %i33.i53.i108, 0
  br i1 %cmp1.i54.i109, label %if.then.i66.i121, label %if.end.i72.i127

if.then.i66.i121:                                 ; preds = %lor.lhs.false.i55.i110, %__reg_deduce_bounds.exit.i106
  %i34.i57.i112 = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i58.i113 = icmp ugt i64 %i.i50.i104, %i34.i57.i112
  %cond.i59.i114 = select i1 %cmp3.i58.i113, i64 %i.i50.i104, i64 %i34.i57.i112
  store i64 %cond.i59.i114, i64* %umin_value9.i18, align 8
  store i64 %cond.i59.i114, i64* %smin_value7.i12, align 8
  %i35.i61.i116 = load i64, i64* %smax_value8.i15, align 8
  %i36.i63.i118 = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i64.i119 = icmp ult i64 %i35.i61.i116, %i36.i63.i118
  %cond12.i65.i120 = select i1 %cmp8.i64.i119, i64 %i35.i61.i116, i64 %i36.i63.i118
  store i64 %cond12.i65.i120, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i142.sink.split

if.end.i72.i127:                                  ; preds = %lor.lhs.false.i55.i110
  %i37.i68.i123 = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i69.i124 = icmp sgt i64 %i37.i68.i123, -1
  %i38.i71.i126 = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i69.i124, label %if.then17.i75.i130, label %if.else.i77.i132

if.then17.i75.i130:                               ; preds = %if.end.i72.i127
  store i64 %i38.i71.i126, i64* %smin_value7.i12, align 8
  %cmp23.i73.i128 = icmp ult i64 %i33.i53.i108, %i37.i68.i123
  %cond27.i74.i129 = select i1 %cmp23.i73.i128, i64 %i33.i53.i108, i64 %i37.i68.i123
  store i64 %cond27.i74.i129, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit81.i142.sink.split

if.else.i77.i132:                                 ; preds = %if.end.i72.i127
  %cmp31.i76.i131 = icmp slt i64 %i38.i71.i126, 0
  br i1 %cmp31.i76.i131, label %if.then32.i80.i135, label %__reg_deduce_bounds.exit81.i142

if.then32.i80.i135:                               ; preds = %if.else.i77.i132
  %cmp36.i78.i133 = icmp ugt i64 %i.i50.i104, %i38.i71.i126
  %cond40.i79.i134 = select i1 %cmp36.i78.i133, i64 %i.i50.i104, i64 %i38.i71.i126
  store i64 %cond40.i79.i134, i64* %umin_value9.i18, align 8
  store i64 %cond40.i79.i134, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit81.i142.sink.split

__reg_deduce_bounds.exit81.i142.sink.split:       ; preds = %if.then32.i80.i135, %if.then17.i75.i130, %if.then.i66.i121
  %i37.i68.i123.sink = phi i64 [ %i37.i68.i123, %if.then32.i80.i135 ], [ %cond27.i74.i129, %if.then17.i75.i130 ], [ %cond12.i65.i120, %if.then.i66.i121 ]
  store i64 %i37.i68.i123.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit81.i142

__reg_deduce_bounds.exit81.i142:                  ; preds = %__reg_deduce_bounds.exit81.i142.sink.split, %if.else.i77.i132
  %i.i83.i137 = load i64, i64* %umin_value.i16, align 8
  %i5.i85.i139 = load i64, i64* %umax_value.i19, align 8
  %xor.i.i.i140 = xor i64 %i5.i85.i139, %i.i83.i137
  %cmp.i.i.i.i141 = icmp eq i64 %xor.i.i.i140, 0
  br i1 %cmp.i.i.i.i141, label %__reg_bound_offset.exit.i200, label %if.end.i.i.i.i172

if.end.i.i.i.i172:                                ; preds = %__reg_deduce_bounds.exit81.i142
  %tobool.not.i.i.i.i.i143 = icmp ult i64 %xor.i.i.i140, 4294967296
  %shl.i.i.i.i.i144 = shl i64 %xor.i.i.i140, 32
  %spec.select.i.i.i.i.i145 = select i1 %tobool.not.i.i.i.i.i143, i64 %shl.i.i.i.i.i144, i64 %xor.i.i.i140
  %spec.select17.i.i.i.i.i146 = select i1 %tobool.not.i.i.i.i.i143, i32 31, i32 63
  %tobool2.not.i.i.i.i.i147 = icmp ult i64 %spec.select.i.i.i.i.i145, 281474976710656
  %sub4.i.i.i.i.i148 = add nsw i32 %spec.select17.i.i.i.i.i146, -16
  %shl5.i.i.i.i.i149 = shl i64 %spec.select.i.i.i.i.i145, 16
  %word.addr.1.i.i.i.i.i150 = select i1 %tobool2.not.i.i.i.i.i147, i64 %shl5.i.i.i.i.i149, i64 %spec.select.i.i.i.i.i145
  %num.1.i.i.i.i.i151 = select i1 %tobool2.not.i.i.i.i.i147, i32 %sub4.i.i.i.i.i148, i32 %spec.select17.i.i.i.i.i146
  %tobool8.not.i.i.i.i.i152 = icmp ult i64 %word.addr.1.i.i.i.i.i150, 72057594037927936
  %sub10.i.i.i.i.i153 = add nsw i32 %num.1.i.i.i.i.i151, -8
  %shl11.i.i.i.i.i154 = shl i64 %word.addr.1.i.i.i.i.i150, 8
  %word.addr.2.i.i.i.i.i155 = select i1 %tobool8.not.i.i.i.i.i152, i64 %shl11.i.i.i.i.i154, i64 %word.addr.1.i.i.i.i.i150
  %num.2.i.i.i.i.i156 = select i1 %tobool8.not.i.i.i.i.i152, i32 %sub10.i.i.i.i.i153, i32 %num.1.i.i.i.i.i151
  %tobool14.not.i.i.i.i.i157 = icmp ult i64 %word.addr.2.i.i.i.i.i155, 1152921504606846976
  %sub16.i.i.i.i.i158 = add nsw i32 %num.2.i.i.i.i.i156, -4
  %shl17.i.i.i.i.i159 = shl i64 %word.addr.2.i.i.i.i.i155, 4
  %word.addr.3.i.i.i.i.i160 = select i1 %tobool14.not.i.i.i.i.i157, i64 %shl17.i.i.i.i.i159, i64 %word.addr.2.i.i.i.i.i155
  %num.3.i.i.i.i.i161 = select i1 %tobool14.not.i.i.i.i.i157, i32 %sub16.i.i.i.i.i158, i32 %num.2.i.i.i.i.i156
  %tobool20.not.i.i.i.i.i162 = icmp ult i64 %word.addr.3.i.i.i.i.i160, 4611686018427387904
  %sub22.i.i.i.i.i163 = add i32 %num.3.i.i.i.i.i161, 254
  %shl23.i.i.i.i.i164 = shl i64 %word.addr.3.i.i.i.i.i160, 2
  %word.addr.4.i.i.i.i.i165 = select i1 %tobool20.not.i.i.i.i.i162, i64 %shl23.i.i.i.i.i164, i64 %word.addr.3.i.i.i.i.i160
  %num.4.i.i.i.i.i166 = select i1 %tobool20.not.i.i.i.i.i162, i32 %sub22.i.i.i.i.i163, i32 %num.3.i.i.i.i.i161
  %word.addr.4.lobit.i.i.i.i.i167.neg = lshr i64 %word.addr.4.i.i.i.i.i165, 63
  %i.i.i.i.i.i168.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i167.neg to i32
  %add.i.i.i.i171 = add i32 %num.4.i.i.i.i.i166, %i.i.i.i.i.i168.neg
  %phi.bo = and i32 %add.i.i.i.i171, 255
  br label %__reg_bound_offset.exit.i200

__reg_bound_offset.exit.i200:                     ; preds = %if.end.i.i.i.i172, %__reg_deduce_bounds.exit81.i142
  %retval.0.i.i.i.i173 = phi i32 [ %phi.bo, %if.end.i.i.i.i172 ], [ 0, %__reg_deduce_bounds.exit81.i142 ]
  %cmp.i.i.i175 = icmp ugt i32 %retval.0.i.i.i.i173, 63
  %sh_prom.i.i.i176 = zext i32 %retval.0.i.i.i.i173 to i64
  %notmask.i.i.i177 = shl nsw i64 -1, %sh_prom.i.i.i176
  %sub.i.i.i178 = xor i64 %notmask.i.i.i177, -1
  %and.i.i.i179 = and i64 %notmask.i.i.i177, %i.i83.i137
  %retval.sroa.0.0.i.i.i180 = select i1 %cmp.i.i.i175, i64 0, i64 %and.i.i.i179
  %retval.sroa.3.0.i.i.i181 = select i1 %cmp.i.i.i175, i64 -1, i64 %sub.i.i.i178
  %i9.i.i185 = load i64, i64* %value.i4, align 8
  %i11.i.i187 = load i64, i64* %mask.i7, align 8
  %or.i.i.i188 = or i64 %retval.sroa.0.0.i.i.i180, %i9.i.i185
  %and.i1.i.i189 = and i64 %retval.sroa.3.0.i.i.i181, %i11.i.i187
  %neg.i.i.i190 = xor i64 %and.i1.i.i189, -1
  %and4.i.i.i191 = and i64 %or.i.i.i188, %neg.i.i.i190
  store i64 %and4.i.i.i191, i64* %value.i4, align 8
  store i64 %and.i1.i.i189, i64* %mask.i7, align 8
  %i.i90.i195 = load i64, i64* %umin_value9.i18, align 8
  %i5.i92.i197 = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i93.i198 = xor i64 %i5.i92.i197, %i.i90.i195
  %cmp.i.i.i94.i199 = icmp eq i64 %xor.i.i93.i198, 0
  br i1 %cmp.i.i.i94.i199, label %reg_set_min_max_inv.exit, label %if.end.i.i.i124.i230

if.end.i.i.i124.i230:                             ; preds = %__reg_bound_offset.exit.i200
  %tobool.not.i.i.i.i95.i201 = icmp ult i64 %xor.i.i93.i198, 4294967296
  %shl.i.i.i.i96.i202 = shl i64 %xor.i.i93.i198, 32
  %spec.select.i.i.i.i97.i203 = select i1 %tobool.not.i.i.i.i95.i201, i64 %shl.i.i.i.i96.i202, i64 %xor.i.i93.i198
  %spec.select17.i.i.i.i98.i204 = select i1 %tobool.not.i.i.i.i95.i201, i32 31, i32 63
  %tobool2.not.i.i.i.i99.i205 = icmp ult i64 %spec.select.i.i.i.i97.i203, 281474976710656
  %sub4.i.i.i.i100.i206 = add nsw i32 %spec.select17.i.i.i.i98.i204, -16
  %shl5.i.i.i.i101.i207 = shl i64 %spec.select.i.i.i.i97.i203, 16
  %word.addr.1.i.i.i.i102.i208 = select i1 %tobool2.not.i.i.i.i99.i205, i64 %shl5.i.i.i.i101.i207, i64 %spec.select.i.i.i.i97.i203
  %num.1.i.i.i.i103.i209 = select i1 %tobool2.not.i.i.i.i99.i205, i32 %sub4.i.i.i.i100.i206, i32 %spec.select17.i.i.i.i98.i204
  %tobool8.not.i.i.i.i104.i210 = icmp ult i64 %word.addr.1.i.i.i.i102.i208, 72057594037927936
  %sub10.i.i.i.i105.i211 = add nsw i32 %num.1.i.i.i.i103.i209, -8
  %shl11.i.i.i.i106.i212 = shl i64 %word.addr.1.i.i.i.i102.i208, 8
  %word.addr.2.i.i.i.i107.i213 = select i1 %tobool8.not.i.i.i.i104.i210, i64 %shl11.i.i.i.i106.i212, i64 %word.addr.1.i.i.i.i102.i208
  %num.2.i.i.i.i108.i214 = select i1 %tobool8.not.i.i.i.i104.i210, i32 %sub10.i.i.i.i105.i211, i32 %num.1.i.i.i.i103.i209
  %tobool14.not.i.i.i.i109.i215 = icmp ult i64 %word.addr.2.i.i.i.i107.i213, 1152921504606846976
  %sub16.i.i.i.i110.i216 = add nsw i32 %num.2.i.i.i.i108.i214, -4
  %shl17.i.i.i.i111.i217 = shl i64 %word.addr.2.i.i.i.i107.i213, 4
  %word.addr.3.i.i.i.i112.i218 = select i1 %tobool14.not.i.i.i.i109.i215, i64 %shl17.i.i.i.i111.i217, i64 %word.addr.2.i.i.i.i107.i213
  %num.3.i.i.i.i113.i219 = select i1 %tobool14.not.i.i.i.i109.i215, i32 %sub16.i.i.i.i110.i216, i32 %num.2.i.i.i.i108.i214
  %tobool20.not.i.i.i.i114.i220 = icmp ult i64 %word.addr.3.i.i.i.i112.i218, 4611686018427387904
  %sub22.i.i.i.i115.i221 = add i32 %num.3.i.i.i.i113.i219, 254
  %shl23.i.i.i.i116.i222 = shl i64 %word.addr.3.i.i.i.i112.i218, 2
  %word.addr.4.i.i.i.i117.i223 = select i1 %tobool20.not.i.i.i.i114.i220, i64 %shl23.i.i.i.i116.i222, i64 %word.addr.3.i.i.i.i112.i218
  %num.4.i.i.i.i118.i224 = select i1 %tobool20.not.i.i.i.i114.i220, i32 %sub22.i.i.i.i115.i221, i32 %num.3.i.i.i.i113.i219
  %word.addr.4.lobit.i.i.i.i119.i225.neg = lshr i64 %word.addr.4.i.i.i.i117.i223, 63
  %i.i.i.i.i120.i226.neg = trunc i64 %word.addr.4.lobit.i.i.i.i119.i225.neg to i32
  %add.i.i.i123.i229 = add i32 %num.4.i.i.i.i118.i224, %i.i.i.i.i120.i226.neg
  %phi.bo13 = and i32 %add.i.i.i123.i229, 255
  br label %reg_set_min_max_inv.exit

reg_set_min_max_inv.exit:                         ; preds = %if.end.i.i.i124.i230, %__reg_bound_offset.exit.i200
  %retval.0.i.i.i125.i231 = phi i32 [ %phi.bo13, %if.end.i.i.i124.i230 ], [ 0, %__reg_bound_offset.exit.i200 ]
  %cmp.i.i127.i233 = icmp ugt i32 %retval.0.i.i.i125.i231, 63
  %sh_prom.i.i128.i234 = zext i32 %retval.0.i.i.i125.i231 to i64
  %notmask.i.i129.i235 = shl nsw i64 -1, %sh_prom.i.i128.i234
  %sub.i.i130.i236 = xor i64 %notmask.i.i129.i235, -1
  %and.i.i131.i237 = and i64 %notmask.i.i129.i235, %i.i90.i195
  %retval.sroa.0.0.i.i132.i238 = select i1 %cmp.i.i127.i233, i64 0, i64 %and.i.i131.i237
  %retval.sroa.3.0.i.i133.i239 = select i1 %cmp.i.i127.i233, i64 -1, i64 %sub.i.i130.i236
  %i9.i137.i243 = load i64, i64* %value3.i6, align 8
  %i11.i139.i245 = load i64, i64* %mask6.i9, align 8
  %or.i.i140.i246 = or i64 %retval.sroa.0.0.i.i132.i238, %i9.i137.i243
  %and.i1.i141.i247 = and i64 %retval.sroa.3.0.i.i133.i239, %i11.i139.i245
  %neg.i.i142.i248 = xor i64 %and.i1.i141.i247, -1
  %and4.i.i143.i249 = and i64 %or.i.i140.i246, %neg.i.i142.i248
  store i64 %and4.i.i143.i249, i64* %value3.i6, align 8
  store i64 %and.i1.i141.i247, i64* %mask6.i9, align 8
  %i.i148.i253 = load i64, i64* %smin_value.i10, align 8
  %i23.i.i255 = load i64, i64* %value.i4, align 8
  %i24.i.i257 = load i64, i64* %mask.i7, align 8
  %and.i149.i258 = and i64 %i24.i.i257, -9223372036854775808
  %or.i150.i259 = or i64 %and.i149.i258, %i23.i.i255
  %cmp.i151.i260 = icmp sgt i64 %i.i148.i253, %or.i150.i259
  %cond.i152.i261 = select i1 %cmp.i151.i260, i64 %i.i148.i253, i64 %or.i150.i259
  store i64 %cond.i152.i261, i64* %smin_value.i10, align 8
  %i25.i.i263 = load i64, i64* %smax_value.i13, align 8
  %and7.i.i264 = and i64 %i24.i.i257, 9223372036854775807
  %or8.i.i265 = or i64 %and7.i.i264, %i23.i.i255
  %cmp10.i.i266 = icmp slt i64 %i25.i.i263, %or8.i.i265
  %cond14.i.i267 = select i1 %cmp10.i.i266, i64 %i25.i.i263, i64 %or8.i.i265
  store i64 %cond14.i.i267, i64* %smax_value.i13, align 8
  %i26.i.i269 = load i64, i64* %umin_value.i16, align 8
  %cmp19.i.i270 = icmp ugt i64 %i26.i.i269, %i23.i.i255
  %cond23.i.i271 = select i1 %cmp19.i.i270, i64 %i26.i.i269, i64 %i23.i.i255
  store i64 %cond23.i.i271, i64* %umin_value.i16, align 8
  %i27.i.i273 = load i64, i64* %umax_value.i19, align 8
  %or29.i.i274 = or i64 %i24.i.i257, %i23.i.i255
  %cmp31.i156.i275 = icmp ult i64 %i27.i.i273, %or29.i.i274
  %cond35.i.i276 = select i1 %cmp31.i156.i275, i64 %i27.i.i273, i64 %or29.i.i274
  store i64 %cond35.i.i276, i64* %umax_value.i19, align 8
  %i.i158.i278 = load i64, i64* %smin_value7.i12, align 8
  %i23.i160.i280 = load i64, i64* %value3.i6, align 8
  %i24.i162.i282 = load i64, i64* %mask6.i9, align 8
  %and.i163.i283 = and i64 %i24.i162.i282, -9223372036854775808
  %or.i164.i284 = or i64 %and.i163.i283, %i23.i160.i280
  %cmp.i165.i285 = icmp sgt i64 %i.i158.i278, %or.i164.i284
  %cond.i166.i286 = select i1 %cmp.i165.i285, i64 %i.i158.i278, i64 %or.i164.i284
  store i64 %cond.i166.i286, i64* %smin_value7.i12, align 8
  %i25.i168.i288 = load i64, i64* %smax_value8.i15, align 8
  %and7.i169.i289 = and i64 %i24.i162.i282, 9223372036854775807
  %or8.i170.i290 = or i64 %and7.i169.i289, %i23.i160.i280
  %cmp10.i171.i291 = icmp slt i64 %i25.i168.i288, %or8.i170.i290
  %cond14.i172.i292 = select i1 %cmp10.i171.i291, i64 %i25.i168.i288, i64 %or8.i170.i290
  store i64 %cond14.i172.i292, i64* %smax_value8.i15, align 8
  %i26.i174.i294 = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i175.i295 = icmp ugt i64 %i26.i174.i294, %i23.i160.i280
  %cond23.i176.i296 = select i1 %cmp19.i175.i295, i64 %i26.i174.i294, i64 %i23.i160.i280
  store i64 %cond23.i176.i296, i64* %umin_value9.i18, align 8
  %i27.i178.i298 = load i64, i64* %umax_value10.i21, align 8
  %or29.i179.i299 = or i64 %i24.i162.i282, %i23.i160.i280
  %cmp31.i180.i300 = icmp ult i64 %i27.i178.i298, %or29.i179.i299
  %cond35.i181.i301 = select i1 %cmp31.i180.i300, i64 %i27.i178.i298, i64 %or29.i179.i299
  store i64 %cond35.i181.i301, i64* %umax_value10.i21, align 8
  br label %if.end117
