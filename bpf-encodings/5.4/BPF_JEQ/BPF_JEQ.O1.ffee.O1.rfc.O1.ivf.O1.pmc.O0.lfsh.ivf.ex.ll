; ModuleID = '/home/pchaigno/agni/bpf-encodings/5.4/BPF_JEQ/BPF_JEQ.O1.ffee.O1.rfc.O1.ivf.O1.pmc.O0.lfsh.ivf.ll'
...
define dso_local void @check_cond_jmp_op_wrapper_BPF_JEQ(%struct.bpf_reg_state* nocapture noundef %dst_reg, %struct.bpf_reg_state* nocapture noundef %src_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_dst_reg, %struct.bpf_reg_state* nocapture noundef %other_branch_src_reg) local_unnamed_addr #0 {
entry:
...
if.then25:                                        ; preds = %land.lhs.true
  %i66.i = load i64, i64* %mask.i, align 8
  %tobool.not.i.i = icmp eq i64 %i66.i, 0
  br i1 %tobool.not.i.i, label %if.then19.i, label %is_branch_taken.exit

if.then19.i:                                      ; preds = %if.then25
  %i58 = load i64, i64* %value.i4, align 8
  %i68.i = load i64, i64* %value.i, align 8
  %cmp.i1.i = icmp eq i64 %i68.i, %i58
  %lnot.ext.i = zext i1 %cmp.i1.i to i32
  br label %is_branch_taken.exit

is_branch_taken.exit:                             ; preds = %if.then19.i, %if.then25
  %retval.0.i = phi i32 [ %lnot.ext.i, %if.then19.i ], [ -1, %if.then25 ]
...
cond.end:                                         ; preds = %if.then52
  ...
  store i64 %i67, i64* %value3.i, align 8
  store i64 0, i64* %mask6.i, align 8
  store i64 %i67, i64* %smin_value7.i, align 8
  store i64 %i67, i64* %smax_value8.i, align 8
  store i64 %i67, i64* %umin_value9.i, align 8
  store i64 %i67, i64* %umax_value10.i, align 8
...
cond.end90:                                       ; preds = %if.else70
  ...
  store i64 %i70, i64* %value3.i6, align 8
  store i64 0, i64* %mask6.i9, align 8
  store i64 %i70, i64* %smin_value7.i12, align 8
  store i64 %i70, i64* %smax_value8.i15, align 8
  store i64 %i70, i64* %umin_value9.i18, align 8
  store i64 %i70, i64* %umax_value10.i21, align 8
  %i.i42.i69 = load i64, i64* %smin_value.i10, align 8
  %cmp.i43.i70 = icmp sgt i64 %i.i42.i69, -1
  br i1 %cmp.i43.i70, label %if.then.i.i86, label %lor.lhs.false.i.i75

lor.lhs.false.i.i75:                              ; preds = %cond.end90
  %i33.i.i73 = load i64, i64* %smax_value.i13, align 8
  %cmp1.i45.i74 = icmp slt i64 %i33.i.i73, 0
  br i1 %cmp1.i45.i74, label %if.then.i.i86, label %if.end.i.i92

if.then.i.i86:                                    ; preds = %lor.lhs.false.i.i75, %cond.end90
  %i34.i.i77 = load i64, i64* %umin_value.i16, align 8
  %cmp3.i.i78 = icmp ugt i64 %i.i42.i69, %i34.i.i77
  %cond.i.i79 = select i1 %cmp3.i.i78, i64 %i.i42.i69, i64 %i34.i.i77
  store i64 %cond.i.i79, i64* %umin_value.i16, align 8
  store i64 %cond.i.i79, i64* %smin_value.i10, align 8
  %i35.i.i81 = load i64, i64* %smax_value.i13, align 8
  %i36.i.i83 = load i64, i64* %umax_value.i19, align 8
  %cmp8.i48.i84 = icmp ult i64 %i35.i.i81, %i36.i.i83
  %cond12.i.i85 = select i1 %cmp8.i48.i84, i64 %i35.i.i81, i64 %i36.i.i83
  store i64 %cond12.i.i85, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i104.sink.split

if.end.i.i92:                                     ; preds = %lor.lhs.false.i.i75
  %i37.i.i88 = load i64, i64* %umax_value.i19, align 8
  %cmp16.i.i89 = icmp sgt i64 %i37.i.i88, -1
  %i38.i.i91 = load i64, i64* %umin_value.i16, align 8
  br i1 %cmp16.i.i89, label %if.then17.i.i95, label %if.else.i.i97

if.then17.i.i95:                                  ; preds = %if.end.i.i92
  store i64 %i38.i.i91, i64* %smin_value.i10, align 8
  %cmp23.i.i93 = icmp ult i64 %i33.i.i73, %i37.i.i88
  %cond27.i.i94 = select i1 %cmp23.i.i93, i64 %i33.i.i73, i64 %i37.i.i88
  store i64 %cond27.i.i94, i64* %umax_value.i19, align 8
  br label %__reg_deduce_bounds.exit.i104.sink.split

if.else.i.i97:                                    ; preds = %if.end.i.i92
  %cmp31.i.i96 = icmp slt i64 %i38.i.i91, 0
  br i1 %cmp31.i.i96, label %if.then32.i.i100, label %__reg_deduce_bounds.exit.i104

if.then32.i.i100:                                 ; preds = %if.else.i.i97
  %cmp36.i.i98 = icmp ugt i64 %i.i42.i69, %i38.i.i91
  %cond40.i.i99 = select i1 %cmp36.i.i98, i64 %i.i42.i69, i64 %i38.i.i91
  store i64 %cond40.i.i99, i64* %umin_value.i16, align 8
  store i64 %cond40.i.i99, i64* %smin_value.i10, align 8
  br label %__reg_deduce_bounds.exit.i104.sink.split

__reg_deduce_bounds.exit.i104.sink.split:         ; preds = %if.then32.i.i100, %if.then17.i.i95, %if.then.i.i86
  %i37.i.i88.sink = phi i64 [ %i37.i.i88, %if.then32.i.i100 ], [ %cond27.i.i94, %if.then17.i.i95 ], [ %cond12.i.i85, %if.then.i.i86 ]
  store i64 %i37.i.i88.sink, i64* %smax_value.i13, align 8
  br label %__reg_deduce_bounds.exit.i104

__reg_deduce_bounds.exit.i104:                    ; preds = %__reg_deduce_bounds.exit.i104.sink.split, %if.else.i.i97
...
lor.lhs.false.i55.i108:                           ; preds = %__reg_deduce_bounds.exit.i104
...
if.then.i66.i119:                                 ; preds = %lor.lhs.false.i55.i108, %__reg_deduce_bounds.exit.i104
...
if.then103:                                       ; preds = %if.else70
  %i36.i.i301 = load i64, i64* %umin_value9.i, align 8
  %cmp.i.i = icmp ugt i64 %i17.i17, %i36.i.i301
  %cond.i.i302 = select i1 %cmp.i.i, i64 %i17.i17, i64 %i36.i.i301
  store i64 %cond.i.i302, i64* %umin_value9.i, align 8
  store i64 %cond.i.i302, i64* %umin_value9.i18, align 8
  %i37.i.i304 = load i64, i64* %umax_value10.i21, align 8
  %i38.i.i305 = load i64, i64* %umax_value10.i, align 8
  %cmp6.i.i = icmp ult i64 %i37.i.i304, %i38.i.i305
  %cond10.i.i = select i1 %cmp6.i.i, i64 %i37.i.i304, i64 %i38.i.i305
  store i64 %cond10.i.i, i64* %umax_value10.i, align 8
  store i64 %cond10.i.i, i64* %umax_value10.i21, align 8
  %i39.i.i = load i64, i64* %smin_value7.i12, align 8
  %i40.i.i = load i64, i64* %smin_value7.i, align 8
  %cmp15.i.i = icmp sgt i64 %i39.i.i, %i40.i.i
  %cond19.i.i = select i1 %cmp15.i.i, i64 %i39.i.i, i64 %i40.i.i
  store i64 %cond19.i.i, i64* %smin_value7.i, align 8
  store i64 %cond19.i.i, i64* %smin_value7.i12, align 8
  %i41.i.i = load i64, i64* %smax_value8.i15, align 8
  %i42.i.i = load i64, i64* %smax_value8.i, align 8
  %cmp24.i.i = icmp slt i64 %i41.i.i, %i42.i.i
  %cond28.i.i = select i1 %cmp24.i.i, i64 %i41.i.i, i64 %i42.i.i
  store i64 %cond28.i.i, i64* %smax_value8.i, align 8
  store i64 %cond28.i.i, i64* %smax_value8.i15, align 8
  %var_off.i.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %other_branch_src_reg, i64 0, i32 5
  %var_off31.i.i = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %other_branch_dst_reg, i64 0, i32 5
  %i43.i.i = getelementptr %struct.tnum, %struct.tnum* %var_off.i.i, i64 0, i32 0
  %i44.i.i = load i64, i64* %i43.i.i, align 8
  %i46.i.i = load i64, i64* %mask6.i9, align 8
  %i47.i.i = getelementptr %struct.tnum, %struct.tnum* %var_off31.i.i, i64 0, i32 0
  %i48.i.i = load i64, i64* %i47.i.i, align 8
  %i50.i.i = load i64, i64* %mask6.i, align 8
  %or.i.i.i308 = or i64 %i48.i.i, %i44.i.i
  %and.i.i.i309 = and i64 %i50.i.i, %i46.i.i
  %neg.i.i.i310 = xor i64 %and.i.i.i309, -1
  %and4.i.i.i311 = and i64 %or.i.i.i308, %neg.i.i.i310
  store i64 %and4.i.i.i311, i64* %value3.i, align 8
  store i64 %and.i.i.i309, i64* %mask6.i, align 8
  %var_off31.i.i.pmcpy.elt = getelementptr inbounds %struct.tnum, %struct.tnum* %var_off31.i.i, i64 0, i32 0
  %var_off31.i.i.pmcpy.unpack = load i64, i64* %var_off31.i.i.pmcpy.elt, align 8
  %var_off.i.i.repack = getelementptr inbounds %struct.tnum, %struct.tnum* %var_off.i.i, i64 0, i32 0
  store i64 %var_off31.i.i.pmcpy.unpack, i64* %var_off.i.i.repack, align 8
  %var_off.i.i.repack4 = getelementptr inbounds %struct.bpf_reg_state, %struct.bpf_reg_state* %other_branch_src_reg, i64 0, i32 5, i32 1
  store i64 %and.i.i.i309, i64* %var_off.i.i.repack4, align 8
  %i.i.i.i = load i64, i64* %smin_value7.i12, align 8
  %i23.i.i.i = load i64, i64* %value3.i6, align 8
  %and.i1.i.i314 = and i64 %and.i.i.i309, -9223372036854775808
  %or.i2.i.i = or i64 %and.i1.i.i314, %i23.i.i.i
  %cmp.i.i.i315 = icmp sgt i64 %i.i.i.i, %or.i2.i.i
  %cond.i.i.i = select i1 %cmp.i.i.i315, i64 %i.i.i.i, i64 %or.i2.i.i
  store i64 %cond.i.i.i, i64* %smin_value7.i12, align 8
  %i25.i.i.i = load i64, i64* %smax_value8.i15, align 8
  %and7.i.i.i = and i64 %and.i.i.i309, 9223372036854775807
  %or8.i.i.i = or i64 %and7.i.i.i, %i23.i.i.i
  %cmp10.i.i.i = icmp slt i64 %i25.i.i.i, %or8.i.i.i
  %cond14.i.i.i = select i1 %cmp10.i.i.i, i64 %i25.i.i.i, i64 %or8.i.i.i
  store i64 %cond14.i.i.i, i64* %smax_value8.i15, align 8
  %i26.i.i.i = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i.i.i = icmp ugt i64 %i26.i.i.i, %i23.i.i.i
  %cond23.i.i.i = select i1 %cmp19.i.i.i, i64 %i26.i.i.i, i64 %i23.i.i.i
  store i64 %cond23.i.i.i, i64* %umin_value9.i18, align 8
  %i27.i.i.i = load i64, i64* %umax_value10.i21, align 8
  %or29.i.i.i = or i64 %and.i.i.i309, %i23.i.i.i
  %cmp31.i.i.i = icmp ult i64 %i27.i.i.i, %or29.i.i.i
  %cond35.i.i.i = select i1 %cmp31.i.i.i, i64 %i27.i.i.i, i64 %or29.i.i.i
  store i64 %cond35.i.i.i, i64* %umax_value10.i21, align 8
  %i.i4.i.i = load i64, i64* %smin_value7.i, align 8
  %i23.i6.i.i = load i64, i64* %value3.i, align 8
  %i24.i8.i.i = load i64, i64* %mask6.i, align 8
  %and.i9.i.i = and i64 %i24.i8.i.i, -9223372036854775808
  %or.i10.i.i = or i64 %and.i9.i.i, %i23.i6.i.i
  %cmp.i11.i.i = icmp sgt i64 %i.i4.i.i, %or.i10.i.i
  %cond.i12.i.i = select i1 %cmp.i11.i.i, i64 %i.i4.i.i, i64 %or.i10.i.i
  store i64 %cond.i12.i.i, i64* %smin_value7.i, align 8
  %i25.i14.i.i = load i64, i64* %smax_value8.i, align 8
  %and7.i15.i.i = and i64 %i24.i8.i.i, 9223372036854775807
  %or8.i16.i.i = or i64 %and7.i15.i.i, %i23.i6.i.i
  %cmp10.i17.i.i = icmp slt i64 %i25.i14.i.i, %or8.i16.i.i
  %cond14.i18.i.i = select i1 %cmp10.i17.i.i, i64 %i25.i14.i.i, i64 %or8.i16.i.i
  store i64 %cond14.i18.i.i, i64* %smax_value8.i, align 8
  %i26.i20.i.i = load i64, i64* %umin_value9.i, align 8
  %cmp19.i21.i.i = icmp ugt i64 %i26.i20.i.i, %i23.i6.i.i
  %cond23.i22.i.i = select i1 %cmp19.i21.i.i, i64 %i26.i20.i.i, i64 %i23.i6.i.i
  store i64 %cond23.i22.i.i, i64* %umin_value9.i, align 8
  %i27.i24.i.i = load i64, i64* %umax_value10.i, align 8
  %or29.i25.i.i = or i64 %i24.i8.i.i, %i23.i6.i.i
  %cmp31.i26.i.i = icmp ult i64 %i27.i24.i.i, %or29.i25.i.i
  %cond35.i27.i.i = select i1 %cmp31.i26.i.i, i64 %i27.i24.i.i, i64 %or29.i25.i.i
  store i64 %cond35.i27.i.i, i64* %umax_value10.i, align 8
  %i.i29.i.i = load i64, i64* %smin_value7.i12, align 8
  %cmp.i30.i.i = icmp sgt i64 %i.i29.i.i, -1
  br i1 %cmp.i30.i.i, label %if.then.i.i.i, label %lor.lhs.false.i.i.i

lor.lhs.false.i.i.i:                              ; preds = %if.then103
  %i33.i.i.i = load i64, i64* %smax_value8.i15, align 8
  %cmp1.i.i.i = icmp slt i64 %i33.i.i.i, 0
  br i1 %cmp1.i.i.i, label %if.then.i.i.i, label %if.end.i.i.i

if.then.i.i.i:                                    ; preds = %lor.lhs.false.i.i.i, %if.then103
  %i34.i.i.i = load i64, i64* %umin_value9.i18, align 8
  %cmp3.i.i.i = icmp ugt i64 %i.i29.i.i, %i34.i.i.i
  %cond.i33.i.i = select i1 %cmp3.i.i.i, i64 %i.i29.i.i, i64 %i34.i.i.i
  store i64 %cond.i33.i.i, i64* %umin_value9.i18, align 8
  store i64 %cond.i33.i.i, i64* %smin_value7.i12, align 8
  %i35.i.i.i = load i64, i64* %smax_value8.i15, align 8
  %i36.i.i.i = load i64, i64* %umax_value10.i21, align 8
  %cmp8.i.i.i = icmp ult i64 %i35.i.i.i, %i36.i.i.i
  %cond12.i.i.i = select i1 %cmp8.i.i.i, i64 %i35.i.i.i, i64 %i36.i.i.i
  store i64 %cond12.i.i.i, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit.i.i.sink.split

if.end.i.i.i:                                     ; preds = %lor.lhs.false.i.i.i
  %i37.i.i.i = load i64, i64* %umax_value10.i21, align 8
  %cmp16.i.i.i = icmp sgt i64 %i37.i.i.i, -1
  %i38.i.i.i = load i64, i64* %umin_value9.i18, align 8
  br i1 %cmp16.i.i.i, label %if.then17.i.i.i, label %if.else.i.i.i

if.then17.i.i.i:                                  ; preds = %if.end.i.i.i
  store i64 %i38.i.i.i, i64* %smin_value7.i12, align 8
  %cmp23.i.i.i = icmp ult i64 %i33.i.i.i, %i37.i.i.i
  %cond27.i.i.i = select i1 %cmp23.i.i.i, i64 %i33.i.i.i, i64 %i37.i.i.i
  store i64 %cond27.i.i.i, i64* %umax_value10.i21, align 8
  br label %__reg_deduce_bounds.exit.i.i.sink.split

if.else.i.i.i:                                    ; preds = %if.end.i.i.i
  %cmp31.i35.i.i = icmp slt i64 %i38.i.i.i, 0
  br i1 %cmp31.i35.i.i, label %if.then32.i.i.i, label %__reg_deduce_bounds.exit.i.i

if.then32.i.i.i:                                  ; preds = %if.else.i.i.i
  %cmp36.i.i.i = icmp ugt i64 %i.i29.i.i, %i38.i.i.i
  %cond40.i.i.i = select i1 %cmp36.i.i.i, i64 %i.i29.i.i, i64 %i38.i.i.i
  store i64 %cond40.i.i.i, i64* %umin_value9.i18, align 8
  store i64 %cond40.i.i.i, i64* %smin_value7.i12, align 8
  br label %__reg_deduce_bounds.exit.i.i.sink.split

__reg_deduce_bounds.exit.i.i.sink.split:          ; preds = %if.then32.i.i.i, %if.then17.i.i.i, %if.then.i.i.i
  %i37.i.i.i.sink = phi i64 [ %i37.i.i.i, %if.then32.i.i.i ], [ %cond27.i.i.i, %if.then17.i.i.i ], [ %cond12.i.i.i, %if.then.i.i.i ]
  store i64 %i37.i.i.i.sink, i64* %smax_value8.i15, align 8
  br label %__reg_deduce_bounds.exit.i.i

__reg_deduce_bounds.exit.i.i:                     ; preds = %__reg_deduce_bounds.exit.i.i.sink.split, %if.else.i.i.i
  %i.i37.i.i = load i64, i64* %smin_value7.i, align 8
  %cmp.i38.i.i = icmp sgt i64 %i.i37.i.i, -1
  br i1 %cmp.i38.i.i, label %if.then.i53.i.i, label %lor.lhs.false.i42.i.i

lor.lhs.false.i42.i.i:                            ; preds = %__reg_deduce_bounds.exit.i.i
  %i33.i40.i.i = load i64, i64* %smax_value8.i, align 8
  %cmp1.i41.i.i = icmp slt i64 %i33.i40.i.i, 0
  br i1 %cmp1.i41.i.i, label %if.then.i53.i.i, label %if.end.i59.i.i

if.then.i53.i.i:                                  ; preds = %lor.lhs.false.i42.i.i, %__reg_deduce_bounds.exit.i.i
  %i34.i44.i.i = load i64, i64* %umin_value9.i, align 8
  %cmp3.i45.i.i = icmp ugt i64 %i.i37.i.i, %i34.i44.i.i
  %cond.i46.i.i = select i1 %cmp3.i45.i.i, i64 %i.i37.i.i, i64 %i34.i44.i.i
  store i64 %cond.i46.i.i, i64* %umin_value9.i, align 8
  store i64 %cond.i46.i.i, i64* %smin_value7.i, align 8
  %i35.i48.i.i = load i64, i64* %smax_value8.i, align 8
  %i36.i50.i.i = load i64, i64* %umax_value10.i, align 8
  %cmp8.i51.i.i = icmp ult i64 %i35.i48.i.i, %i36.i50.i.i
  %cond12.i52.i.i = select i1 %cmp8.i51.i.i, i64 %i35.i48.i.i, i64 %i36.i50.i.i
  store i64 %cond12.i52.i.i, i64* %umax_value10.i, align 8
  br label %__reg_deduce_bounds.exit68.i.i.sink.split

if.end.i59.i.i:                                   ; preds = %lor.lhs.false.i42.i.i
  %i37.i55.i.i = load i64, i64* %umax_value10.i, align 8
  %cmp16.i56.i.i = icmp sgt i64 %i37.i55.i.i, -1
  %i38.i58.i.i = load i64, i64* %umin_value9.i, align 8
  br i1 %cmp16.i56.i.i, label %if.then17.i62.i.i, label %if.else.i64.i.i

if.then17.i62.i.i:                                ; preds = %if.end.i59.i.i
  store i64 %i38.i58.i.i, i64* %smin_value7.i, align 8
  %cmp23.i60.i.i = icmp ult i64 %i33.i40.i.i, %i37.i55.i.i
  %cond27.i61.i.i = select i1 %cmp23.i60.i.i, i64 %i33.i40.i.i, i64 %i37.i55.i.i
  store i64 %cond27.i61.i.i, i64* %umax_value10.i, align 8
  br label %__reg_deduce_bounds.exit68.i.i.sink.split

if.else.i64.i.i:                                  ; preds = %if.end.i59.i.i
  %cmp31.i63.i.i = icmp slt i64 %i38.i58.i.i, 0
  br i1 %cmp31.i63.i.i, label %if.then32.i67.i.i, label %__reg_deduce_bounds.exit68.i.i

if.then32.i67.i.i:                                ; preds = %if.else.i64.i.i
  %cmp36.i65.i.i = icmp ugt i64 %i.i37.i.i, %i38.i58.i.i
  %cond40.i66.i.i = select i1 %cmp36.i65.i.i, i64 %i.i37.i.i, i64 %i38.i58.i.i
  store i64 %cond40.i66.i.i, i64* %umin_value9.i, align 8
  store i64 %cond40.i66.i.i, i64* %smin_value7.i, align 8
  br label %__reg_deduce_bounds.exit68.i.i.sink.split

__reg_deduce_bounds.exit68.i.i.sink.split:        ; preds = %if.then32.i67.i.i, %if.then17.i62.i.i, %if.then.i53.i.i
  %i37.i55.i.i.sink = phi i64 [ %i37.i55.i.i, %if.then32.i67.i.i ], [ %cond27.i61.i.i, %if.then17.i62.i.i ], [ %cond12.i52.i.i, %if.then.i53.i.i ]
  store i64 %i37.i55.i.i.sink, i64* %smax_value8.i, align 8
  br label %__reg_deduce_bounds.exit68.i.i

__reg_deduce_bounds.exit68.i.i:                   ; preds = %__reg_deduce_bounds.exit68.i.i.sink.split, %if.else.i64.i.i
  %i.i70.i.i = load i64, i64* %umin_value9.i18, align 8
  %i5.i.i.i = load i64, i64* %umax_value10.i21, align 8
  %xor.i.i.i.i = xor i64 %i5.i.i.i, %i.i70.i.i
  %cmp.i.i.i.i.i = icmp eq i64 %xor.i.i.i.i, 0
  br i1 %cmp.i.i.i.i.i, label %__reg_bound_offset.exit.i.i, label %if.end.i.i.i.i.i

if.end.i.i.i.i.i:                                 ; preds = %__reg_deduce_bounds.exit68.i.i
  %tobool.not.i.i.i.i.i.i = icmp ult i64 %xor.i.i.i.i, 4294967296
  %shl.i.i.i.i.i.i = shl i64 %xor.i.i.i.i, 32
  %spec.select.i.i.i.i.i.i = select i1 %tobool.not.i.i.i.i.i.i, i64 %shl.i.i.i.i.i.i, i64 %xor.i.i.i.i
  %spec.select17.i.i.i.i.i.i = select i1 %tobool.not.i.i.i.i.i.i, i32 31, i32 63
  %tobool2.not.i.i.i.i.i.i = icmp ult i64 %spec.select.i.i.i.i.i.i, 281474976710656
  %sub4.i.i.i.i.i.i = add nsw i32 %spec.select17.i.i.i.i.i.i, -16
  %shl5.i.i.i.i.i.i = shl i64 %spec.select.i.i.i.i.i.i, 16
  %word.addr.1.i.i.i.i.i.i = select i1 %tobool2.not.i.i.i.i.i.i, i64 %shl5.i.i.i.i.i.i, i64 %spec.select.i.i.i.i.i.i
  %num.1.i.i.i.i.i.i = select i1 %tobool2.not.i.i.i.i.i.i, i32 %sub4.i.i.i.i.i.i, i32 %spec.select17.i.i.i.i.i.i
  %tobool8.not.i.i.i.i.i.i = icmp ult i64 %word.addr.1.i.i.i.i.i.i, 72057594037927936
  %sub10.i.i.i.i.i.i = add nsw i32 %num.1.i.i.i.i.i.i, -8
  %shl11.i.i.i.i.i.i = shl i64 %word.addr.1.i.i.i.i.i.i, 8
  %word.addr.2.i.i.i.i.i.i = select i1 %tobool8.not.i.i.i.i.i.i, i64 %shl11.i.i.i.i.i.i, i64 %word.addr.1.i.i.i.i.i.i
  %num.2.i.i.i.i.i.i = select i1 %tobool8.not.i.i.i.i.i.i, i32 %sub10.i.i.i.i.i.i, i32 %num.1.i.i.i.i.i.i
  %tobool14.not.i.i.i.i.i.i = icmp ult i64 %word.addr.2.i.i.i.i.i.i, 1152921504606846976
  %sub16.i.i.i.i.i.i = add nsw i32 %num.2.i.i.i.i.i.i, -4
  %shl17.i.i.i.i.i.i = shl i64 %word.addr.2.i.i.i.i.i.i, 4
  %word.addr.3.i.i.i.i.i.i = select i1 %tobool14.not.i.i.i.i.i.i, i64 %shl17.i.i.i.i.i.i, i64 %word.addr.2.i.i.i.i.i.i
  %num.3.i.i.i.i.i.i = select i1 %tobool14.not.i.i.i.i.i.i, i32 %sub16.i.i.i.i.i.i, i32 %num.2.i.i.i.i.i.i
  %tobool20.not.i.i.i.i.i.i = icmp ult i64 %word.addr.3.i.i.i.i.i.i, 4611686018427387904
  %sub22.i.i.i.i.i.i = add i32 %num.3.i.i.i.i.i.i, 254
  %shl23.i.i.i.i.i.i = shl i64 %word.addr.3.i.i.i.i.i.i, 2
  %word.addr.4.i.i.i.i.i.i = select i1 %tobool20.not.i.i.i.i.i.i, i64 %shl23.i.i.i.i.i.i, i64 %word.addr.3.i.i.i.i.i.i
  %num.4.i.i.i.i.i.i = select i1 %tobool20.not.i.i.i.i.i.i, i32 %sub22.i.i.i.i.i.i, i32 %num.3.i.i.i.i.i.i
  %word.addr.4.lobit.i.i.i.i.i.i.neg = lshr i64 %word.addr.4.i.i.i.i.i.i, 63
  %i.i.i.i.i.i.i.neg = trunc i64 %word.addr.4.lobit.i.i.i.i.i.i.neg to i32
  %add.i.i.i.i.i = add i32 %num.4.i.i.i.i.i.i, %i.i.i.i.i.i.i.neg
  %phi.bo = and i32 %add.i.i.i.i.i, 255
  br label %__reg_bound_offset.exit.i.i

__reg_bound_offset.exit.i.i:                      ; preds = %if.end.i.i.i.i.i, %__reg_deduce_bounds.exit68.i.i
  %retval.0.i.i.i.i.i = phi i32 [ %phi.bo, %if.end.i.i.i.i.i ], [ 0, %__reg_deduce_bounds.exit68.i.i ]
  %cmp.i.i.i.i316 = icmp ugt i32 %retval.0.i.i.i.i.i, 63
  %sh_prom.i.i.i.i = zext i32 %retval.0.i.i.i.i.i to i64
  %notmask.i.i.i.i = shl nsw i64 -1, %sh_prom.i.i.i.i
  %sub.i.i.i.i = xor i64 %notmask.i.i.i.i, -1
  %and.i.i.i.i = and i64 %notmask.i.i.i.i, %i.i70.i.i
  %retval.sroa.0.0.i.i.i.i = select i1 %cmp.i.i.i.i316, i64 0, i64 %and.i.i.i.i
  %retval.sroa.3.0.i.i.i.i = select i1 %cmp.i.i.i.i316, i64 -1, i64 %sub.i.i.i.i
  %i9.i.i.i = load i64, i64* %value3.i6, align 8
  %i11.i.i.i = load i64, i64* %mask6.i9, align 8
  %or.i.i.i.i = or i64 %retval.sroa.0.0.i.i.i.i, %i9.i.i.i
  %and.i1.i.i.i = and i64 %retval.sroa.3.0.i.i.i.i, %i11.i.i.i
  %neg.i.i.i.i = xor i64 %and.i1.i.i.i, -1
  %and4.i.i.i.i = and i64 %or.i.i.i.i, %neg.i.i.i.i
  store i64 %and4.i.i.i.i, i64* %value3.i6, align 8
  store i64 %and.i1.i.i.i, i64* %mask6.i9, align 8
  %i.i73.i.i = load i64, i64* %umin_value9.i, align 8
  %i5.i75.i.i = load i64, i64* %umax_value10.i, align 8
  %xor.i.i76.i.i = xor i64 %i5.i75.i.i, %i.i73.i.i
  %cmp.i.i.i77.i.i = icmp eq i64 %xor.i.i76.i.i, 0
  br i1 %cmp.i.i.i77.i.i, label %reg_combine_min_max.exit, label %if.end.i.i.i107.i.i

if.end.i.i.i107.i.i:                              ; preds = %__reg_bound_offset.exit.i.i
  %tobool.not.i.i.i.i78.i.i = icmp ult i64 %xor.i.i76.i.i, 4294967296
  %shl.i.i.i.i79.i.i = shl i64 %xor.i.i76.i.i, 32
  %spec.select.i.i.i.i80.i.i = select i1 %tobool.not.i.i.i.i78.i.i, i64 %shl.i.i.i.i79.i.i, i64 %xor.i.i76.i.i
  %spec.select17.i.i.i.i81.i.i = select i1 %tobool.not.i.i.i.i78.i.i, i32 31, i32 63
  %tobool2.not.i.i.i.i82.i.i = icmp ult i64 %spec.select.i.i.i.i80.i.i, 281474976710656
  %sub4.i.i.i.i83.i.i = add nsw i32 %spec.select17.i.i.i.i81.i.i, -16
  %shl5.i.i.i.i84.i.i = shl i64 %spec.select.i.i.i.i80.i.i, 16
  %word.addr.1.i.i.i.i85.i.i = select i1 %tobool2.not.i.i.i.i82.i.i, i64 %shl5.i.i.i.i84.i.i, i64 %spec.select.i.i.i.i80.i.i
  %num.1.i.i.i.i86.i.i = select i1 %tobool2.not.i.i.i.i82.i.i, i32 %sub4.i.i.i.i83.i.i, i32 %spec.select17.i.i.i.i81.i.i
  %tobool8.not.i.i.i.i87.i.i = icmp ult i64 %word.addr.1.i.i.i.i85.i.i, 72057594037927936
  %sub10.i.i.i.i88.i.i = add nsw i32 %num.1.i.i.i.i86.i.i, -8
  %shl11.i.i.i.i89.i.i = shl i64 %word.addr.1.i.i.i.i85.i.i, 8
  %word.addr.2.i.i.i.i90.i.i = select i1 %tobool8.not.i.i.i.i87.i.i, i64 %shl11.i.i.i.i89.i.i, i64 %word.addr.1.i.i.i.i85.i.i
  %num.2.i.i.i.i91.i.i = select i1 %tobool8.not.i.i.i.i87.i.i, i32 %sub10.i.i.i.i88.i.i, i32 %num.1.i.i.i.i86.i.i
  %tobool14.not.i.i.i.i92.i.i = icmp ult i64 %word.addr.2.i.i.i.i90.i.i, 1152921504606846976
  %sub16.i.i.i.i93.i.i = add nsw i32 %num.2.i.i.i.i91.i.i, -4
  %shl17.i.i.i.i94.i.i = shl i64 %word.addr.2.i.i.i.i90.i.i, 4
  %word.addr.3.i.i.i.i95.i.i = select i1 %tobool14.not.i.i.i.i92.i.i, i64 %shl17.i.i.i.i94.i.i, i64 %word.addr.2.i.i.i.i90.i.i
  %num.3.i.i.i.i96.i.i = select i1 %tobool14.not.i.i.i.i92.i.i, i32 %sub16.i.i.i.i93.i.i, i32 %num.2.i.i.i.i91.i.i
  %tobool20.not.i.i.i.i97.i.i = icmp ult i64 %word.addr.3.i.i.i.i95.i.i, 4611686018427387904
  %sub22.i.i.i.i98.i.i = add i32 %num.3.i.i.i.i96.i.i, 254
  %shl23.i.i.i.i99.i.i = shl i64 %word.addr.3.i.i.i.i95.i.i, 2
  %word.addr.4.i.i.i.i100.i.i = select i1 %tobool20.not.i.i.i.i97.i.i, i64 %shl23.i.i.i.i99.i.i, i64 %word.addr.3.i.i.i.i95.i.i
  %num.4.i.i.i.i101.i.i = select i1 %tobool20.not.i.i.i.i97.i.i, i32 %sub22.i.i.i.i98.i.i, i32 %num.3.i.i.i.i96.i.i
  %word.addr.4.lobit.i.i.i.i102.i.i.neg = lshr i64 %word.addr.4.i.i.i.i100.i.i, 63
  %i.i.i.i.i103.i.i.neg = trunc i64 %word.addr.4.lobit.i.i.i.i102.i.i.neg to i32
  %add.i.i.i106.i.i = add i32 %num.4.i.i.i.i101.i.i, %i.i.i.i.i103.i.i.neg
  %phi.bo13 = and i32 %add.i.i.i106.i.i, 255
  br label %reg_combine_min_max.exit

reg_combine_min_max.exit:                         ; preds = %if.end.i.i.i107.i.i, %__reg_bound_offset.exit.i.i
  %retval.0.i.i.i108.i.i = phi i32 [ %phi.bo13, %if.end.i.i.i107.i.i ], [ 0, %__reg_bound_offset.exit.i.i ]
  %cmp.i.i110.i.i = icmp ugt i32 %retval.0.i.i.i108.i.i, 63
  %sh_prom.i.i111.i.i = zext i32 %retval.0.i.i.i108.i.i to i64
  %notmask.i.i112.i.i = shl nsw i64 -1, %sh_prom.i.i111.i.i
  %sub.i.i113.i.i = xor i64 %notmask.i.i112.i.i, -1
  %and.i.i114.i.i = and i64 %notmask.i.i112.i.i, %i.i73.i.i
  %retval.sroa.0.0.i.i115.i.i = select i1 %cmp.i.i110.i.i, i64 0, i64 %and.i.i114.i.i
  %retval.sroa.3.0.i.i116.i.i = select i1 %cmp.i.i110.i.i, i64 -1, i64 %sub.i.i113.i.i
  %i9.i120.i.i = load i64, i64* %value3.i, align 8
  %i11.i122.i.i = load i64, i64* %mask6.i, align 8
  %or.i.i123.i.i = or i64 %retval.sroa.0.0.i.i115.i.i, %i9.i120.i.i
  %and.i1.i124.i.i = and i64 %retval.sroa.3.0.i.i116.i.i, %i11.i122.i.i
  %neg.i.i125.i.i = xor i64 %and.i1.i124.i.i, -1
  %and4.i.i126.i.i = and i64 %or.i.i123.i.i, %neg.i.i125.i.i
  store i64 %and4.i.i126.i.i, i64* %value3.i, align 8
  store i64 %and.i1.i124.i.i, i64* %mask6.i, align 8
  %i.i131.i.i = load i64, i64* %smin_value7.i12, align 8
  %i23.i133.i.i = load i64, i64* %value3.i6, align 8
  %i24.i135.i.i = load i64, i64* %mask6.i9, align 8
  %and.i136.i.i = and i64 %i24.i135.i.i, -9223372036854775808
  %or.i137.i.i = or i64 %and.i136.i.i, %i23.i133.i.i
  %cmp.i138.i.i = icmp sgt i64 %i.i131.i.i, %or.i137.i.i
  %cond.i139.i.i = select i1 %cmp.i138.i.i, i64 %i.i131.i.i, i64 %or.i137.i.i
  store i64 %cond.i139.i.i, i64* %smin_value7.i12, align 8
  %i25.i141.i.i = load i64, i64* %smax_value8.i15, align 8
  %and7.i142.i.i = and i64 %i24.i135.i.i, 9223372036854775807
  %or8.i143.i.i = or i64 %and7.i142.i.i, %i23.i133.i.i
  %cmp10.i144.i.i = icmp slt i64 %i25.i141.i.i, %or8.i143.i.i
  %cond14.i145.i.i = select i1 %cmp10.i144.i.i, i64 %i25.i141.i.i, i64 %or8.i143.i.i
  store i64 %cond14.i145.i.i, i64* %smax_value8.i15, align 8
  %i26.i147.i.i = load i64, i64* %umin_value9.i18, align 8
  %cmp19.i148.i.i = icmp ugt i64 %i26.i147.i.i, %i23.i133.i.i
  %cond23.i149.i.i = select i1 %cmp19.i148.i.i, i64 %i26.i147.i.i, i64 %i23.i133.i.i
  store i64 %cond23.i149.i.i, i64* %umin_value9.i18, align 8
  %i27.i151.i.i = load i64, i64* %umax_value10.i21, align 8
  %or29.i152.i.i = or i64 %i24.i135.i.i, %i23.i133.i.i
  %cmp31.i153.i.i = icmp ult i64 %i27.i151.i.i, %or29.i152.i.i
  %cond35.i154.i.i = select i1 %cmp31.i153.i.i, i64 %i27.i151.i.i, i64 %or29.i152.i.i
  store i64 %cond35.i154.i.i, i64* %umax_value10.i21, align 8
  %i.i156.i.i = load i64, i64* %smin_value7.i, align 8
  %i23.i158.i.i = load i64, i64* %value3.i, align 8
  %i24.i160.i.i = load i64, i64* %mask6.i, align 8
  %and.i161.i.i = and i64 %i24.i160.i.i, -9223372036854775808
  %or.i162.i.i = or i64 %and.i161.i.i, %i23.i158.i.i
  %cmp.i163.i.i = icmp sgt i64 %i.i156.i.i, %or.i162.i.i
  %cond.i164.i.i = select i1 %cmp.i163.i.i, i64 %i.i156.i.i, i64 %or.i162.i.i
  store i64 %cond.i164.i.i, i64* %smin_value7.i, align 8
  %i25.i166.i.i = load i64, i64* %smax_value8.i, align 8
  %and7.i167.i.i = and i64 %i24.i160.i.i, 9223372036854775807
  %or8.i168.i.i = or i64 %and7.i167.i.i, %i23.i158.i.i
  %cmp10.i169.i.i = icmp slt i64 %i25.i166.i.i, %or8.i168.i.i
  %cond14.i170.i.i = select i1 %cmp10.i169.i.i, i64 %i25.i166.i.i, i64 %or8.i168.i.i
  store i64 %cond14.i170.i.i, i64* %smax_value8.i, align 8
  %i26.i172.i.i = load i64, i64* %umin_value9.i, align 8
  %cmp19.i173.i.i = icmp ugt i64 %i26.i172.i.i, %i23.i158.i.i
  %cond23.i174.i.i = select i1 %cmp19.i173.i.i, i64 %i26.i172.i.i, i64 %i23.i158.i.i
  store i64 %cond23.i174.i.i, i64* %umin_value9.i, align 8
  %i27.i176.i.i = load i64, i64* %umax_value10.i, align 8
  %or29.i177.i.i = or i64 %i24.i160.i.i, %i23.i158.i.i
  %cmp31.i178.i.i = icmp ult i64 %i27.i176.i.i, %or29.i177.i.i
  %cond35.i179.i.i = select i1 %cmp31.i178.i.i, i64 %i27.i176.i.i, i64 %or29.i177.i.i
  store i64 %cond35.i179.i.i, i64* %umax_value10.i, align 8
  br label %if.end117
