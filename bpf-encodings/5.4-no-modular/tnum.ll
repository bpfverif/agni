...
@llvm.compiler.used = appending global [2 x i8*] [i8* getelementptr inbounds ([10 x i8], [10 x i8]* @__kstrtab_tnum_strn, i32 0, i32 0), i8* bitcast (i8** @__addressable_tnum_strn257 to i8*)], section "llvm.metadata"
