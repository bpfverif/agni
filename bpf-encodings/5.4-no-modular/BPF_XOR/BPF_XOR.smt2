...
(assert (let ((a!1 (or (and (= or.cond200.i_10_49 #b0) (= tobool.not.i.i_10_36 #b0))
               (and (= or.cond199.i_10_45 #b0) (= tobool.not.i.i_10_36 #b1))))
      (a!2 (or (and (= or.cond200.i_10_49 #b1) (= tobool.not.i.i_10_36 #b0))
               (and (= or.cond199.i_10_45 #b1) (= tobool.not.i.i_10_36 #b1))))
      (a!3 (and (= #x00000001 src_reg_10_89)
      ...
      (a!7 (=> (= tobool.not.i.i_10_36 #b0)
               (and (ite (bvsgt src_reg1.sroa.13.0.copyload_10_30
                                src_reg1.sroa.15.0.copyload_10_31)
                         (= cmp21.old.i_10_46 #b1)
                         (= cmp21.old.i_10_46 #b0))
                    (ite (bvugt src_reg1.sroa.17.0.copyload_10_32
      ...
      (a!8 (=> (= tobool.not.i.i_10_36 #b1)
               (and (ite (distinct src_reg1.sroa.13.0.copyload_10_30
                                   src_reg1.sroa.15.0.copyload_10_31)
                    ...
                    (ite (bvsgt src_reg1.sroa.13.0.copyload_10_30
                                src_reg1.sroa.15.0.copyload_10_31)
                         (= cmp21.i_10_41 #b1)
                         (= cmp21.i_10_41 #b0))
                    (= or.cond198.i_10_42
                       (bvor cmp21.i_10_41 or.cond197.i_10_40))
                    (ite (bvugt src_reg1.sroa.17.0.copyload_10_32
                                src_reg1.sroa.22.0.copyload_10_33)
                         (= cmp24.i_10_43 #b1)
                         (= cmp24.i_10_43 #b0))
...
(let ((a!4 (and (=> a!2 a!3)
                (=> (and (= tobool.not.i.i_10_36 #b1) a!1)
                    (and (= #x00000001 src_reg_10_89)
                         ...
                         (= dst_reg_10_12 dst_reg_10_87)
                         (= dst_reg_10_13 dst_reg_10_88)))
                (=> (and (= tobool.not.i.i_10_36 #b0) a!1) a!3)
      ...
      (a!6 (=> (and (= tobool.not.i.i_10_36 #b1) a!1)
               (and (= #x0000000000000000 i9.i.i_10_70)
...
(let ((a!5 (=> (or (and (= tobool.not.i.i_10_36 #b1) a!1)
...
;{"dst_reg":["dst_reg_10_103",[""],"dst_reg_10_104","dst_reg_10_105","dst_reg_10_106",["dst_reg_10_107","dst_reg_10_108"],"dst_reg_10_109","dst_reg_10_110","dst_reg_10_111","dst_reg_10_112","","","dst_reg_10_113","dst_reg_10_114","dst_reg_10_115"],"src_reg":["src_reg_10_117",[""],"src_reg_10_118","src_reg_10_119","src_reg_10_120",["src_reg_10_121","src_reg_10_122"],"src_reg_10_123","src_reg_10_124","src_reg_10_125","src_reg_10_126","","","src_reg_10_127","src_reg_10_128","src_reg_10_129"]}
