...
@__addressable_tnum_strn217 = internal global i8* bitcast (i32 (i8*, i64, i64, i64)* @tnum_strn to i8*), section ".discard.addressable", align 8
@llvm.compiler.used = appending global [1 x i8*] [i8* bitcast (i8** @__addressable_tnum_strn217 to i8*)], section "llvm.metadata"
...
entry:
  ...
  %call = call { i64, i64 } @hma(i64 %14, i64 %16, i64 noundef %9, i64 noundef %or) #3
  ...
  %call8 = call { i64, i64 } @hma(i64 %28, i64 %30, i64 noundef %24, i64 noundef %25) #3
...
if.then:                                          ; preds = %while.body
  ...
  %call = call { i64, i64 } @tnum_add(i64 %8, i64 %10, i64 %13, i64 %15) #3
...
entry:
  ...
  %mask = getelementptr inbounds %struct.tnum, %struct.tnum* %a, i32 0, i32 1
  %6 = load i64, i64* %mask, align 8
  %call = call i32 (i8*, i64, i8*, ...) @snprintf(i8* noundef %3, i64 noundef %4, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str, i64 0, i64 0), i64 noundef %5, i64 noundef %6) #3
  ret i32 %call
}
...
entry:
  ...
  %6 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %3, i32 0, i32 1
  %7 = load i64, i64* %6, align 8
  %call = call { i64, i64 } @tnum_clear_subreg(i64 %5, i64 %7) #3
  %8 = bitcast %struct.tnum* %agg.tmp to { i64, i64 }*
  %9 = getelementptr inbounds { i64, i64 }, { i64, i64 }* %8, i32 0, i32 0
  %10 = extractvalue { i64, i64 } %call, 0
  store i64 %10, i64* %9, align 8
  ...
  %call2 = call { i64, i64 } @tnum_const(i64 noundef %conv) #3
  ...
  %28 = load i64, i64* %27, align 8
  %call3 = call { i64, i64 } @tnum_or(i64 %21, i64 %23, i64 %26, i64 %28) #3
...
; Function Attrs: noinline noredzone nounwind null_pointer_is_valid sspstrong
define internal i64 @fls___(i64 noundef %word) #0 {
entry:
